...
-- Original Query
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 9613;
-- Rewritten Queries
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 9613 LIMIT 1;
