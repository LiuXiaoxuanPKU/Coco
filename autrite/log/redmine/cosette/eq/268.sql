...
-- Original Query
SELECT COUNT(*) FROM import_items WHERE import_items.import_id = 16788 AND import_items.obj_id IS NULL;
-- Rewritten Queries
SELECT COUNT(*) FROM import_items WHERE import_items.import_id = 16788 AND import_items.obj_id IS NULL LIMIT 1;
