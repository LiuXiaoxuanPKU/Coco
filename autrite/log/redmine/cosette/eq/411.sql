...
-- Original Query
SELECT COUNT(*) FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 17569;
-- Rewritten Queries
SELECT COUNT(*) FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 17569 LIMIT 1;
