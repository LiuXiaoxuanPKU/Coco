...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 79 AND attachments.container_type = 'rhdngywfoyvqaksbgvitn' AND attachments.id IN (2290, 2383) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 79 AND attachments.container_type = 'rhdngywfoyvqaksbgvitn' AND attachments.id IN (2290, 2383) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
