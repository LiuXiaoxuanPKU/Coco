...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 11385 AND workflows.old_status_id = 0 AND workflows.role_id IN (4890, 8638, 4493);
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 11385 AND workflows.old_status_id = 0 AND workflows.role_id IN (4890, 8638, 4493) LIMIT 1;
