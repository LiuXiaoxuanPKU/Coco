...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE wiki_pages.wiki_id = 15388 ORDER BY LOWER(title) ASC;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE wiki_pages.wiki_id = 15388 ORDER BY LOWER(title) ASC LIMIT 1;
