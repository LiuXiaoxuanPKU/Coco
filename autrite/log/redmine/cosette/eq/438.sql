...
-- Original Query
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 1599 AND projects.status <> 9 AND projects.status <> 9;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.user_id = 1599;
SELECT members.* FROM members WHERE members.user_id = 1599 LIMIT 1;
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 1599 AND projects.status <> 9 AND projects.status <> 9 LIMIT 1;
