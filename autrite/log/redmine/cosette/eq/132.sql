...
-- Original Query
SELECT MAX(boards.position) FROM boards WHERE boards.project_id = 1880 AND boards.parent_id IS NULL;
-- Rewritten Queries
SELECT MAX(boards.position) FROM boards WHERE boards.project_id = 1880 AND boards.parent_id IS NULL LIMIT 1;
