...
-- Original Query
SELECT 1 AS "one" FROM versions INNER JOIN projects ON projects.id = versions.project_id WHERE projects.lft >= 1 AND projects.rgt <= 10 AND projects.status <> 9 LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions LIMIT 5;
