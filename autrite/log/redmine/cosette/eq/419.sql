...
-- Original Query
SELECT journals.* FROM journals WHERE journals.journalized_id = 9202 AND journals.journalized_type = 'Issue' AND journals.id > 2 ORDER BY journals.id ASC;
-- Rewritten Queries
SELECT journals.* FROM journals WHERE journals.journalized_id = 9202 AND journals.journalized_type = 'Issue' AND journals.id > 2 ORDER BY journals.id ASC LIMIT 1;
