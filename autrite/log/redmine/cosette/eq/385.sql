...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id = 2073 AND workflows.tracker_id = 15976;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id = 2073 AND workflows.tracker_id = 15976 LIMIT 1;
