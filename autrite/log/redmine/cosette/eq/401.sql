...
-- Original Query
SELECT projects.* FROM projects WHERE projects.parent_id IS NULL AND projects.rgt IS NULL AND projects.lft IS NULL ORDER BY projects.name ASC;
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.parent_id IS NULL AND projects.rgt IS NULL AND projects.lft IS NULL ORDER BY projects.name ASC LIMIT 1;
