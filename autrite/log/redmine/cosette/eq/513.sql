...
-- Original Query
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 3218 AND projects.status <> 5 AND members.project_id = 2902 ORDER BY members.id ASC LIMIT 1;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.user_id = 3218 AND members.project_id = 2902 ORDER BY members.id ASC LIMIT 1;
