...
-- Original Query
SELECT COUNT(*) FROM users WHERE users.type IN ('Group', 'GroupBuiltin', 'GroupAnonymous', 'GroupNonMember') AND users.type = 'User';
-- Rewritten Queries
SELECT COUNT(*) FROM users WHERE users.type IN ('Group', 'GroupBuiltin', 'GroupAnonymous', 'GroupNonMember') AND users.type = 'User' LIMIT 1;
