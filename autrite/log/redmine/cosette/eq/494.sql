...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10748 AND workflows.old_status_id = 0 AND workflows.role_id IN (8779, 8037, 8107, 2244, 4238);
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10748 AND workflows.old_status_id = 0 AND workflows.role_id IN (8779, 8037, 8107, 2244, 4238) LIMIT 1;
