...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id IN (8230, 4186, 1212, 2460) AND workflows.tracker_id IN (19105, 19057, 18083);
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id IN (8230, 4186, 1212, 2460) AND workflows.tracker_id IN (19105, 19057, 18083) LIMIT 1;
