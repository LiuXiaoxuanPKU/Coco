...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.type IN ('IssueCustomField') AND custom_fields.visible = True AND custom_fields.is_for_all = False ORDER BY custom_fields.position ASC;
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.type IN ('IssueCustomField') AND custom_fields.visible = True AND custom_fields.is_for_all = False ORDER BY custom_fields.position ASC LIMIT 1;
