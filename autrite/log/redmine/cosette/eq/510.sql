...
-- Original Query
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 5224 AND trackers.id = 7778 ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 5224 AND trackers.id = 7778 ORDER BY trackers.position ASC LIMIT 1;
