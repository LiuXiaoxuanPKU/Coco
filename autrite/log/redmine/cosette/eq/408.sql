...
-- Original Query
SELECT COUNT(*) FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 1;
-- Rewritten Queries
SELECT COUNT(*) FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 1 LIMIT 1;
