...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6614 AND issue_relations.issue_to_id IN (136, 5361, 3083);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6614 AND issue_relations.issue_to_id IN (136, 5361, 3083) LIMIT 1;
