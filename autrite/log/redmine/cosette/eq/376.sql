...
-- Original Query
SELECT COUNT(*) FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id = 8571 AND workflows.tracker_id = 14675;
-- Rewritten Queries
SELECT COUNT(*) FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.role_id = 8571 AND workflows.tracker_id = 14675 LIMIT 1;
