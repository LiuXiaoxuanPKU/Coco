...
-- Original Query
SELECT MAX(changesets.commit_date) FROM changesets WHERE changesets.repository_id = 2821;
-- Rewritten Queries
SELECT MAX(changesets.commit_date) FROM changesets WHERE changesets.repository_id = 2821 LIMIT 1;
