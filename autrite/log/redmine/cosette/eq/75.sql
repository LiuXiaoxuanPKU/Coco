...
-- Original Query
SELECT versions.* FROM versions WHERE versions.id = 1365 OR versions.id IS NULL;
-- Rewritten Queries
SELECT versions.* FROM versions WHERE versions.id = 1365 OR versions.id IS NULL LIMIT 1;
