...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id = 14926 AND workflows.role_id = 6439 ORDER BY tracker_id, role_id, old_status_id, new_status_id;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id = 14926 AND workflows.role_id = 6439 ORDER BY tracker_id, role_id, old_status_id, new_status_id LIMIT 1;
