...
-- Original Query
SELECT member_roles.id FROM member_roles WHERE member_roles.member_id = 2688;
-- Rewritten Queries
SELECT member_roles.id FROM member_roles WHERE member_roles.member_id = 2688 LIMIT 1;
