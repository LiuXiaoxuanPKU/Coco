...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'nwgfsdcjmwwe' AND attachments.container_id IN (14, 17, 45, 96, 9, 95, 25) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'nwgfsdcjmwwe' AND attachments.container_id IN (14, 17, 45, 96, 9, 95, 25) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
