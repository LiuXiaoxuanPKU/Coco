...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8978, 8117, 3375, 591, 5655, 199, 7465, 5274) AND issue_relations.issue_to_id IN (2482, 3016, 1030, 2520, 7310, 3842, 9411, 5218) AND issue_relations.relation_type IN ('duplicates', 'blocks');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8978, 8117, 3375, 591, 5655, 199, 7465, 5274) AND issue_relations.issue_to_id IN (2482, 3016, 1030, 2520, 7310, 3842, 9411, 5218) AND issue_relations.relation_type IN ('duplicates', 'blocks') LIMIT 1;
