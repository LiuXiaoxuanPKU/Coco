...
-- Original Query
SELECT COUNT(*) FROM enumerations WHERE enumerations.type IN ('IssuePriority');
-- Rewritten Queries
SELECT COUNT(*) FROM enumerations WHERE enumerations.type IN ('IssuePriority') LIMIT 1;
