...
-- Original Query
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 5959 AND watchers.watchable_type = 'Message';
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 5959 AND watchers.watchable_type = 'Message' LIMIT 1;
