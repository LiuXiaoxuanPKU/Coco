...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 3068 AND issue_relations.issue_to_id = 8027 AND issue_relations.relation_type IN ('blocks', 'blocks');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 3068 AND issue_relations.issue_to_id = 8027 AND issue_relations.relation_type IN ('blocks', 'blocks') LIMIT 1;
