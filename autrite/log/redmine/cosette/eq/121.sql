...
-- Original Query
SELECT COUNT(*) FROM watchers WHERE watchers.watchable_id = 4672 AND watchers.watchable_type = 'News';
-- Rewritten Queries
SELECT COUNT(*) FROM watchers WHERE watchers.watchable_id = 4672 AND watchers.watchable_type = 'News' LIMIT 1;
