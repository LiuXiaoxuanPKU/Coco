...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (1729, 7721, 9446, 3217, 2854, 6265) AND issue_relations.issue_to_id IN (9017, 8003, 6248, 5402, 4823, 7818) AND issue_relations.relation_type IN ('duplicates', 'copied_to');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (1729, 7721, 9446, 3217, 2854, 6265) AND issue_relations.issue_to_id IN (9017, 8003, 6248, 5402, 4823, 7818) AND issue_relations.relation_type IN ('duplicates', 'copied_to') LIMIT 1;
