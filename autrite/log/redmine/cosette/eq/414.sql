...
-- Original Query
SELECT 1 AS "one" FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 1203 AND projects.status <> 9 LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM members WHERE members.user_id = 1203 LIMIT 9;
