...
-- Original Query
SELECT COUNT(*) FROM custom_fields WHERE custom_fields.type IN ('ProjectCustomField');
-- Rewritten Queries
SELECT COUNT(*) FROM custom_fields WHERE custom_fields.type IN ('ProjectCustomField') LIMIT 1;
