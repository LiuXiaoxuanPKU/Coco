...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.id = 14993 ORDER BY enumerations.position ASC;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.id = 14993 ORDER BY enumerations.position ASC LIMIT 1;
