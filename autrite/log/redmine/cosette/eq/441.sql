...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 25 AND attachments.container_type = 'jd' ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 25 AND attachments.container_type = 'jd' ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
