...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE type = 'VersionCustomField' ORDER BY custom_fields.position ASC;
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE type = 'VersionCustomField' ORDER BY custom_fields.position ASC LIMIT 1;
