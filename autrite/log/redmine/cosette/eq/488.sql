...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 19077 AND workflows.old_status_id = 0 AND workflows.role_id IN (9339, 54, 3856, 2304);
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 19077 AND workflows.old_status_id = 0 AND workflows.role_id IN (9339, 54, 3856, 2304) LIMIT 1;
