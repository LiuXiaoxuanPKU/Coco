...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10302 AND workflows.old_status_id IS NULL AND workflows.role_id = 1234;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10302 AND False AND workflows.role_id = 1234;
