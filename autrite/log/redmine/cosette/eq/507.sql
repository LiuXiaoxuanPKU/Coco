...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'vabxezgrwwyvgae' AND attachments.container_id IN (70, 60, 22, 35, 12, 10, 74, 32) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'vabxezgrwwyvgae' AND attachments.container_id IN (70, 60, 22, 35, 12, 10, 74, 32) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
