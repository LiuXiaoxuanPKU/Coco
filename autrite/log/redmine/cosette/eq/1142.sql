...
-- Original Query
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals INNER JOIN issues ON issues.id = journals.journalized_id INNER JOIN projects ON projects.id = issues.project_id WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (1484, 191, 7278, 7974, 8551, 3249, 9517, 8115, 5998, 4864, 2270) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id;
-- Rewritten Queries
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (2368, 509, 5476, 8949, 1914, 2990, 1936, 645, 2628, 1060, 2654) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id;
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (2368, 509, 5476, 8949, 1914, 2990, 1936, 645, 2628, 1060, 2654) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id LIMIT 1;
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals INNER JOIN issues ON issues.id = journals.journalized_id WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (645, 2628, 1060, 2654, 606, 1839, 9317, 1484, 191, 7278, 7974) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id;
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals INNER JOIN issues ON issues.id = journals.journalized_id WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (645, 2628, 1060, 2654, 606, 1839, 9317, 1484, 191, 7278, 7974) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id LIMIT 1;
SELECT MAX(journals.id) AS maximum_id, journals.journalized_id AS journals_journalized_id FROM journals INNER JOIN issues ON issues.id = journals.journalized_id INNER JOIN projects ON projects.id = issues.project_id WHERE journals.journalized_type = 'Issue' AND journals.journalized_id IN (1484, 191, 7278, 7974, 8551, 3249, 9517, 8115, 5998, 4864, 2270) AND (journals.private_notes = False OR journals.user_id = 2 OR 1 = 0) AND journals.notes <> '{}' GROUP BY journals.journalized_id LIMIT 1;
