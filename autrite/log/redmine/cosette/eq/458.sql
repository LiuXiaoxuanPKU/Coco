...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'wmtwr' AND attachments.container_id IN (8, 44) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'wmtwr' AND attachments.container_id IN (8, 44) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
