...
-- Original Query
SELECT COUNT(*) FROM issue_categories WHERE issue_categories.project_id = 4159;
-- Rewritten Queries
SELECT COUNT(*) FROM issue_categories WHERE issue_categories.project_id = 4159 LIMIT 1;
