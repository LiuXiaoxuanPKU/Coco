...
-- Original Query
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('TimeEntryCustomField');
-- Rewritten Queries
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('TimeEntryCustomField') LIMIT 1;
