...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 16264 AND workflows.old_status_id = 0 AND workflows.role_id = 5060;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 16264 AND workflows.old_status_id = 0 AND workflows.role_id = 5060 LIMIT 1;
