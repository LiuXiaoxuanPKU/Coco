...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18757 AND workflows.old_status_id IS NULL AND workflows.role_id = 4513;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18757 AND False AND workflows.role_id = 4513;
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18757 AND False AND workflows.role_id = 4513 LIMIT 1;
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18757 AND workflows.old_status_id IS NULL AND workflows.role_id = 4513 LIMIT 1;
