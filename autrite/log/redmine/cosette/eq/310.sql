...
-- Original Query
SELECT COUNT(*) FROM time_entries WHERE time_entries.activity_id = 10010 AND time_entries.project_id = 9515;
-- Rewritten Queries
SELECT COUNT(*) FROM time_entries WHERE time_entries.activity_id = 10010 AND time_entries.project_id = 9515 LIMIT 1;
