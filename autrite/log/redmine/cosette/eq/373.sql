...
-- Original Query
SELECT 1 AS "one" FROM members INNER JOIN member_roles ON members.id = member_roles.member_id WHERE member_roles.role_id = 2 LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM members LIMIT 8;
