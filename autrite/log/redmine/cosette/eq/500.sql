...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8721 AND issue_relations.issue_to_id = 4511 AND issue_relations.relation_type = 'relates' AND issue_relations.delay = 0;
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8721 AND issue_relations.issue_to_id = 4511 AND issue_relations.relation_type = 'relates';
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8721 AND issue_relations.issue_to_id = 4511 AND issue_relations.relation_type = 'relates' AND issue_relations.delay = 0 LIMIT 1;
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8721 AND issue_relations.issue_to_id = 4511 AND issue_relations.relation_type = 'relates' LIMIT 1;
