...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'aqwzlbnetfe' AND attachments.container_id IN (75, 3, 4, 35, 48, 97) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'aqwzlbnetfe' AND attachments.container_id IN (75, 3, 4, 35, 48, 97) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
