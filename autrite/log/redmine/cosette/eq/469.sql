...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18826 AND workflows.old_status_id = 0 AND workflows.role_id IN (10143, 8792);
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 18826 AND workflows.old_status_id = 0 AND workflows.role_id IN (10143, 8792) LIMIT 1;
