...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('DocumentCategory') AND enumerations.id IN (14722, 15730) ORDER BY enumerations.position ASC;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('DocumentCategory') AND enumerations.id IN (14722, 15730) ORDER BY enumerations.position ASC LIMIT 1;
