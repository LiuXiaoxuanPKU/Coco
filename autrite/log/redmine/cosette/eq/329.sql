...
-- Original Query
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('TimeEntryActivityCustomField');
-- Rewritten Queries
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('TimeEntryActivityCustomField') LIMIT 1;
