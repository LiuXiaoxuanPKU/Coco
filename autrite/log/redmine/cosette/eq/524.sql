...
-- Original Query
SELECT DISTINCT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (10868, 11423, 14241) AND workflows.role_id IN (8916, 10055, 908, 7318);
-- Rewritten Queries
SELECT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (10969, 10868, 11423) AND workflows.role_id IN (4453, 8916, 10055, 908);
SELECT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (10969, 10868, 11423) AND workflows.role_id IN (4453, 8916, 10055, 908) LIMIT 1;
SELECT DISTINCT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (10868, 11423, 14241) AND workflows.role_id IN (8916, 10055, 908, 7318) LIMIT 1;
