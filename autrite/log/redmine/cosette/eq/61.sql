...
-- Original Query
SELECT COUNT(*) FROM enabled_modules WHERE enabled_modules.project_id = 9500;
-- Rewritten Queries
SELECT COUNT(*) FROM enabled_modules WHERE enabled_modules.project_id = 9500 LIMIT 1;
