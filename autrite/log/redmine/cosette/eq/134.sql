...
-- Original Query
SELECT watchers.* FROM watchers WHERE watchers.watchable_id = 6636 AND watchers.watchable_type = 'News';
-- Rewritten Queries
SELECT watchers.* FROM watchers WHERE watchers.watchable_id = 6636 AND watchers.watchable_type = 'News' LIMIT 1;
