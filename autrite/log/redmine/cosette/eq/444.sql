...
-- Original Query
SELECT MAX(enumerations.position) FROM enumerations WHERE enumerations.type IN ('IssuePriority') AND enumerations.project_id IS NULL AND enumerations.parent_id IS NULL;
-- Rewritten Queries
SELECT MAX(enumerations.position) FROM enumerations WHERE enumerations.type IN ('IssuePriority') AND enumerations.project_id IS NULL AND enumerations.parent_id IS NULL LIMIT 1;
