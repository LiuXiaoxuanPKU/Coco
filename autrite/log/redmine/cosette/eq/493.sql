...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 21 AND attachments.container_type = 'wcxoegqqlmnfncgubdnbcxydbcpyz' AND attachments.id = 1558 ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 21 AND attachments.container_type = 'wcxoegqqlmnfncgubdnbcxydbcpyz' AND attachments.id = 1558 ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
