...
-- Original Query
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('VersionCustomField');
-- Rewritten Queries
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('VersionCustomField') LIMIT 1;
