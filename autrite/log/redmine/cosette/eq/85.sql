...
-- Original Query
SELECT MAX(import_items.position) FROM import_items WHERE import_items.import_id = 12036;
-- Rewritten Queries
SELECT MAX(import_items.position) FROM import_items WHERE import_items.import_id = 12036 LIMIT 1;
