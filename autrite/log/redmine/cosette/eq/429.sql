...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.type IN ('TimeEntryCustomField') AND custom_fields.visible = True ORDER BY custom_fields.position ASC;
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.type IN ('TimeEntryCustomField') AND custom_fields.visible = True ORDER BY custom_fields.position ASC LIMIT 1;
