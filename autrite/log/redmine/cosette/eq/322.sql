...
-- Original Query
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('IssuePriorityCustomField');
-- Rewritten Queries
SELECT MAX(custom_fields.position) FROM custom_fields WHERE custom_fields.type IN ('IssuePriorityCustomField') LIMIT 1;
