...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (5, 8, 4, 9, 5);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (5, 8, 4, 9, 5) LIMIT 1;
