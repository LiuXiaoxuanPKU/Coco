...
-- Original Query
SELECT roles.id FROM roles WHERE roles.builtin = 0 ORDER BY roles.position ASC;
-- Rewritten Queries
SELECT roles.id FROM roles WHERE roles.builtin = 0 ORDER BY roles.position ASC LIMIT 1;
