...
-- Original Query
SELECT custom_fields.id FROM custom_fields WHERE custom_fields.type IN ('IssueCustomField') ORDER BY custom_fields.position ASC;
-- Rewritten Queries
SELECT custom_fields.id FROM custom_fields WHERE custom_fields.type IN ('IssueCustomField') ORDER BY custom_fields.position ASC LIMIT 1;
