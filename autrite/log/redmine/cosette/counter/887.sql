...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id IN (5380, 1098, 1466, 2085, 5423, 3154, 4175);
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id IN (5380, 1098, 1466, 2085, 5423, 3154, 4175) LIMIT 1;
