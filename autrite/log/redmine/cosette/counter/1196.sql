...
-- Original Query
SELECT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id WHERE members.user_id = 2174 AND projects.status != 5;
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.status <> 5 LIMIT 1;
