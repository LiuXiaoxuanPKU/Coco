...
-- Original Query
SELECT time_entries.* FROM time_entries WHERE time_entries.id IN (6599, 8552, 4600);
-- Rewritten Queries
SELECT time_entries.* FROM time_entries WHERE time_entries.id IN (6599, 8552, 4600) LIMIT 1;
