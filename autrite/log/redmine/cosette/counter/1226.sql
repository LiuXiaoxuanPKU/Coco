...
-- Original Query
SELECT trackers.* FROM trackers WHERE trackers.id IN (3901, 1884, 3795) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.* FROM trackers WHERE trackers.id IN (3901, 1884, 3795) ORDER BY trackers.position ASC LIMIT 1;
