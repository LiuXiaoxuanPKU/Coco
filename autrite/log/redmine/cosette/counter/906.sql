...
-- Original Query
SELECT issue_statuses.name FROM issue_statuses ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.name FROM issue_statuses ORDER BY issue_statuses.position ASC LIMIT 1;
