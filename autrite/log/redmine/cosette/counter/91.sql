...
-- Original Query
SELECT  enumerations.* FROM enumerations WHERE enumerations.type IN ('IssuePriority') AND (position > 2) ORDER BY enumerations.position ASC LIMIT 2;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('IssuePriority') ORDER BY enumerations.position ASC LIMIT 2;
