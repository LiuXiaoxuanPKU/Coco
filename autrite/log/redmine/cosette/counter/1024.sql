...
-- Original Query
SELECT issues.* FROM issues WHERE issues.id IN (5048, 3762, 9503, 3575, 417, 7869, 195, 4398, 1842, 4356);
-- Rewritten Queries
SELECT issues.* FROM issues WHERE issues.id IN (5048, 3762, 9503, 3575, 417, 7869, 195, 4398, 1842, 4356) LIMIT 1;
