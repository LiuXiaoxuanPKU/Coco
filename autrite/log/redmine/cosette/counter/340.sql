...
-- Original Query
SELECT COUNT(*) FROM members INNER JOIN users ON users.id = members.user_id WHERE members.project_id = 8951 AND users.type = 'User' AND users.status = 2;
-- Rewritten Queries
SELECT COUNT(*) FROM members WHERE members.project_id = 8951;
SELECT COUNT(*) FROM members WHERE members.project_id = 8951 LIMIT 1;
