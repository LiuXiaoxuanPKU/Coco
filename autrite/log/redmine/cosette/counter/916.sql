...
-- Original Query
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id INNER JOIN enumerations ON enumerations.id = issues.priority_id AND enumerations.type IN ('IssuePriority') WHERE ((issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses  WHERE is_closed = FALSE))));
-- Rewritten Queries
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN projects ON projects.id = issues.project_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False));
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id INNER JOIN enumerations ON enumerations.id = issues.priority_id AND enumerations.type IN ('IssuePriority') WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False)) LIMIT 1;
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id INNER JOIN enumerations ON enumerations.id = issues.priority_id AND enumerations.type IN ('IssuePriority') WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1);
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id INNER JOIN enumerations ON enumerations.id = issues.priority_id AND enumerations.type IN ('IssuePriority') WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1);
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id INNER JOIN enumerations ON enumerations.id = issues.priority_id AND enumerations.type IN ('IssuePriority') WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1) LIMIT 1;
...
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1)) LIMIT 1;
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False)) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1);
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1);
SELECT issues.* FROM issues WHERE issues.id IN (SELECT DISTINCT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1) LIMIT 1;
...
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1)) LIMIT 1;
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False)) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1);
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1);
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False) LIMIT 1) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1)) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issue_relations.issue_to_id FROM issue_relations, issues AS relissues WHERE issue_relations.relation_type = 'blocks' AND issue_relations.issue_from_id = relissues.id AND relissues.status_id IN (SELECT id FROM issue_statuses WHERE is_closed = False LIMIT 1) LIMIT 1) LIMIT 1;
