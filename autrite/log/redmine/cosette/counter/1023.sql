...
-- Original Query
SELECT issues.* FROM issues WHERE issues.id IN (3435, 365, 456, 2817, 4112, 8304, 7266, 6151, 2651);
-- Rewritten Queries
SELECT issues.* FROM issues WHERE issues.id IN (3435, 365, 456, 2817, 4112, 8304, 7266, 6151, 2651) LIMIT 1;
