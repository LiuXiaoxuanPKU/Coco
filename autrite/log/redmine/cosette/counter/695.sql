...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 9, 4);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 9, 4) LIMIT 1;
