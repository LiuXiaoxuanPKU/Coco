...
-- Original Query
SELECT issues.* FROM issues WHERE issues.id IN (5466, 5580, 6197) ORDER BY issues.id ASC;
-- Rewritten Queries
SELECT issues.* FROM issues WHERE issues.id IN (5466, 5580, 6197) ORDER BY issues.id ASC LIMIT 1;
