...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (5, 9, 7, 4, 4, 7, 5);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (5, 9, 7, 4, 4, 7, 5) LIMIT 1;
