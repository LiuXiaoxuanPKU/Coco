...
-- Original Query
SELECT custom_fields.* FROM custom_fields INNER JOIN custom_fields_roles ON custom_fields.id = custom_fields_roles.custom_field_id WHERE custom_fields_roles.role_id = 1;
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields;
SELECT custom_fields.* FROM custom_fields INNER JOIN custom_fields_roles ON custom_fields.id = custom_fields_roles.custom_field_id WHERE custom_fields_roles.role_id = 1 LIMIT 1;
SELECT custom_fields.* FROM custom_fields LIMIT 1;
