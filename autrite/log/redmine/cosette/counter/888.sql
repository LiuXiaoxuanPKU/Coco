...
-- Original Query
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id IN (1687, 5635) AND (is_default = TRUE OR notify = TRUE);
-- Rewritten Queries
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id IN (1687, 5635) AND (is_default = True OR notify = True) LIMIT 1;
