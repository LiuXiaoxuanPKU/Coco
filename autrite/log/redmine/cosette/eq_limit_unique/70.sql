...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (6546, 1349, 4623, 6407, 8551, 1351, 2182, 9784) AND issue_relations.issue_to_id IN (8302, 193, 3288, 9516, 1055, 119, 1001, 2116) AND issue_relations.relation_type IN ('duplicates', 'blocks');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (6546, 1349, 4623, 6407, 8551, 1351, 2182, 9784) AND issue_relations.issue_to_id IN (8302, 193, 3288, 9516, 1055, 119, 1001, 2116) AND issue_relations.relation_type IN ('duplicates', 'blocks') LIMIT 1;
