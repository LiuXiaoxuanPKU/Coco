...
-- Original Query
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 155;
-- Rewritten Queries
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 155 LIMIT 1;
