...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (1749, 3323, 9506, 1351, 3031, 8062) AND issue_relations.issue_to_id IN (9228, 9993, 439, 6835, 8540, 1121) AND issue_relations.relation_type IN ('blocks', 'precedes');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (1749, 3323, 9506, 1351, 3031, 8062) AND issue_relations.issue_to_id IN (9228, 9993, 439, 6835, 8540, 1121) AND issue_relations.relation_type IN ('blocks', 'precedes') LIMIT 1;
