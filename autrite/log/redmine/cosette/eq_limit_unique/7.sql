...
-- Original Query
SELECT wiki_pages.title FROM wiki_pages WHERE wiki_pages.wiki_id = 5992 ORDER BY LOWER(title) ASC;
-- Rewritten Queries
SELECT wiki_pages.title FROM wiki_pages WHERE wiki_pages.wiki_id = 5992 ORDER BY LOWER(title) ASC LIMIT 1;
