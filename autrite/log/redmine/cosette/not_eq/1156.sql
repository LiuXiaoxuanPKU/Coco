...
-- Original Query
SELECT projects.* FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 2;
-- Rewritten Queries
SELECT projects.* FROM projects;
SELECT projects.* FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 2 LIMIT 1;
SELECT projects.* FROM projects LIMIT 1;
