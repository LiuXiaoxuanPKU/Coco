...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.visible = True ORDER BY id;
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.visible = True ORDER BY id LIMIT 1;
