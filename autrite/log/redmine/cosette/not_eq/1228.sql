...
-- Original Query
SELECT trackers.id FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 326 AND trackers.id IN (2532, 4484) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.id FROM trackers WHERE trackers.id IN (4080, 5741) ORDER BY trackers.position ASC;
SELECT trackers.id FROM trackers WHERE trackers.id IN (4080, 5741) ORDER BY trackers.position ASC LIMIT 1;
