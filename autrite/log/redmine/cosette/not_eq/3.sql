...
-- Original Query
SELECT enabled_modules.name FROM enabled_modules WHERE enabled_modules.project_id = 9691;
-- Rewritten Queries
SELECT enabled_modules.name FROM enabled_modules WHERE enabled_modules.project_id = 9691 LIMIT 1;
