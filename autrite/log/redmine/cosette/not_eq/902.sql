...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (8271, 2795, 822, 3372, 2475) ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (8271, 2795, 822, 3372, 2475) ORDER BY issue_statuses.position ASC LIMIT 1;
