...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (3, 1, 2, 8);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (3, 1, 2, 8) LIMIT 1;
