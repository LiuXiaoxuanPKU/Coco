...
-- Original Query
SELECT time_entries.* FROM time_entries WHERE time_entries.id IN (3210, 4469);
-- Rewritten Queries
SELECT time_entries.* FROM time_entries WHERE time_entries.id IN (3210, 4469) LIMIT 1;
