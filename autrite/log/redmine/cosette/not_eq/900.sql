...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (3626, 5703, 9434) ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (3626, 5703, 9434) ORDER BY issue_statuses.position ASC LIMIT 1;
