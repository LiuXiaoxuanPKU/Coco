...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 1, 6, 11, 2, 11);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 1, 6, 11, 2, 11) LIMIT 1;
