...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.id IN (4932, 5619, 8057, 8592, 6457);
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.id IN (4932, 5619, 8057, 8592, 6457) LIMIT 1;
