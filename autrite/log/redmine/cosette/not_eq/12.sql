...
-- Original Query
SELECT issue_statuses.name FROM issue_statuses WHERE issue_statuses.id IN (9056, 6458, 5714) ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.name FROM issue_statuses WHERE issue_statuses.id IN (9056, 6458, 5714) ORDER BY issue_statuses.position ASC LIMIT 1;
