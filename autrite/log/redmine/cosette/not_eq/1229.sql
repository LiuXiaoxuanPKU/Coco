...
-- Original Query
SELECT trackers.id FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 5546 ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.id FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 5546 ORDER BY trackers.position ASC LIMIT 1;
