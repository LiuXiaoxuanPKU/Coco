...
-- Original Query
SELECT  enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.position = 970 AND enumerations.parent_id IS NULL ORDER BY enumerations.position ASC LIMIT 1;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.parent_id IS NULL ORDER BY enumerations.position ASC LIMIT 1;
