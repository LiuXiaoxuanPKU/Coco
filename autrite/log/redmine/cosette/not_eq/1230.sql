...
-- Original Query
SELECT trackers.name FROM trackers WHERE trackers.id IN (3947, 4416, 6668) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.name FROM trackers WHERE trackers.id IN (3947, 4416, 6668) ORDER BY trackers.position ASC LIMIT 1;
