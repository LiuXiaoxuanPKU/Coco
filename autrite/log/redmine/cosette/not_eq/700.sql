...
-- Original Query
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 2, 2, 6, 1, 6, 5, 3);
-- Rewritten Queries
SELECT custom_fields.* FROM custom_fields WHERE custom_fields.id IN (1, 2, 2, 6, 1, 6, 5, 3) LIMIT 1;
