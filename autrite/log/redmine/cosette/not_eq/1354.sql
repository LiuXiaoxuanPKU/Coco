...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE wiki_pages.id IN (8977, 2628, 3007);
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE wiki_pages.id IN (8977, 2628, 3007) LIMIT 1;
