...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.id IN (4338, 7682, 4903);
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.id IN (4338, 7682, 4903) LIMIT 1;
