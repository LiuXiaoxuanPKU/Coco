...
-- Rewritten Queries
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN projects ON projects.id = issues.project_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN projects ON projects.id = issues.project_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues WHERE issues.status_id IS NOT NULL AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id INNER JOIN projects ON projects.id = issues.project_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN projects ON projects.id = issues.project_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN projects ON projects.id = issues.project_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN trackers ON trackers.id = issues.tracker_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues INNER JOIN issue_statuses ON issue_statuses.id = issues.status_id WHERE True AND (issues.description IS NULL OR issues.description = '');
SELECT issues.* FROM issues WHERE True AND (issues.description IS NULL OR issues.description = '');
