...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (9704, 6919, 5822, 4997, 341, 2648);
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (9704, 6919, 5822, 4997, 341, 2648) LIMIT 1;
