...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (8048, 4252, 7639, 947) ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (8048, 4252, 7639, 947) ORDER BY issue_statuses.position ASC LIMIT 1;
