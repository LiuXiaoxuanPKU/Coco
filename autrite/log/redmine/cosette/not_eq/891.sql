...
-- Original Query
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.project_id = 8130 ORDER BY issue_categories.name ASC;
-- Rewritten Queries
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.project_id = 8130 ORDER BY issue_categories.name ASC LIMIT 1;
