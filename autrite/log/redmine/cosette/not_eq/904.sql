...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (1097, 6732, 5431, 8101, 9560, 6820, 2423);
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (1097, 6732, 5431, 8101, 9560, 6820, 2423) LIMIT 1;
