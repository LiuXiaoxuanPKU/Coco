...
-- Original Query
SELECT enabled_modules.id FROM enabled_modules WHERE enabled_modules.project_id = 4692;
-- Rewritten Queries
SELECT enabled_modules.id FROM enabled_modules WHERE enabled_modules.project_id = 4692 LIMIT 1;
