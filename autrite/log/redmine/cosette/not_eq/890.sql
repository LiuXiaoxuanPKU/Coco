...
-- Original Query
SELECT enabled_modules.name FROM enabled_modules WHERE enabled_modules.project_id = 5603;
-- Rewritten Queries
SELECT enabled_modules.name FROM enabled_modules WHERE enabled_modules.project_id = 5603 LIMIT 1;
