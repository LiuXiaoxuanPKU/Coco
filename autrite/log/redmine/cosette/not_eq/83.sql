...
-- Original Query
SELECT DISTINCT attachments.filename AS alias_0, projects.id FROM projects LEFT OUTER JOIN attachments ON attachments.container_id = projects.id AND attachments.container_type = 'peksoitqdwbjhjcecxtipotrnmw' WHERE projects.id = 2643 ORDER BY attachments.filename ASC LIMIT 9;
-- Rewritten Queries
SELECT DISTINCT attachments.filename AS alias_0, projects.id FROM projects INNER JOIN attachments ON attachments.container_id = projects.id AND attachments.container_type = 'peksoitqdwbjhjcecxtipotrnmw' WHERE projects.id = 2643 ORDER BY attachments.filename ASC LIMIT 9;
