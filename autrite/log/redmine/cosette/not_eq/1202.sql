...
-- Original Query
SELECT projects.id FROM projects WHERE (projects.lft >= 6 AND projects.rgt <= 7) ORDER BY projects.lft ASC;
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.lft >= 6 AND projects.rgt <= 7 ORDER BY projects.lft ASC LIMIT 1;
