...
-- Original Query
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (6518, 9008, 1296, 6119, 9327, 6303, 7369) ORDER BY issue_statuses.position ASC;
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses WHERE issue_statuses.id IN (6518, 9008, 1296, 6119, 9327, 6303, 7369) ORDER BY issue_statuses.position ASC LIMIT 1;
