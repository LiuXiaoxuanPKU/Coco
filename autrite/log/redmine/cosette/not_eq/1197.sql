...
-- Original Query
SELECT projects.id FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 2;
-- Rewritten Queries
SELECT projects.id FROM projects;
SELECT projects.id FROM projects INNER JOIN projects_trackers ON projects.id = projects_trackers.project_id WHERE projects_trackers.tracker_id = 2 LIMIT 1;
