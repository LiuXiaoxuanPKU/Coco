...
-- Original Query
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 8042 AND trackers.id IN (5669, 4136) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.* FROM trackers WHERE trackers.id IN (6906, 3276) ORDER BY trackers.position ASC;
SELECT trackers.* FROM trackers WHERE trackers.id IN (6906, 3276) ORDER BY trackers.position ASC LIMIT 1;
