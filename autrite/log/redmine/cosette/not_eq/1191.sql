...
-- Original Query
SELECT projects.* FROM projects WHERE projects.id IN (9544, 2157, 1943, 5076, 5, 6892);
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.id IN (9544, 2157, 1943, 5076, 5, 6892) LIMIT 1;
