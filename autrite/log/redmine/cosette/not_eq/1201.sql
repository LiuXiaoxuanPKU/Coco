...
-- Original Query
SELECT projects.id FROM projects WHERE (projects.lft >= 1 AND projects.rgt <= 10) ORDER BY projects.lft ASC;
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.lft >= 1 AND projects.rgt <= 10 ORDER BY projects.lft ASC LIMIT 1;
