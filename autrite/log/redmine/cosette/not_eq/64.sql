...
-- Original Query
SELECT 1 AS "one" FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 2552 AND trackers.id IN (7047, 1283) LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM trackers WHERE trackers.id IN (5139, 1028) LIMIT 2;
