...
-- Original Query
SELECT members.* FROM members INNER JOIN users ON users.id = members.user_id WHERE members.project_id = 7832 AND users.status = 2;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.project_id = 7832;
SELECT members.* FROM members WHERE members.project_id = 7832 LIMIT 1;
