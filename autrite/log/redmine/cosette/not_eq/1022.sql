...
-- Original Query
SELECT issues.* FROM issues WHERE issues.id IN (6061, 3425, 2142, 1574, 6254, 3148);
-- Rewritten Queries
SELECT issues.* FROM issues WHERE issues.id IN (6061, 3425, 2142, 1574, 6254, 3148) LIMIT 1;
