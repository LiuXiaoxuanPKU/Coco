...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10701 AND workflows.old_status_id IS NULL AND workflows.role_id = 4600;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 10701 AND False AND workflows.role_id = 4600;
