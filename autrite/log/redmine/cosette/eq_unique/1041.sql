...
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' LEFT OUTER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10')) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' LEFT OUTER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10'));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' LEFT OUTER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10')) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' INNER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10'));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' INNER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10')) LIMIT 1;
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' INNER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10'));
SELECT issues.* FROM issues WHERE issues.id IN (SELECT issues.id FROM issues INNER JOIN watchers ON issues.id = watchers.watchable_id AND watchers.watchable_type = 'Issue' INNER JOIN projects ON projects.id = issues.project_id WHERE watchers.user_id IN ('2') OR projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND (projects.id IN (1, 5) OR projects.id IN (2, 5)) AND watchers.user_id IN ('10')) LIMIT 1;
