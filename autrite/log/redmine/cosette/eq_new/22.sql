...
-- Original Query
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id WHERE members.user_id = 2854 AND projects.status <> 1 AND projects.id = 3878 LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects WHERE projects.status <> 1 AND projects.id = 3878 LIMIT 6;
