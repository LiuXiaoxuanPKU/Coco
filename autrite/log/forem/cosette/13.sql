...
-- Original Query
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 3810 AND organization_memberships.organization_id IS NULL LIMIT 3;
-- Rewritten Queries
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 3810 AND False LIMIT 3;
