...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'aogpgcsuqsfjzecrjecfmojigsbffobajhyptbpkcyaczxznlc' AND articles.user_id = 9259 AND articles.title IS NULL LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'aogpgcsuqsfjzecrjecfmojigsbffobajhyptbpkcyaczxznlc' AND articles.user_id = 9259 AND False LIMIT 7;
