...
-- Original Query
SELECT articles.* FROM articles WHERE articles.published = False AND (published_at <= '2022-02-27 07:10:54.765698') AND articles.user_id IS NULL ORDER BY articles.published_at DESC LIMIT 5;
-- Rewritten Queries
SELECT articles.* FROM articles WHERE articles.published = False AND published_at <= '2022-02-27 07:10:54.765698' AND False ORDER BY articles.published_at DESC LIMIT 5;
