...
-- Original Query
SELECT articles.* FROM articles WHERE articles.user_id = 4331 AND articles.slug IS NULL LIMIT 1;
-- Rewritten Queries
SELECT articles.* FROM articles WHERE articles.user_id = 4331 AND False LIMIT 1;
