...
-- Original Query
SELECT DISTINCT collections.* FROM collections INNER JOIN articles ON articles.collection_id = collections.id WHERE collections.user_id = 9903 ORDER BY collections.created_at DESC;
-- Rewritten Queries
SELECT collections.* FROM collections INNER JOIN articles ON articles.collection_id = collections.id WHERE collections.user_id = 9903 ORDER BY collections.created_at DESC;
SELECT collections.* FROM collections INNER JOIN articles ON articles.collection_id = collections.id WHERE collections.user_id = 9903 ORDER BY collections.created_at DESC LIMIT 1;
SELECT DISTINCT collections.* FROM collections INNER JOIN articles ON articles.collection_id = collections.id WHERE collections.user_id = 9903 ORDER BY collections.created_at DESC LIMIT 1;
