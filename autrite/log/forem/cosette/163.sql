...
-- Original Query
SELECT tags.requires_approval FROM tags INNER JOIN taggings ON tags.id = taggings.tag_id WHERE taggings.taggable_id = 2428 AND taggings.taggable_type = 'Article' AND taggings.context = 'tags';
-- Rewritten Queries
