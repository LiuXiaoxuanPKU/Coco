...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 2378 AND articles.published = False AND published_at <= '2022-02-27 06:53:18.141518' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 2378 AND articles.published = False AND published_at <= '2022-02-27 06:53:18.141518' ORDER BY articles.published_at ASC LIMIT 1;
