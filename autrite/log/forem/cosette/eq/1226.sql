...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 8699 AND articles.published = False AND published_at <= '2022-02-27 07:11:05.642823' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 8699 AND articles.published = False AND published_at <= '2022-02-27 07:11:05.642823' ORDER BY articles.published_at ASC LIMIT 1;
