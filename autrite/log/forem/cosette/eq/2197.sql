...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 2614 AND articles.published = False AND published_at <= '2022-02-27 07:05:28.648999' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 2614 AND articles.published = False AND published_at <= '2022-02-27 07:05:28.648999' ORDER BY articles.published_at ASC LIMIT 1;
