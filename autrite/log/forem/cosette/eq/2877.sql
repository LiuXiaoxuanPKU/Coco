...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.organization_id = 3 AND notifications.notifiable_id = 9441 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'zuvakwhjmbnhaicnbpnspoz' LIMIT 4;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.organization_id = 3 AND notifications.notifiable_id = 9441 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'zuvakwhjmbnhaicnbpnspoz' LIMIT 4;
