...
-- Original Query
SELECT tag_adjustments.* FROM tag_adjustments WHERE tag_adjustments.article_id = 5307;
-- Rewritten Queries
SELECT tag_adjustments.* FROM tag_adjustments WHERE tag_adjustments.article_id = 5307 LIMIT 1;
