...
-- Original Query
SELECT taggings.* FROM taggings WHERE taggings.taggable_id = 6909 AND taggings.taggable_type = 'Article' AND taggings.tagger_id IS NULL AND taggings.tagger_type IS NULL AND taggings.context = 'tags' AND taggings.tag_id = 10024;
-- Rewritten Queries
SELECT taggings.* FROM taggings WHERE taggings.taggable_id = 6909 AND taggings.taggable_type = 'Article' AND taggings.tagger_id IS NULL AND taggings.tagger_type IS NULL AND taggings.context = 'tags' AND taggings.tag_id = 10024 LIMIT 1;
