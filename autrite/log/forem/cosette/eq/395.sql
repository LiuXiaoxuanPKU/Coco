...
-- Original Query
SELECT COUNT(*) FROM feedback_messages WHERE feedback_messages.category IN ('harassment', 'other', 'other', 'other') AND created_at > '2022-02-26 07:20:35.753700';
-- Rewritten Queries
SELECT COUNT(*) FROM feedback_messages WHERE feedback_messages.category IN ('harassment', 'other', 'other', 'other') AND created_at > '2022-02-26 07:20:35.753700' LIMIT 1;
