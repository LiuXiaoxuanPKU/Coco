...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 28 AND articles.published = False AND published_at <= '2022-02-27 07:05:29.280945' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 28 AND articles.published = False AND published_at <= '2022-02-27 07:05:29.280945' ORDER BY articles.published_at ASC LIMIT 1;
