...
-- Original Query
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 5770;
-- Rewritten Queries
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 5770 LIMIT 1;
