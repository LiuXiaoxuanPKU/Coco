...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '259/260/%' OR comments.ancestry = '259/260';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '259/260/%' OR comments.ancestry = '259/260' LIMIT 1;
