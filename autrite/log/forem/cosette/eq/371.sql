...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6033 AND articles.published = False AND published_at <= '2022-02-27 07:13:15.231921';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6033 AND articles.published = False AND published_at <= '2022-02-27 07:13:15.231921' LIMIT 1;
