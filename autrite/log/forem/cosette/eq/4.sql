...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.slug IS NULL AND articles.user_id = 5173 LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE False AND articles.user_id = 5173 LIMIT 5;
