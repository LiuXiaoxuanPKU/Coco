...
-- Original Query
SELECT tag_adjustments.* FROM tag_adjustments WHERE tag_adjustments.article_id = 3729;
-- Rewritten Queries
SELECT tag_adjustments.* FROM tag_adjustments WHERE tag_adjustments.article_id = 3729 LIMIT 1;
