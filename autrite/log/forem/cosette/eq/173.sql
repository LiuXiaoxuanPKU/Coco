...
-- Original Query
SELECT identities.provider FROM identities WHERE identities.user_id = 4337;
-- Rewritten Queries
SELECT identities.provider FROM identities WHERE identities.user_id = 4337 LIMIT 1;
