...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 3604 AND articles.published = False AND published_at <= '2022-02-27 07:00:02.356459' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 3604 AND articles.published = False AND published_at <= '2022-02-27 07:00:02.356459' ORDER BY articles.published_at ASC LIMIT 1;
