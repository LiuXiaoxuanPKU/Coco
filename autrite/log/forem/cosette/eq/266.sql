...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '317/318/%' OR comments.ancestry = '317/318';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '317/318/%' OR comments.ancestry = '317/318' LIMIT 1;
