...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '239/240/%' OR comments.ancestry = '239/240';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '239/240/%' OR comments.ancestry = '239/240' LIMIT 1;
