...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4512 AND articles.published = False AND published_at <= '2022-02-27 07:07:38.780143' AND created_at > '2022-02-27 07:02:38.780248';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4512 AND articles.published = False AND published_at <= '2022-02-27 07:07:38.780143' AND created_at > '2022-02-27 07:02:38.780248' LIMIT 1;
