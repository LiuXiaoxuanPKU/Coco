...
-- Original Query
SELECT tags.badge_id FROM tags WHERE tags.name = 'dveaqgyikbgobbhqntegbxdzn';
-- Rewritten Queries
SELECT tags.badge_id FROM tags WHERE tags.name = 'dveaqgyikbgobbhqntegbxdzn' LIMIT 1;
