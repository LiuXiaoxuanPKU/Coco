...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '251/252/%' OR comments.ancestry = '251/252';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '251/252/%' OR comments.ancestry = '251/252' LIMIT 1;
