...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 659 AND articles.published = False AND published_at <= '2022-02-27 07:04:13.211417' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 659 AND articles.published = False AND published_at <= '2022-02-27 07:04:13.211417' ORDER BY articles.published_at ASC LIMIT 1;
