...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 255 AND articles.published = False AND published_at <= '2022-02-27 07:07:37.731386' AND created_at > '2022-02-27 07:02:37.731491';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 255 AND articles.published = False AND published_at <= '2022-02-27 07:07:37.731386' AND created_at > '2022-02-27 07:02:37.731491' LIMIT 1;
