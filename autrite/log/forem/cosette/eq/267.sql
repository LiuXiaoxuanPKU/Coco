...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '243/244/%' OR comments.ancestry = '243/244';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '243/244/%' OR comments.ancestry = '243/244' LIMIT 1;
