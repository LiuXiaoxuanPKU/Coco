...
-- Original Query
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 6250;
-- Rewritten Queries
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 6250 LIMIT 1;
