...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 1443 AND articles.published = False AND published_at <= '2022-02-27 07:17:04.227841' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 1443 AND articles.published = False AND published_at <= '2022-02-27 07:17:04.227841' ORDER BY articles.published_at ASC LIMIT 1;
