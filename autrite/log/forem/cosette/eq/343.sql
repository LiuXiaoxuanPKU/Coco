...
-- Original Query
SELECT podcast_episode_appearances.* FROM podcast_episode_appearances WHERE podcast_episode_appearances.podcast_episode_id = 2386;
-- Rewritten Queries
SELECT podcast_episode_appearances.* FROM podcast_episode_appearances WHERE podcast_episode_appearances.podcast_episode_id = 2386 LIMIT 1;
