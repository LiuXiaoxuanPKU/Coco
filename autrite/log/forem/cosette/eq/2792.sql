...
-- Original Query
SELECT COUNT(*) AS count_all, DATE(created_at) AS date_created_at FROM comments WHERE comments.user_id = 9609 AND created_at > '2022-02-20 07:16:57.093240' GROUP BY DATE(created_at);
-- Rewritten Queries
SELECT COUNT(*) AS count_all, DATE(created_at) AS date_created_at FROM comments WHERE comments.user_id = 9609 AND created_at > '2022-02-20 07:16:57.093240' GROUP BY DATE(created_at) LIMIT 1;
