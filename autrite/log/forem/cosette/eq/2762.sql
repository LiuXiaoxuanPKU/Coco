...
-- Original Query
SELECT follows.* FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9923 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9923 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC LIMIT 1;
