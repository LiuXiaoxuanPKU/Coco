...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 6501 AND articles.published = False AND published_at <= '2022-02-27 07:07:30.639440' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 6501 AND articles.published = False AND published_at <= '2022-02-27 07:07:30.639440' ORDER BY articles.published_at ASC LIMIT 1;
