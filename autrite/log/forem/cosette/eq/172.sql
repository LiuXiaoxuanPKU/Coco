...
-- Original Query
SELECT notifications.* FROM notifications WHERE notifications.user_id = 372;
-- Rewritten Queries
SELECT notifications.* FROM notifications WHERE notifications.user_id = 372 LIMIT 1;
