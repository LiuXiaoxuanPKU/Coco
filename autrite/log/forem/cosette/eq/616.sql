...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 961 AND articles.published = False AND published_at <= '2022-02-27 07:20:31.440137' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 961 AND articles.published = False AND published_at <= '2022-02-27 07:20:31.440137' ORDER BY articles.published_at ASC LIMIT 1;
