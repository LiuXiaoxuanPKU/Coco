...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 8256 AND articles.published = False AND published_at <= '2022-02-27 07:13:14.833630';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 8256 AND articles.published = False AND published_at <= '2022-02-27 07:13:14.833630' LIMIT 1;
