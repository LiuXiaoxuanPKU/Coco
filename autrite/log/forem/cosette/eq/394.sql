...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6229 AND articles.published = False AND published_at <= '2022-02-27 07:12:50.482863';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6229 AND articles.published = False AND published_at <= '2022-02-27 07:12:50.482863' LIMIT 1;
