...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '235/236/%' OR comments.ancestry = '235/236';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '235/236/%' OR comments.ancestry = '235/236' LIMIT 1;
