...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 9697 AND articles.published = False AND published_at <= '2022-02-27 07:10:50.270755' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 9697 AND articles.published = False AND published_at <= '2022-02-27 07:10:50.270755' ORDER BY articles.published_at ASC LIMIT 1;
