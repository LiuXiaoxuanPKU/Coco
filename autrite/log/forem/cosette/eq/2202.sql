...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 7433 AND articles.published = False AND published_at <= '2022-02-27 06:53:11.055302' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 7433 AND articles.published = False AND published_at <= '2022-02-27 06:53:11.055302' ORDER BY articles.published_at ASC LIMIT 1;
