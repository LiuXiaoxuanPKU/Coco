...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 784 AND articles.published = False AND published_at <= '2022-02-27 07:14:34.326745' AND created_at > '2022-02-27 07:09:34.326852';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 784 AND articles.published = False AND published_at <= '2022-02-27 07:14:34.326745' AND created_at > '2022-02-27 07:09:34.326852' LIMIT 1;
