...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 3550 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 3666 AND notifications.notifiable_type = 'Broadcast' AND notifications.action IS NULL LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 3550 AND False AND notifications.notifiable_id = 3666 AND notifications.notifiable_type = 'Broadcast' AND notifications.action IS NULL LIMIT 2;
