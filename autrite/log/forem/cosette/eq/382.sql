...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 7888 AND articles.published = False AND published_at <= '2022-02-27 07:13:13.575142';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 7888 AND articles.published = False AND published_at <= '2022-02-27 07:13:13.575142' LIMIT 1;
