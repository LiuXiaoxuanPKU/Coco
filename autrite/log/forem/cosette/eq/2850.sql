...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 990 AND articles.published = False AND published_at <= '2022-02-27 07:07:37.290992' AND created_at > '2022-02-27 07:02:37.291095';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 990 AND articles.published = False AND published_at <= '2022-02-27 07:07:37.290992' AND created_at > '2022-02-27 07:02:37.291095' LIMIT 1;
