...
-- Original Query
SELECT comments.* FROM comments WHERE comments.body_markdown = '' AND comments.commentable_id = 22 AND comments.ancestry IS NULL;
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.body_markdown = '' AND comments.commentable_id = 22 AND comments.ancestry IS NULL LIMIT 1;
