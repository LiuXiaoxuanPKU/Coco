...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '431/%' OR comments.ancestry = '431';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '431/%' OR comments.ancestry = '431' LIMIT 1;
