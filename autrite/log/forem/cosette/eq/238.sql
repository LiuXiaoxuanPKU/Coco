...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '338/%' OR comments.ancestry = '338';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '338/%' OR comments.ancestry = '338' LIMIT 1;
