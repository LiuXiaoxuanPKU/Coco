...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 2288 AND articles.published = False AND published_at <= '2022-02-27 07:03:27.057987' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 2288 AND articles.published = False AND published_at <= '2022-02-27 07:03:27.057987' ORDER BY articles.published_at ASC LIMIT 1;
