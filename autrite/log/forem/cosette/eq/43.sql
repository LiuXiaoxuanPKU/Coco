...
-- Original Query
SELECT pages.* FROM pages WHERE pages.slug = 'scothcfjevmulcwtubontmrbdqkavtlifefdfdouttdxlqelnpbniaotbokpbsppauqjaaemmggkqppuwcglhvprjnlymcirbelocsllxgmvknjoeweur';
-- Rewritten Queries
SELECT pages.* FROM pages WHERE pages.slug = 'scothcfjevmulcwtubontmrbdqkavtlifefdfdouttdxlqelnpbniaotbokpbsppauqjaaemmggkqppuwcglhvprjnlymcirbelocsllxgmvknjoeweur' LIMIT 1;
