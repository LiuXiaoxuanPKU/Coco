...
-- Original Query
SELECT podcast_episodes.* FROM podcast_episodes WHERE podcast_episodes.id = 7201;
-- Rewritten Queries
SELECT podcast_episodes.* FROM podcast_episodes WHERE podcast_episodes.id = 7201 LIMIT 1;
