...
-- Original Query
SELECT sponsorships.* FROM sponsorships WHERE sponsorships.organization_id = 6736;
-- Rewritten Queries
SELECT sponsorships.* FROM sponsorships WHERE sponsorships.organization_id = 6736 LIMIT 1;
