...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '309/310/%' OR comments.ancestry = '309/310';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '309/310/%' OR comments.ancestry = '309/310' LIMIT 1;
