...
-- Original Query
SELECT page_views.user_id FROM page_views WHERE created_at > '2022-02-25 07:20:35.129165' AND created_at < '2022-02-26 07:20:35.129219' AND page_views.user_id IS NOT NULL;
-- Rewritten Queries
SELECT page_views.user_id FROM page_views WHERE created_at > '2022-02-25 07:20:35.129165' AND created_at < '2022-02-26 07:20:35.129219' AND page_views.user_id IS NOT NULL LIMIT 1;
