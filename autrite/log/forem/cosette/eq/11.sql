...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7797 AND identities.provider = 'github';
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7797 AND identities.provider = 'github' LIMIT 1;
