...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'bwnl' AND articles.user_id = 4666 AND articles.title IS NULL LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'bwnl' AND articles.user_id = 4666 AND False LIMIT 9;
