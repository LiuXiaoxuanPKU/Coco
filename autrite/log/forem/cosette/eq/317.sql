...
-- Original Query
SELECT taggings.* FROM taggings WHERE taggings.taggable_id = 822 AND taggings.taggable_type = 'Article' AND taggings.context = 'tags';
-- Rewritten Queries
SELECT taggings.* FROM taggings WHERE taggings.taggable_id = 822 AND taggings.taggable_type = 'Article' AND taggings.context = 'tags' LIMIT 1;
