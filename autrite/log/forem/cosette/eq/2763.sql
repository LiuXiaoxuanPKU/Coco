...
-- Original Query
SELECT follows.* FROM follows WHERE follows.followable_type = 'User' AND follows.followable_id = 4672 AND created_at > '2022-02-26 07:17:05.888107' ORDER BY follows.created_at DESC;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.followable_type = 'User' AND follows.followable_id = 4672 AND created_at > '2022-02-26 07:17:05.888107' ORDER BY follows.created_at DESC LIMIT 1;
