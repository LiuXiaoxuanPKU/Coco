...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 374 AND articles.published = False AND published_at <= '2022-02-27 07:12:42.393648';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 374 AND articles.published = False AND published_at <= '2022-02-27 07:12:42.393648' LIMIT 1;
