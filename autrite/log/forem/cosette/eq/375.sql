...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 8614 AND articles.published = False AND published_at <= '2022-02-27 07:12:41.329739';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 8614 AND articles.published = False AND published_at <= '2022-02-27 07:12:41.329739' LIMIT 1;
