...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6259 AND articles.published = False AND published_at <= '2022-02-27 07:20:37.575614';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6259 AND articles.published = False AND published_at <= '2022-02-27 07:20:37.575614' LIMIT 1;
