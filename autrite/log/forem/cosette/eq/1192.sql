...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 68 AND articles.published = False AND published_at <= '2022-02-27 06:52:50.118717' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 68 AND articles.published = False AND published_at <= '2022-02-27 06:52:50.118717' ORDER BY articles.published_at ASC LIMIT 1;
