...
-- Original Query
SELECT page_views.user_id FROM page_views WHERE created_at > '2022-02-25 07:20:34.182244' AND created_at < '2022-02-26 07:20:34.182298' AND page_views.user_id IS NOT NULL;
-- Rewritten Queries
SELECT page_views.user_id FROM page_views WHERE created_at > '2022-02-25 07:20:34.182244' AND created_at < '2022-02-26 07:20:34.182298' AND page_views.user_id IS NOT NULL LIMIT 1;
