...
-- Original Query
SELECT notifications.* FROM notifications WHERE notifications.user_id = 8197;
-- Rewritten Queries
SELECT notifications.* FROM notifications WHERE notifications.user_id = 8197 LIMIT 1;
