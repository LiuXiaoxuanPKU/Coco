...
-- Original Query
SELECT articles.* FROM articles WHERE articles.user_id = 3478 AND articles.slug IS NULL LIMIT 8;
-- Rewritten Queries
SELECT articles.* FROM articles WHERE articles.user_id = 3478 AND False LIMIT 8;
