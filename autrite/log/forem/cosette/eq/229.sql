...
-- Original Query
SELECT COUNT(*) FROM comments WHERE comments.ancestry LIKE '335/%' OR comments.ancestry = '335';
-- Rewritten Queries
SELECT COUNT(*) FROM comments WHERE comments.ancestry LIKE '335/%' OR comments.ancestry = '335' LIMIT 1;
