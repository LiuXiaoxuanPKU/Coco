...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 9452 AND articles.published = False AND published_at <= '2022-02-27 07:12:45.397991';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 9452 AND articles.published = False AND published_at <= '2022-02-27 07:12:45.397991' LIMIT 1;
