...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 1611 AND articles.published = False AND published_at <= '2022-02-27 07:12:45.005027';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 1611 AND articles.published = False AND published_at <= '2022-02-27 07:12:45.005027' LIMIT 1;
