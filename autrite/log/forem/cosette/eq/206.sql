...
-- Original Query
SELECT feedback_messages.* FROM feedback_messages WHERE feedback_messages.reporter_id = 9509;
-- Rewritten Queries
SELECT feedback_messages.* FROM feedback_messages WHERE feedback_messages.reporter_id = 9509 LIMIT 1;
