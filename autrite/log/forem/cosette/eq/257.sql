...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '231/232/%' OR comments.ancestry = '231/232';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '231/232/%' OR comments.ancestry = '231/232' LIMIT 1;
