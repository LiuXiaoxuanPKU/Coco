...
-- Original Query
SELECT podcast_episodes.title FROM podcast_episodes WHERE podcast_episodes.podcast_id = 7237;
-- Rewritten Queries
SELECT podcast_episodes.title FROM podcast_episodes WHERE podcast_episodes.podcast_id = 7237 LIMIT 1;
