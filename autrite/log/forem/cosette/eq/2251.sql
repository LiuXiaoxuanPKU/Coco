...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 2455 AND articles.published = False AND published_at <= '2022-02-27 06:51:05.375978' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 2455 AND articles.published = False AND published_at <= '2022-02-27 06:51:05.375978' ORDER BY articles.published_at ASC LIMIT 1;
