...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5238 AND articles.published = False AND published_at <= '2022-02-27 07:12:51.287210';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5238 AND articles.published = False AND published_at <= '2022-02-27 07:12:51.287210' LIMIT 1;
