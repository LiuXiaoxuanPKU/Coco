...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 2274 AND articles.published = False AND published_at <= '2022-02-27 07:09:01.243972' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 2274 AND articles.published = False AND published_at <= '2022-02-27 07:09:01.243972' ORDER BY articles.published_at ASC LIMIT 1;
