...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 6451 AND articles.published = True AND published_at <= '2022-02-27 06:52:40.309439' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 6451 AND articles.published = True AND published_at <= '2022-02-27 06:52:40.309439' ORDER BY articles.published_at ASC LIMIT 1;
