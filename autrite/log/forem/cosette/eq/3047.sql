...
-- Original Query
SELECT articles.id, articles.user_id, articles.organization_id, articles.collection_id, articles.title, articles.description, articles.main_image, articles.published_at, articles.crossposted_at, articles.social_image, articles.cached_tag_list, articles.slug, articles.path, articles.canonical_url, articles.comments_count, articles.public_reactions_count, articles.created_at, articles.edited_at, articles.last_comment_at, articles.published, articles.updated_at, articles.video_thumbnail_url, articles.reading_time FROM articles WHERE articles.id = 3761;
-- Rewritten Queries
SELECT articles.id, articles.user_id, articles.organization_id, articles.collection_id, articles.title, articles.description, articles.main_image, articles.published_at, articles.crossposted_at, articles.social_image, articles.cached_tag_list, articles.slug, articles.path, articles.canonical_url, articles.comments_count, articles.public_reactions_count, articles.created_at, articles.edited_at, articles.last_comment_at, articles.published, articles.updated_at, articles.video_thumbnail_url, articles.reading_time FROM articles WHERE articles.id = 3761 LIMIT 1;
