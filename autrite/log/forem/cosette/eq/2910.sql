...
-- Original Query
SELECT users.* FROM users WHERE users.id IN (SELECT follows.follower_id FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9115 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC);
-- Rewritten Queries
SELECT users.* FROM users WHERE users.id IN (SELECT follows.follower_id FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9115 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC) LIMIT 1;
SELECT users.* FROM users WHERE users.id IN (SELECT follows.follower_id FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9115 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC LIMIT 1);
SELECT users.* FROM users WHERE users.id IN (SELECT follows.follower_id FROM follows WHERE follows.followable_type = 'Organization' AND follows.followable_id = 9115 AND created_at > '2022-02-26 07:10:08.245725' ORDER BY follows.created_at DESC LIMIT 1) LIMIT 1;
