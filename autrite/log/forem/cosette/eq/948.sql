...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 1349 AND articles.published = False AND published_at <= '2022-02-27 06:52:44.418827' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 1349 AND articles.published = False AND published_at <= '2022-02-27 06:52:44.418827' ORDER BY articles.published_at ASC LIMIT 1;
