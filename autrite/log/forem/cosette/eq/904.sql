...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 5075 AND articles.published = False AND published_at <= '2022-02-27 07:11:29.831306' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 5075 AND articles.published = False AND published_at <= '2022-02-27 07:11:29.831306' ORDER BY articles.published_at ASC LIMIT 1;
