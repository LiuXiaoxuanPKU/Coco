...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 3953 AND articles.published = False AND published_at <= '2022-02-27 07:14:44.689117' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 3953 AND articles.published = False AND published_at <= '2022-02-27 07:14:44.689117' ORDER BY articles.published_at ASC LIMIT 1;
