...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2040 AND articles.published = False AND published_at <= '2022-02-27 07:13:13.113564';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2040 AND articles.published = False AND published_at <= '2022-02-27 07:13:13.113564' LIMIT 1;
