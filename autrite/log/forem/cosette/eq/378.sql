...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6173 AND articles.published = False AND published_at <= '2022-02-27 06:53:10.598928';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6173 AND articles.published = False AND published_at <= '2022-02-27 06:53:10.598928' LIMIT 1;
