...
-- Original Query
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'qlcot';
-- Rewritten Queries
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'qlcot' LIMIT 1;
