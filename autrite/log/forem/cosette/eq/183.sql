...
-- Original Query
SELECT COUNT(*) FROM badge_achievements WHERE badge_achievements.user_id = 1852;
-- Rewritten Queries
SELECT COUNT(*) FROM badge_achievements WHERE badge_achievements.user_id = 1852 LIMIT 1;
