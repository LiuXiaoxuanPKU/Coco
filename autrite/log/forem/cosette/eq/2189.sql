...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 3931 AND articles.published = False AND published_at <= '2022-02-27 07:15:38.050732' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 3931 AND articles.published = False AND published_at <= '2022-02-27 07:15:38.050732' ORDER BY articles.published_at ASC LIMIT 1;
