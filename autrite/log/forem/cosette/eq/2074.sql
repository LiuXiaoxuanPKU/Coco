...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 3784 AND articles.published = False AND published_at <= '2022-02-27 06:51:14.975608' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 3784 AND articles.published = False AND published_at <= '2022-02-27 06:51:14.975608' ORDER BY articles.published_at ASC LIMIT 1;
