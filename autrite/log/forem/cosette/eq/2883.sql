...
-- Original Query
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 8808 AND comments.user_id = 7763 AND comments.ancestry IS NULL AND comments.commentable_id IS NULL AND comments.commentable_type IS NULL LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 8808 AND comments.user_id = 7763 AND comments.ancestry IS NULL AND False AND comments.commentable_type IS NULL LIMIT 6;
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 8808 AND comments.user_id = 7763 AND comments.ancestry IS NULL AND comments.commentable_id IS NULL AND False LIMIT 6;
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 8808 AND comments.user_id = 7763 AND comments.ancestry IS NULL AND False AND False LIMIT 6;
