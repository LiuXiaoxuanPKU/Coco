...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2760 AND articles.published = False AND published_at <= '2022-02-27 07:12:50.890808';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2760 AND articles.published = False AND published_at <= '2022-02-27 07:12:50.890808' LIMIT 1;
