...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2313 AND articles.published = False AND published_at <= '2022-02-27 07:12:46.195781';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 2313 AND articles.published = False AND published_at <= '2022-02-27 07:12:46.195781' LIMIT 1;
