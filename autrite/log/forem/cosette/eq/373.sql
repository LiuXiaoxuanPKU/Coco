...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6727 AND articles.published = False AND published_at <= '2022-02-27 06:50:38.576143';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6727 AND articles.published = False AND published_at <= '2022-02-27 06:50:38.576143' LIMIT 1;
