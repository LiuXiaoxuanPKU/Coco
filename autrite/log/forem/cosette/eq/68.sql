...
-- Original Query
SELECT pages.* FROM pages WHERE pages.slug = 'hklspequddfujwwarqivowfhybuaskpoudaimmlsvllbxruqodlrxdfivjpbiwwfuxqubhrxrtukyqcaogrnueseowwjsxtqroivjpjkfltvojmqgalfxfknlijkafvztkvinrgxgzpuedcvldenneigjqpjpwrjruscpcvxxtgyjbbchtbfu';
-- Rewritten Queries
SELECT pages.* FROM pages WHERE pages.slug = 'hklspequddfujwwarqivowfhybuaskpoudaimmlsvllbxruqodlrxdfivjpbiwwfuxqubhrxrtukyqcaogrnueseowwjsxtqroivjpjkfltvojmqgalfxfknlijkafvztkvinrgxgzpuedcvldenneigjqpjpwrjruscpcvxxtgyjbbchtbfu' LIMIT 1;
