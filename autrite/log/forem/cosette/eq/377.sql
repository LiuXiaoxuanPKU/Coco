...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 3826 AND articles.published = False AND published_at <= '2022-02-27 07:12:44.577749';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 3826 AND articles.published = False AND published_at <= '2022-02-27 07:12:44.577749' LIMIT 1;
