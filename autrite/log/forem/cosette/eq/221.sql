...
-- Original Query
SELECT COUNT(*) FROM notifications WHERE notifications.user_id = 3193 AND notifications.read = False;
-- Rewritten Queries
SELECT COUNT(*) FROM notifications WHERE notifications.user_id = 3193 AND notifications.read = False LIMIT 1;
