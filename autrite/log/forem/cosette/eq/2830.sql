...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4829 AND articles.published = False AND published_at <= '2022-02-27 07:07:39.150954' AND created_at > '2022-02-27 07:02:39.151071';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4829 AND articles.published = False AND published_at <= '2022-02-27 07:07:39.150954' AND created_at > '2022-02-27 07:02:39.151071' LIMIT 1;
