...
-- Original Query
SELECT COUNT(*) AS count_all, DATE(created_at) AS date_created_at FROM comments WHERE comments.user_id = 8316 AND created_at > '2022-02-20 07:10:39.075605' GROUP BY DATE(created_at);
-- Rewritten Queries
SELECT COUNT(*) AS count_all, DATE(created_at) AS date_created_at FROM comments WHERE comments.user_id = 8316 AND created_at > '2022-02-20 07:10:39.075605' GROUP BY DATE(created_at) LIMIT 1;
