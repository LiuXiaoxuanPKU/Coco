...
-- Original Query
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'qyultunznawffibtszhepx';
-- Rewritten Queries
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'qyultunznawffibtszhepx' LIMIT 1;
