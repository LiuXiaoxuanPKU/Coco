...
-- Original Query
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '437/%' OR comments.ancestry = '437';
-- Rewritten Queries
SELECT comments.* FROM comments WHERE comments.ancestry LIKE '437/%' OR comments.ancestry = '437' LIMIT 1;
