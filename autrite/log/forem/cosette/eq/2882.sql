...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 2416 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 5362 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'cgsltpkarjqvthrxqxprtdwzsehczgjyrmxuhtyuehfydqdznjskdrhrmnrxnyqlrrffkqciiggzdwehwfbhoezhecpgrblhujvomtlutngebzekhepmjywsimeoukauqqzjywclcedllrjvsrjldbvgzuegbwdkvasrwcyvyievvhymtegyh' LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 2416 AND False AND notifications.notifiable_id = 5362 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'cgsltpkarjqvthrxqxprtdwzsehczgjyrmxuhtyuehfydqdznjskdrhrmnrxnyqlrrffkqciiggzdwehwfbhoezhecpgrblhujvomtlutngebzekhepmjywsimeoukauqqzjywclcedllrjvsrjldbvgzuegbwdkvasrwcyvyievvhymtegyh' LIMIT 8;
