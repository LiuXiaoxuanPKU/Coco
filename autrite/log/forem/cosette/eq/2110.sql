...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 8607 AND articles.published = False AND published_at <= '2022-02-27 07:17:13.528333' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 8607 AND articles.published = False AND published_at <= '2022-02-27 07:17:13.528333' ORDER BY articles.published_at ASC LIMIT 1;
