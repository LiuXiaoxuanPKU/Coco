...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.user_id = 4044 AND reactions.category = 'thinking';
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.user_id = 4044 AND reactions.category = 'thinking' LIMIT 1;
