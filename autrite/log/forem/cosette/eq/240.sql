...
-- Original Query
SELECT COUNT(*) FROM comments WHERE comments.ancestry LIKE '1012/%' OR comments.ancestry = '1012';
-- Rewritten Queries
SELECT COUNT(*) FROM comments WHERE comments.ancestry LIKE '1012/%' OR comments.ancestry = '1012' LIMIT 1;
