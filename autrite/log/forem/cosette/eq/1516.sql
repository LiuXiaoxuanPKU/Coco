...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 5167 AND articles.published = True AND published_at <= '2022-02-27 07:12:41.804592' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 5167 AND articles.published = True AND published_at <= '2022-02-27 07:12:41.804592' ORDER BY articles.published_at ASC LIMIT 1;
