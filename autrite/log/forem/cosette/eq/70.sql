...
-- Original Query
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 5445 AND comments.user_id = 4144 AND comments.ancestry IS NULL AND comments.commentable_id IS NULL AND comments.commentable_type IS NULL LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 5445 AND comments.user_id = 4144 AND comments.ancestry IS NULL AND False AND comments.commentable_type IS NULL LIMIT 9;
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 5445 AND comments.user_id = 4144 AND comments.ancestry IS NULL AND comments.commentable_id IS NULL AND False LIMIT 9;
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 5445 AND comments.user_id = 4144 AND comments.ancestry IS NULL AND False AND False LIMIT 9;
