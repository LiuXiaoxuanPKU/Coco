...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 5561 AND articles.published = False AND published_at <= '2022-02-27 07:12:06.551732' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 5561 AND articles.published = False AND published_at <= '2022-02-27 07:12:06.551732' ORDER BY articles.published_at ASC LIMIT 1;
