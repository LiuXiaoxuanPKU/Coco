...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5473 AND articles.published = False AND published_at <= '2022-02-27 06:52:21.399754';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5473 AND articles.published = False AND published_at <= '2022-02-27 06:52:21.399754' LIMIT 1;
