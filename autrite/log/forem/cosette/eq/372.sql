...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5679 AND articles.published = False AND published_at <= '2022-02-27 07:12:43.735688';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 5679 AND articles.published = False AND published_at <= '2022-02-27 07:12:43.735688' LIMIT 1;
