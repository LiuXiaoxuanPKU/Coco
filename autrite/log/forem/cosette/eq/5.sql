...
-- Original Query
SELECT articles.* FROM articles WHERE articles.user_id = 9617 AND articles.slug IS NULL LIMIT 9;
-- Rewritten Queries
SELECT articles.* FROM articles WHERE articles.user_id = 9617 AND False LIMIT 9;
