...
-- Original Query
SELECT DISTINCT github_repos.* FROM github_repos WHERE github_repos.user_id = 9459 AND github_repos.featured = False;
-- Rewritten Queries
SELECT github_repos.* FROM github_repos WHERE github_repos.user_id = 9459 AND github_repos.featured = False;
