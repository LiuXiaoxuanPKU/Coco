...
-- Original Query
SELECT tags.id, tags.alias_for, tags.badge_id, tags.bg_color_hex, tags.category, tags.created_at, tags.hotness_score, tags.keywords_for_search, tags.name, tags.pretty_name, tags.profile_image, tags.requires_approval, tags.rules_html, tags.rules_markdown, tags.short_summary, tags.social_image, tags.social_preview_template, tags.submission_template, tags.supported, tags.taggings_count, tags.text_color_hex, tags.updated_at, tags.wiki_body_html, tags.wiki_body_markdown FROM tags WHERE name = 'bobofogololo' OR name = 'spla' OR name = 'bla';
-- Rewritten Queries
SELECT tags.id, tags.alias_for, tags.badge_id, tags.bg_color_hex, tags.category, tags.created_at, tags.hotness_score, tags.keywords_for_search, tags.name, tags.pretty_name, tags.profile_image, tags.requires_approval, tags.rules_html, tags.rules_markdown, tags.short_summary, tags.social_image, tags.social_preview_template, tags.submission_template, tags.supported, tags.taggings_count, tags.text_color_hex, tags.updated_at, tags.wiki_body_html, tags.wiki_body_markdown FROM tags WHERE name = 'bobofogololo' OR name = 'spla' OR name = 'bla' LIMIT 1;
