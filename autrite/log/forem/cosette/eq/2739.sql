...
-- Original Query
SELECT organization_memberships.organization_id FROM organization_memberships WHERE organization_memberships.user_id = 7942 AND organization_memberships.type_of_user IN ('guest', 'guest');
-- Rewritten Queries
SELECT organization_memberships.organization_id FROM organization_memberships WHERE organization_memberships.user_id = 7942 AND organization_memberships.type_of_user IN ('guest', 'guest') LIMIT 1;
