...
-- Original Query
SELECT follows.* FROM follows WHERE follows.followable_type = 'User' AND follows.followable_id = 5202 AND created_at > '2022-02-26 07:10:11.592555' ORDER BY follows.created_at DESC;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.followable_type = 'User' AND follows.followable_id = 5202 AND created_at > '2022-02-26 07:10:11.592555' ORDER BY follows.created_at DESC LIMIT 1;
