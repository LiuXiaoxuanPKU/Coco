...
-- Original Query
SELECT articles.id FROM articles WHERE articles.user_id = 7046 AND articles.published = True AND published_at <= '2022-02-27 07:00:03.681220' ORDER BY articles.published_at ASC;
-- Rewritten Queries
SELECT articles.id FROM articles WHERE articles.user_id = 7046 AND articles.published = True AND published_at <= '2022-02-27 07:00:03.681220' ORDER BY articles.published_at ASC LIMIT 1;
