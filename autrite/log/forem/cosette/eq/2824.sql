...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6572 AND articles.published = False AND published_at <= '2022-02-27 07:07:38.052120' AND created_at > '2022-02-27 07:02:38.052237';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 6572 AND articles.published = False AND published_at <= '2022-02-27 07:07:38.052120' AND created_at > '2022-02-27 07:02:38.052237' LIMIT 1;
