...
-- Original Query
SELECT COUNT(*) FROM reactions WHERE reactions.category IN ('unicorn', 'thumbsup', 'readinglist');
-- Rewritten Queries
SELECT COUNT(*) FROM reactions WHERE reactions.category IN ('unicorn', 'thumbsup', 'readinglist') LIMIT 1;
