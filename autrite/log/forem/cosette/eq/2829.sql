...
-- Original Query
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4460 AND articles.published = True AND published_at <= '2022-02-27 07:17:22.161656' AND created_at > '2022-02-27 07:12:22.161766';
-- Rewritten Queries
SELECT COUNT(*) FROM articles WHERE articles.user_id = 4460 AND articles.published = True AND published_at <= '2022-02-27 07:17:22.161656' AND created_at > '2022-02-27 07:12:22.161766' LIMIT 1;
