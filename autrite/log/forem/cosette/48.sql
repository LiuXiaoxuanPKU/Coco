...
-- Original Query
SELECT github_repos.* FROM github_repos WHERE github_repos.user_id = 1021 AND github_repos.featured = False ORDER BY github_repos.stargazers_count DESC, github_repos.name ASC;
-- Rewritten Queries
SELECT github_repos.* FROM github_repos WHERE github_repos.user_id = 1021 AND github_repos.featured = False ORDER BY github_repos.stargazers_count DESC, github_repos.name ASC LIMIT 1;
