...
-- Original Query
SELECT devices.* FROM devices WHERE devices.user_id = 2482 AND devices.token IS NULL AND devices.platform = 'iOS' AND devices.consumer_app_id = 1274 LIMIT 5;
-- Rewritten Queries
SELECT devices.* FROM devices WHERE devices.user_id = 2482 AND False AND devices.platform = 'iOS' AND devices.consumer_app_id = 1274 LIMIT 5;
