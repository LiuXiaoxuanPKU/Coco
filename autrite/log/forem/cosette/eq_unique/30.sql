...
-- Original Query
SELECT mentions.* FROM mentions WHERE mentions.mentionable_id = 7242 AND mentions.mentionable_type = 'Article' AND mentions.user_id <> 2455;
-- Rewritten Queries
SELECT mentions.* FROM mentions WHERE mentions.mentionable_id = 7242 AND mentions.mentionable_type = 'Article' AND mentions.user_id <> 2455 LIMIT 1;
