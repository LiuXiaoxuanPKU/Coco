...
-- Original Query
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 273;
-- Rewritten Queries
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 273 LIMIT 1;
