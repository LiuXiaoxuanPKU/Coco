...
-- Original Query
SELECT pages.* FROM pages WHERE pages.slug = 'ohumrwheuvputsievrekurqijxjugisgametkzkqalquzlcawwu';
-- Rewritten Queries
SELECT pages.* FROM pages WHERE pages.slug = 'ohumrwheuvputsievrekurqijxjugisgametkzkqalquzlcawwu' LIMIT 1;
