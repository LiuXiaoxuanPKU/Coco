...
-- Original Query
SELECT 1 AS "one" FROM user_blocks WHERE user_blocks.blocker_id IS NULL AND user_blocks.blocked_id = 1377 LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM user_blocks WHERE False AND user_blocks.blocked_id = 1377 LIMIT 7;
