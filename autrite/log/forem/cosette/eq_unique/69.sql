...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.organization_id = 1 AND notifications.notifiable_id = 8136 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'hksqfmsniyeoqgymwhmsacsytqxjhvrjjlkafgobrnavekjwtwppzrtosobqymwfriqcoweogfswaxyrimmsikijwdtiiwgdscxezrskyuevhmepheiqvujstxpjfnpkugpvhlwgumv' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.organization_id = 1 AND notifications.notifiable_id = 8136 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'hksqfmsniyeoqgymwhmsacsytqxjhvrjjlkafgobrnavekjwtwppzrtosobqymwfriqcoweogfswaxyrimmsikijwdtiiwgdscxezrskyuevhmepheiqvujstxpjfnpkugpvhlwgumv' LIMIT 1;
