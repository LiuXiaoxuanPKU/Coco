...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 7266 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 4032 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'lhunyqinktlqmeptuotumpiucuitgcthhmdjwyhraxaquseyzyoffcxbxstqmkrqkdakvgwwimybitkzwigpyvclukewlswsiiwidjnmcaunrmdwvzrgmwbbyierdoceqgzkvgelohzpbppvytzluaaguuczfjx' LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 7266 AND False AND notifications.notifiable_id = 4032 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'lhunyqinktlqmeptuotumpiucuitgcthhmdjwyhraxaquseyzyoffcxbxstqmkrqkdakvgwwimybitkzwigpyvclukewlswsiiwidjnmcaunrmdwvzrgmwbbyierdoceqgzkvgelohzpbppvytzluaaguuczfjx' LIMIT 5;
