...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.category IN ('hands', 'thinking', 'like', 'hands', 'hands') AND reactions.reactable_id = 3737 AND reactions.reactable_type = 'User' AND reactions.user_id = 8886;
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.category IN ('hands', 'thinking', 'like', 'hands', 'hands') AND reactions.reactable_id = 3737 AND reactions.reactable_type = 'User' AND reactions.user_id = 8886 LIMIT 1;
