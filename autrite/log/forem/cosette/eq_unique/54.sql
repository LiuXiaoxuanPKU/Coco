...
-- Original Query
SELECT COUNT(*) FROM follows WHERE follows.blocked = True AND follows.follower_id = 2992 AND follows.follower_type = 'User' AND follows.followable_id = 8220 AND follows.followable_type = 'Organization';
-- Rewritten Queries
SELECT COUNT(*) FROM follows WHERE follows.blocked = True AND follows.follower_id = 2992 AND follows.follower_type = 'User' AND follows.followable_id = 8220 AND follows.followable_type = 'Organization' LIMIT 1;
