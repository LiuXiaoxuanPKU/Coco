...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.id <> 3109 AND notifications.organization_id = 3 AND notifications.notifiable_id = 8731 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'incjeizkwunuxxczrncclwodwnjdkxmejnkvcyubcctjoihfvpdgkkmdocyjycjnowoaaulvhfcstmdntgqfonwtsjdumsvjvelgbyilipdvveounhfasattgdzamjatuqikuspltcjsbuvwrignwlehupaiadlylwpmhnboyiwfordhncvvomomrvnbpcwwltswmpsbodfksjozyhopqtsztbe' LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.id <> 3109 AND notifications.organization_id = 3 AND notifications.notifiable_id = 8731 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'incjeizkwunuxxczrncclwodwnjdkxmejnkvcyubcctjoihfvpdgkkmdocyjycjnowoaaulvhfcstmdntgqfonwtsjdumsvjvelgbyilipdvveounhfasattgdzamjatuqikuspltcjsbuvwrignwlehupaiadlylwpmhnboyiwfordhncvvomomrvnbpcwwltswmpsbodfksjozyhopqtsztbe' LIMIT 2;
