...
-- Original Query
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 3076 AND organization_memberships.type_of_user IN ('guest', 'admin') AND organization_memberships.organization_id IS NULL LIMIT 4;
-- Rewritten Queries
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 3076 AND organization_memberships.type_of_user IN ('guest', 'admin') AND False LIMIT 4;
