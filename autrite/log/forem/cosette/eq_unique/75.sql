...
-- Original Query
SELECT users.* FROM users INNER JOIN follows ON follows.followable_type = 'User' AND follows.followable_id = users.id WHERE follows.blocked = True AND follows.follower_id = 5833 AND follows.follower_type = 'User' AND follows.followable_type = 'User';
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN follows ON follows.followable_type = 'User' AND follows.followable_id = users.id WHERE follows.blocked = True AND follows.follower_id = 5833 AND follows.follower_type = 'User' AND follows.followable_type = 'User' LIMIT 1;
