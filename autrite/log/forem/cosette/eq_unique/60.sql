...
-- Original Query
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 966 AND organization_memberships.type_of_user = 'member' AND organization_memberships.organization_id IS NULL LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM organization_memberships WHERE organization_memberships.user_id = 966 AND organization_memberships.type_of_user = 'member' AND False LIMIT 10;
