...
-- Original Query
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'vhjxhhhkpgjttgppbrnldtfgprmjelmgnadjfpyrbbeotuygzvzhdoqbazlwgppnlgkmtykoohuatialqi';
-- Rewritten Queries
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'vhjxhhhkpgjttgppbrnldtfgprmjelmgnadjfpyrbbeotuygzvzhdoqbazlwgppnlgkmtykoohuatialqi' LIMIT 1;
