...
UNIQUE(broadcastable_type,broadcastable_id),
UNIQUE(title,type_of),
);
...
CREATE TABLE chat_channel_memberships (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint NOT NULL,
UNIQUE(chat_channel_id,user_id),
);
...
CREATE TABLE comments (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint,
UNIQUE(body_markdown,user_id,ancestry,commentable_id,commentable_type),
);
...
updated_at timestamp without time zone,
UNIQUE(followable_id,followable_type,follower_id,follower_type),
);
...
CREATE TABLE mentions (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint,
UNIQUE(user_id,mentionable_id,mentionable_type),
);
...
CREATE TABLE notification_subscriptions (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint NOT NULL,
UNIQUE(user_id,notifiable_type,notifiable_id),
);
...
CREATE TABLE notifications (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint,
UNIQUE(user_id,organization_id,notifiable_id,notifiable_type,action),
);
...
CREATE TABLE podcast_episode_appearances (
    ...
    updated_at timestamp(6) without time zone NOT NULL,
user_id bigint NOT NULL,
UNIQUE(podcast_episode_id,user_id),
);
...
updated_at timestamp without time zone NOT NULL,
UNIQUE(pinnable_id,profile_id,profile_type,pinnable_type),
);
...
CREATE TABLE reactions (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint,
UNIQUE(user_id,reactable_id,reactable_type,category),
);
...
CREATE TABLE response_templates (
    ...
    updated_at timestamp without time zone NOT NULL,
user_id bigint,
UNIQUE(content,user_id,type_of,content_type),
);
...
UNIQUE(subscriber_id,subscriber_email,user_subscription_sourceable_type,user_subscription_sourceable_id),
);
...
-- Original Query
SELECT articles.path, articles.title, articles.id, articles.published, articles.comments_count, articles.public_reactions_count, articles.cached_tag_list, articles.main_image, articles.main_image_background_hex_color, articles.updated_at, articles.slug, articles.video, articles.user_id, articles.organization_id, articles.video_source_url, articles.video_code, articles.video_thumbnail_url, articles.video_closed_caption_track_url, articles.experience_level_rating, articles.experience_level_rating_distribution, articles.cached_user, articles.cached_organization, articles.published_at, articles.crossposted_at, articles.description, articles.reading_time, articles.video_duration_in_seconds, articles.last_comment_at FROM articles INNER JOIN taggings ON articles.id = taggings.taggable_id WHERE taggings.tag_id = 10193 AND taggings.taggable_type = 'Article' AND articles.published = False AND published_at <= '2022-02-27 07:11:45.354171' AND published_at > '2022-02-20 07:11:45.354651' ORDER BY articles.public_reactions_count DESC LIMIT 6 OFFSET 1;
-- Rewritten Queries
SELECT articles.path, articles.title, articles.id, articles.published, articles.comments_count, articles.public_reactions_count, articles.cached_tag_list, articles.main_image, articles.main_image_background_hex_color, articles.updated_at, articles.slug, articles.video, articles.user_id, articles.organization_id, articles.video_source_url, articles.video_code, articles.video_thumbnail_url, articles.video_closed_caption_track_url, articles.experience_level_rating, articles.experience_level_rating_distribution, articles.cached_user, articles.cached_organization, articles.published_at, articles.crossposted_at, articles.description, articles.reading_time, articles.video_duration_in_seconds, articles.last_comment_at FROM articles WHERE articles.published = False AND published_at <= '2022-02-27 07:11:45.354171' AND published_at > '2022-02-20 07:11:45.354651' ORDER BY articles.public_reactions_count DESC LIMIT 6 OFFSET 1;
