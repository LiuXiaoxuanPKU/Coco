...
-- Original Query
SELECT consumer_apps.* FROM consumer_apps WHERE consumer_apps.app_bundle = 'ewwlufcixqciuxwoqtxrpiwxzkcemjpudzfqdqjvmyciuysqxeuhdontjbvvxntprgflpuirim' AND consumer_apps.platform = 'Android';
-- Rewritten Queries
SELECT consumer_apps.* FROM consumer_apps WHERE consumer_apps.app_bundle = 'ewwlufcixqciuxwoqtxrpiwxzkcemjpudzfqdqjvmyciuysqxeuhdontjbvvxntprgflpuirim' AND consumer_apps.platform = 'Android' LIMIT 1;
