...
-- Original Query
SELECT badge_achievements.badge_id FROM badge_achievements WHERE badge_achievements.user_id = 2206;
-- Rewritten Queries
SELECT badge_achievements.badge_id FROM badge_achievements WHERE badge_achievements.user_id = 2206 LIMIT 1;
