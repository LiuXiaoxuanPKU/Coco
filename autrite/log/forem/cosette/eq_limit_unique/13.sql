...
-- Original Query
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 3070;
-- Rewritten Queries
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 3070 LIMIT 1;
