...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.category IN ('thinking', 'thumbsup', 'unicorn', 'thinking', 'thinking') AND reactions.reactable_id = 1690 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 7310;
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.category IN ('thinking', 'thumbsup', 'unicorn', 'thinking', 'thinking') AND reactions.reactable_id = 1690 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 7310 LIMIT 1;
