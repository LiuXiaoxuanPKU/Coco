...
-- Original Query
SELECT users.name, users.username FROM users WHERE users.id = 1322 ORDER BY users.created_at ASC;
-- Rewritten Queries
SELECT users.name, users.username FROM users WHERE users.id = 1322 ORDER BY users.created_at ASC LIMIT 1;
