...
-- Original Query
SELECT podcast_episodes.* FROM podcast_episodes INNER JOIN podcasts ON podcasts.id = podcast_episodes.podcast_id WHERE podcast_episodes.podcast_id = 246 AND podcast_episodes.reachable = True AND podcasts.published = False AND podcast_episodes.slug = 'ouepskyhoeyyrb' LIMIT 9;
-- Rewritten Queries
SELECT podcast_episodes.* FROM podcast_episodes WHERE podcast_episodes.podcast_id = 246 AND podcast_episodes.reachable = True AND podcast_episodes.slug = 'ouepskyhoeyyrb' LIMIT 9;
