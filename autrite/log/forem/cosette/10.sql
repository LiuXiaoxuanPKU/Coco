...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.id != 6900 AND notifications.organization_id = 2 AND notifications.notifiable_id = 653 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'rkukzfgtpbhjqkhboassvvvwabrxxrypmsrpfxiqsztgiqwrdltuzugdttyfxygrnipddjboojulkxzoonsognvgkkhggonmvnwvpiygpkkxlwrhsklb' LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.id <> 6900 AND notifications.organization_id = 2 AND notifications.notifiable_id = 653 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'rkukzfgtpbhjqkhboassvvvwabrxxrypmsrpfxiqsztgiqwrdltuzugdttyfxygrnipddjboojulkxzoonsognvgkkhggonmvnwvpiygpkkxlwrhsklb' LIMIT 10;
