...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 8649 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 7615 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'eiyzyzzapyszgwoqglcqoatfozkjzuagpswhqpbiwbszmsbmjbiweegbszwolmuzdlrfrmoutourtcfdnsptgvdhphigufbfuseveuroeqxplwqftjbcwutxprraaeqlexesveaeedgnkcrcfygcppauupaubobqjjypmsiogqzvsfolspwebrzokslnzgsfcymcsysuvwysgnahlbbeewnxcerxaoinebcscllpyep' LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 8649 AND False AND notifications.notifiable_id = 7615 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'eiyzyzzapyszgwoqglcqoatfozkjzuagpswhqpbiwbszmsbmjbiweegbszwolmuzdlrfrmoutourtcfdnsptgvdhphigufbfuseveuroeqxplwqftjbcwutxprraaeqlexesveaeedgnkcrcfygcppauupaubobqjjypmsiogqzvsfolspwebrzokslnzgsfcymcsysuvwysgnahlbbeewnxcerxaoinebcscllpyep' LIMIT 5;
