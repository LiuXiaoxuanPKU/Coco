...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9529 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 7539 AND notifications.notifiable_type = 'Broadcast' AND notifications.action IS NULL LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9529 AND False AND notifications.notifiable_id = 7539 AND notifications.notifiable_type = 'Broadcast' AND notifications.action IS NULL LIMIT 8;
