...
-- Original Query
SELECT user_blocks.blocked_id FROM user_blocks WHERE user_blocks.blocker_id = 920;
-- Rewritten Queries
SELECT user_blocks.blocked_id FROM user_blocks WHERE user_blocks.blocker_id = 920 LIMIT 1;
