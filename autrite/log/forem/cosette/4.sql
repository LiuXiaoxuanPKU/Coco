...
-- Original Query
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id != 3501 AND comments.user_id = 4177 AND comments.ancestry IS NULL AND comments.commentable_id IS NULL AND comments.commentable_type IS NULL LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM comments WHERE comments.body_markdown = '' AND comments.id <> 3501 AND comments.user_id = 4177 AND comments.ancestry IS NULL AND False AND comments.commentable_type IS NULL LIMIT 5;
