...
-- Original Query
SELECT roles.resource_type FROM roles INNER JOIN users_roles ON roles.id = users_roles.role_id WHERE users_roles.user_id = 9761;
-- Rewritten Queries
SELECT roles.resource_type FROM roles LIMIT 1;
SELECT roles.resource_type FROM roles INNER JOIN users_roles ON roles.id = users_roles.role_id WHERE users_roles.user_id = 9761 LIMIT 1;
