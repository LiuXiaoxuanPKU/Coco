...
-- Original Query
SELECT 1 AS "one" FROM users_roles INNER JOIN roles ON roles.id = users_roles.role_id WHERE roles.name = 'trusted' LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM users_roles LIMIT 10;
