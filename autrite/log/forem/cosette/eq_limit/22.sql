...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7954 AND identities.provider = 'twitter' AND identities.provider = 'twitter';
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7954 AND identities.provider = 'twitter' AND identities.provider = 'twitter' LIMIT 1;
