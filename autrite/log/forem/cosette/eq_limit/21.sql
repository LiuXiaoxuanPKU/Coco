...
-- Original Query
SELECT identities.* FROM identities WHERE identities.user_id = 6103 AND identities.provider IN ('twitter', 'twitter', 'apple', 'twitter', 'github', 'facebook');
-- Rewritten Queries
SELECT identities.* FROM identities WHERE identities.user_id = 6103 AND identities.provider IN ('twitter', 'twitter', 'apple', 'twitter', 'github', 'facebook') LIMIT 1;
