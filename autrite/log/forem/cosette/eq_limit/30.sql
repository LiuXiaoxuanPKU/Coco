...
-- Original Query
SELECT tag_adjustments.tag_name FROM tag_adjustments WHERE tag_adjustments.article_id = 2673 AND tag_adjustments.adjustment_type = 'addition' AND tag_adjustments.status = 'resolved';
-- Rewritten Queries
SELECT tag_adjustments.tag_name FROM tag_adjustments WHERE tag_adjustments.article_id = 2673 AND tag_adjustments.adjustment_type = 'addition' AND tag_adjustments.status = 'resolved' LIMIT 1;
