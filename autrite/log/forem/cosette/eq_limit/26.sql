...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 1528 AND identities.provider IN ('apple', 'apple') AND identities.provider IN ('facebook', 'apple', 'facebook', 'apple', 'apple', 'twitter');
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 1528 AND identities.provider IN ('apple', 'apple') AND identities.provider IN ('facebook', 'apple', 'facebook', 'apple', 'apple', 'twitter') LIMIT 1;
