...
-- Original Query
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'bsrzxqvfruq';
-- Rewritten Queries
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'bsrzxqvfruq' LIMIT 1;
