...
-- Original Query
SELECT COUNT(*) FROM follows WHERE follows.blocked = 'false' AND follows.follower_id = 3988 AND follows.follower_type = 'User' AND follows.followable_id = 2999 AND follows.followable_type = 'User';
-- Rewritten Queries
SELECT COUNT(*) FROM follows WHERE follows.blocked = 'false' AND follows.follower_id = 3988 AND follows.follower_type = 'User' AND follows.followable_id = 2999 AND follows.followable_type = 'User' LIMIT 1;
