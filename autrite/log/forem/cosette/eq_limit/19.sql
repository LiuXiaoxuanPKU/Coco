...
-- Original Query
SELECT identities.provider FROM identities WHERE identities.user_id = 9709 AND identities.provider IN ('facebook', 'twitter');
-- Rewritten Queries
SELECT identities.provider FROM identities WHERE identities.user_id = 9709 AND identities.provider IN ('facebook', 'twitter') LIMIT 1;
