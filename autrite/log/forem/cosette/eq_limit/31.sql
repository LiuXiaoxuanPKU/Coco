...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 7856 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 8983 AND reactions.category IN ('unicorn', 'readinglist');
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 7856 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 8983 AND reactions.category IN ('unicorn', 'readinglist') LIMIT 1;
