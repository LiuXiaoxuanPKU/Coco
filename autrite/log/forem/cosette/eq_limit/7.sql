...
-- Original Query
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'jphvdoruzslebpoxlaxhvrjwqflhau';
-- Rewritten Queries
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'jphvdoruzslebpoxlaxhvrjwqflhau' LIMIT 1;
