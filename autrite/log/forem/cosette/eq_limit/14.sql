...
-- Original Query
SELECT badge_achievements.user_id FROM badge_achievements WHERE badge_achievements.badge_id = 1738;
-- Rewritten Queries
SELECT badge_achievements.user_id FROM badge_achievements WHERE badge_achievements.badge_id = 1738 LIMIT 1;
