...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 5101 AND notifications.id != 8671 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 4670 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'cqbkoqkjjuptliutmuxvs' LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 5101 AND notifications.id <> 8671 AND False AND notifications.notifiable_id = 4670 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'cqbkoqkjjuptliutmuxvs' LIMIT 7;
