...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.id <> 4261 AND notifications.organization_id = 1 AND notifications.notifiable_id = 8693 AND notifications.notifiable_type = 'Article' AND notifications.action = 'gvcugtortyrkvfxudtfuqpvmnfdqopmpwqlqcdrvnlrzxbwnevrtpdglmmqpylgzxhgivewhslphailbywkxejpekbhkvgsykepxotzsnzwmqasqhpuhagemqhtgkuvyogleinldmkewddtghsyucglfqwhqmlzggzkkzaipdwkyghjmuvxxaiqboaxctdezyrgmkspdcayjpnpmyzedhmdpbctayuhnbkgbcjdvujqumbujodqyyxeutzzfn' LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.id <> 4261 AND notifications.organization_id = 1 AND notifications.notifiable_id = 8693 AND notifications.notifiable_type = 'Article' AND notifications.action = 'gvcugtortyrkvfxudtfuqpvmnfdqopmpwqlqcdrvnlrzxbwnevrtpdglmmqpylgzxhgivewhslphailbywkxejpekbhkvgsykepxotzsnzwmqasqhpuhagemqhtgkuvyogleinldmkewddtghsyucglfqwhqmlzggzkkzaipdwkyghjmuvxxaiqboaxctdezyrgmkspdcayjpnpmyzedhmdpbctayuhnbkgbcjdvujqumbujodqyyxeutzzfn' LIMIT 7;
