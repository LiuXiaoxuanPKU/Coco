...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 1486 AND notifications.id <> 9675 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 6481 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'dzsvsxywnllnyafqxdjwlfqzvxnfnbpptktwrziowswusiqbxccjnamqybvctdfhrrplrhjcawkzhtxmddcmzuwibmhasyiwujhyextinudnvgrpkazxckszyzcbbvvywnlbpdrolsmewcshipkiolsjkecenqsbowrtoffylufvscvqbuaprklvqfspfngfhaoiyrucmelzhojizwxoxtoelcbkxcage' LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 1486 AND notifications.id <> 9675 AND False AND notifications.notifiable_id = 6481 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'dzsvsxywnllnyafqxdjwlfqzvxnfnbpptktwrziowswusiqbxccjnamqybvctdfhrrplrhjcawkzhtxmddcmzuwibmhasyiwujhyextinudnvgrpkazxckszyzcbbvvywnlbpdrolsmewcshipkiolsjkecenqsbowrtoffylufvscvqbuaprklvqfspfngfhaoiyrucmelzhojizwxoxtoelcbkxcage' LIMIT 2;
