...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id != 5650 AND articles.user_id = 7104 AND articles.title IS NULL LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id <> 5650 AND articles.user_id = 7104 AND False LIMIT 7;
