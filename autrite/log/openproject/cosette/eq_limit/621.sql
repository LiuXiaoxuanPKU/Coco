...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-87%' AND id <> 87 AND wiki_id = 1136;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-87%' AND id <> 87 AND wiki_id = 1136 LIMIT 1;
