...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 9909 AND scmid IN ('899a15dba03a3b350b89c3f537e4bbe02a03cdc9') ORDER BY changesets.committed_on DESC, changesets.id DESC, committed_on DESC;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 9909 AND scmid IN ('899a15dba03a3b350b89c3f537e4bbe02a03cdc9') ORDER BY changesets.committed_on DESC, changesets.id DESC, committed_on DESC LIMIT 1;
