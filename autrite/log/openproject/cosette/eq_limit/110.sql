...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'unrelatedpage%' AND wiki_id = 91;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'unrelatedpage%' AND wiki_id = 91 LIMIT 1;
