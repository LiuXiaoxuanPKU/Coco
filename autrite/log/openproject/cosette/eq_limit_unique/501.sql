...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 48 AND wiki_id = 252;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 48 AND wiki_id = 252 LIMIT 1;
