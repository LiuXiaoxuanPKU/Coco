...
-- Original Query
SELECT DISTINCT work_packages.* FROM work_packages INNER JOIN relations ON work_packages.id = relations.from_id WHERE relations.to_id = 1656 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0;
-- Rewritten Queries
SELECT DISTINCT work_packages.* FROM work_packages INNER JOIN relations ON work_packages.id = relations.from_id WHERE relations.to_id = 1656 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 LIMIT 1;
