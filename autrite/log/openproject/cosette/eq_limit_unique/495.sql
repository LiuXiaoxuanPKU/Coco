...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 45 AND wiki_id = 246;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 45 AND wiki_id = 246 LIMIT 1;
