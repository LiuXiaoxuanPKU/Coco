...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'newtitle%' AND id <> 55 AND wiki_id = 337;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'newtitle%' AND id <> 55 AND wiki_id = 337 LIMIT 1;
