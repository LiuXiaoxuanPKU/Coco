...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'an-old-page%' AND id <> 50 AND wiki_id = 256;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'an-old-page%' AND id <> 50 AND wiki_id = 256 LIMIT 1;
