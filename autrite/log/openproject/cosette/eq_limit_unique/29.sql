...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'alert-foo%' AND wiki_id = 499;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'alert-foo%' AND wiki_id = 499 LIMIT 1;
