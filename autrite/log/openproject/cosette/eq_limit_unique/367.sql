...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-29%' AND wiki_id = 211;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-29%' AND wiki_id = 211 LIMIT 1;
