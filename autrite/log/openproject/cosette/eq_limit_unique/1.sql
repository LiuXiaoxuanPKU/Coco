...
-- Original Query
SELECT projects.id FROM projects WHERE projects.identifier = 'gyvcjgjiszlpvwwevjilqqzzgjjsitmmcjhfggjuexjybptgyfopijkadvllczasmxroeworttpyrpatmtnafofzzwlpggzymzgf';
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.identifier = 'gyvcjgjiszlpvwwevjilqqzzgjjsitmmcjhfggjuexjybptgyfopijkadvllczasmxroeworttpyrpatmtnafofzzwlpggzymzgf' LIMIT 1;
