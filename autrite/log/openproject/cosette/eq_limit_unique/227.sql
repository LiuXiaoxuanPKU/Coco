...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'original-title%' AND wiki_id = 250;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'original-title%' AND wiki_id = 250 LIMIT 1;
