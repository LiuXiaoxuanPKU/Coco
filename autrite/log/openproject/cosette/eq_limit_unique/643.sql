...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'node-page-from-invisible-project%' AND wiki_id = 70;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'node-page-from-invisible-project%' AND wiki_id = 70 LIMIT 1;
