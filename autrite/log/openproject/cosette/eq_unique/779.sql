...
-- Original Query
SELECT users.* FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type IN ('User', 'Group', 'User', 'Group') AND group_users.group_id = 29090;
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type IN ('User', 'Group', 'User', 'Group') AND group_users.group_id = 29090 LIMIT 1;
