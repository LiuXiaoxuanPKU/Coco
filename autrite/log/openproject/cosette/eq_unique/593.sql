...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-old-title%' AND id <> 53 AND wiki_id = 262;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-old-title%' AND id <> 53 AND wiki_id = 262 LIMIT 1;
