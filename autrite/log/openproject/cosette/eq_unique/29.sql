...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'oldtitle%' AND wiki_id = 337;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'oldtitle%' AND wiki_id = 337 LIMIT 1;
