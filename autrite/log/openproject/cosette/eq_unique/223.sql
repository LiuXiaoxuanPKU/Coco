...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'original-title%' AND wiki_id = 254;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'original-title%' AND wiki_id = 254 LIMIT 1;
