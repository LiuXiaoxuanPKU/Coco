...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 51 AND wiki_id = 258;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 51 AND wiki_id = 258 LIMIT 1;
