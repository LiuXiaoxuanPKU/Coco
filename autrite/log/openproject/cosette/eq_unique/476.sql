...
-- Original Query
SELECT 1 AS "one" FROM projects WHERE projects.identifier IS NULL AND projects.id <> 5087 LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects WHERE False AND projects.id <> 5087 LIMIT 8;
