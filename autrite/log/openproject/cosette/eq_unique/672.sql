...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'nogdlxgmorvdynohuymmiwjdsyvapupygoguwwxetrvaecxsrudnbscpuwoscvkeuzyryawjnmwmwdyitozicwiwrqostamgihahuzajyikbdztiyeookwvptbgixusftniywwcxvhmvcyzvgncaemflauhwqinyztpgehqbzndzenxskqdggmgxyhwulrzvygpszbqicgilqcc' AND versions.project_id IS NULL LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'nogdlxgmorvdynohuymmiwjdsyvapupygoguwwxetrvaecxsrudnbscpuwoscvkeuzyryawjnmwmwdyitozicwiwrqostamgihahuzajyikbdztiyeookwvptbgixusftniywwcxvhmvcyzvgncaemflauhwqinyztpgehqbzndzenxskqdggmgxyhwulrzvygpszbqicgilqcc' AND False LIMIT 6;
