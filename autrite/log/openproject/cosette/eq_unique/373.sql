...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-78%' AND wiki_id = 151;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-78%' AND wiki_id = 151 LIMIT 1;
