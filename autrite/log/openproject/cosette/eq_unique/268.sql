...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'i-am-a-ghostpage%' AND wiki_id = 91;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'i-am-a-ghostpage%' AND wiki_id = 91 LIMIT 1;
