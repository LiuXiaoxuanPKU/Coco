...
-- Original Query
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 35 AND relations.to_id IS NULL AND relations.id IS NOT NULL LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 35 AND False AND relations.id IS NOT NULL LIMIT 2;
