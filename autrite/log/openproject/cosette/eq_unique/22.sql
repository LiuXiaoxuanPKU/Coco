...
-- Original Query
SELECT 1 AS "one" FROM attribute_help_texts WHERE attribute_help_texts.attribute_name IS NULL AND attribute_help_texts.type = 'AttributeHelpText::WorkPackage' LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM attribute_help_texts WHERE False AND attribute_help_texts.type = 'AttributeHelpText::WorkPackage' LIMIT 9;
