...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'parent-page%' AND wiki_id = 333;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'parent-page%' AND wiki_id = 333 LIMIT 1;
