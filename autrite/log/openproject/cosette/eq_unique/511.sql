...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 46 AND wiki_id = 248;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-title%' AND id <> 46 AND wiki_id = 248 LIMIT 1;
