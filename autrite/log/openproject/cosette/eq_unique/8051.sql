...
-- Original Query
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
-- Rewritten Queries
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
...
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity' LIMIT 1) AND projects.id IN (SELECT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity' LIMIT 1) AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC;
...
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL LIMIT 1) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects INNER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
SELECT journals.id AS event_id, journals.created_at AS event_datetime, journals.user_id AS event_author, journals.notes AS event_description, journals.version AS version, journals.journable_id AS journable_id, meeting_contents.type AS meeting_content_type, meetings.id AS meeting_id, meetings.title AS meeting_title, meetings.project_id AS project_id FROM journals INNER JOIN meeting_content_journals ON journals.data_id = meeting_content_journals.id AND journals.data_type = 'Journal::MeetingContentJournal' INNER JOIN meetings ON meeting_content_journals.meeting_id = meetings.id INNER JOIN meeting_contents ON journals.journable_id = meeting_contents.id AND journals.journable_type = 'MeetingContent' INNER JOIN projects ON projects.id = meetings.project_id WHERE journals.journable_type = 'MeetingContent' AND journals.created_at >= '2022-01-18' AND journals.created_at <= '2022-02-18' AND journals.user_id = 456 AND projects.id IN (SELECT enabled_modules.project_id FROM enabled_modules WHERE name = 'activity') AND projects.id IN (SELECT DISTINCT projects.id FROM projects LEFT OUTER JOIN members ON projects.id = members.project_id AND members.user_id = 455 AND projects.active = True INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('meetings') AND projects.active = True INNER JOIN role_permissions ON role_permissions.permission IN ('view_meetings') INNER JOIN roles AS permission_roles ON permission_roles.id = role_permissions.role_id INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles AS assigned_roles ON assigned_roles.id = permission_roles.id AND projects.active = True AND (assigned_roles.id = member_roles.role_id OR projects.public = True AND assigned_roles.builtin = 1 AND member_roles.id IS NULL) WHERE assigned_roles.id IS NOT NULL) ORDER BY journals.id DESC LIMIT 1;
