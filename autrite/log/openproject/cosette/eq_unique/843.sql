...
-- Original Query
SELECT COUNT(DISTINCT news.id) FROM news LEFT OUTER JOIN users ON users.id = news.author_id AND users.type IN ('Group', 'Group', 'User', 'Group') LEFT OUTER JOIN projects ON projects.id = news.project_id INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('news') AND projects.active = True WHERE projects.active = True;
-- Rewritten Queries
SELECT COUNT(DISTINCT news.id) FROM news LEFT OUTER JOIN users ON users.id = news.author_id AND users.type IN ('Group', 'Group', 'User', 'Group') LEFT OUTER JOIN projects ON projects.id = news.project_id INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('news') AND projects.active = True WHERE projects.active = True LIMIT 1;
SELECT COUNT(DISTINCT news.id) FROM news LEFT OUTER JOIN users ON users.id = news.author_id AND users.type IN ('Group', 'Group', 'User', 'Group') INNER JOIN projects ON projects.id = news.project_id INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('news') AND projects.active = True WHERE projects.active = True;
SELECT COUNT(DISTINCT news.id) FROM news LEFT OUTER JOIN users ON users.id = news.author_id AND users.type IN ('Group', 'Group', 'User', 'Group') INNER JOIN projects ON projects.id = news.project_id INNER JOIN enabled_modules ON projects.id = enabled_modules.project_id AND enabled_modules.name IN ('news') AND projects.active = True WHERE projects.active = True LIMIT 1;
