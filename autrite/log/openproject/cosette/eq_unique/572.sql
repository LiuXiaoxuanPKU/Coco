...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-2%' AND id <> 3 AND wiki_id = 12;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-2%' AND id <> 3 AND wiki_id = 12 LIMIT 1;
