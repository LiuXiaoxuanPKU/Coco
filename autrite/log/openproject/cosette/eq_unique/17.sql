...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.id <> 2181 AND versions.project_id IS NULL LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE False AND versions.id <> 2181 AND versions.project_id IS NULL LIMIT 2;
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.id <> 2181 AND False LIMIT 2;
SELECT 1 AS "one" FROM versions WHERE False AND versions.id <> 2181 AND False LIMIT 2;
