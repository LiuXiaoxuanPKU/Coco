...
-- Original Query
SELECT DISTINCT attribute_help_texts.attribute_name FROM attribute_help_texts WHERE attribute_help_texts.type = 'AttributeHelpText::WorkPackage' AND attribute_help_texts.type = 'AttributeHelpText::WorkPackage';
-- Rewritten Queries
SELECT attribute_help_texts.attribute_name FROM attribute_help_texts WHERE attribute_help_texts.type = 'AttributeHelpText::WorkPackage' AND attribute_help_texts.type = 'AttributeHelpText::WorkPackage';
