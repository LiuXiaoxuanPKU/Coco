...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.id <> 598 AND versions.project_id = 0 LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE False AND versions.id <> 598 AND versions.project_id = 0 LIMIT 7;
