...
-- Original Query
SELECT 1 AS "one" FROM relations WHERE relations.from_id IS NULL AND relations.to_id = 3267 AND relations.id IS NOT NULL LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM relations WHERE False AND relations.to_id = 3267 AND relations.id IS NOT NULL LIMIT 9;
