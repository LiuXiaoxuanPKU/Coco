...
-- Original Query
SELECT 1 AS "one" FROM projects WHERE projects.identifier IS NULL AND projects.id <> 7010 LIMIT 3;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects WHERE False AND projects.id <> 7010 LIMIT 3;
