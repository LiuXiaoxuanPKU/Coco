...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (project_id IS NULL OR project_id = 266) LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (False OR project_id = 266) LIMIT 7;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (False OR project_id = 266) LIMIT 7;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (False OR project_id = 266) LIMIT 7;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (False OR project_id = 266) LIMIT 7;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 747 AND is_public = False AND (False OR project_id = 266) LIMIT 7;
