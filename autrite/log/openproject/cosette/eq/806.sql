...
-- Original Query
SELECT custom_values.value FROM custom_values LEFT OUTER JOIN custom_fields ON custom_fields.id = custom_values.custom_field_id WHERE custom_values.customized_id = 0 AND custom_values.customized_type = '' AND custom_values.custom_field_id = 166 ORDER BY custom_fields.position;
-- Rewritten Queries
SELECT custom_values.value FROM custom_values INNER JOIN custom_fields ON custom_fields.id = custom_values.custom_field_id WHERE custom_values.customized_id = 0 AND custom_values.customized_type = '' AND custom_values.custom_field_id = 166 ORDER BY custom_fields.position;
