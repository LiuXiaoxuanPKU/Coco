...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND id <> 116 AND wiki_id = 483;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND id <> 116 AND wiki_id = 483 LIMIT 1;
