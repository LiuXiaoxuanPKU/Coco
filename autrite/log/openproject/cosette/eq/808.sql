...
-- Original Query
SELECT 1 AS "one" FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 838 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON roles.id = role_permissions.role_id AND role_permissions.permission = 'view_work_packages' WHERE users.type IN ('Group', 'User', 'User', 'User') AND (roles.id IS NOT NULL AND role_permissions.id IS NOT NULL OR users.admin = True) AND users.id = 7915 LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM users INNER JOIN members ON users.id = members.user_id AND members.project_id = 838 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON roles.id = role_permissions.role_id AND role_permissions.permission = 'view_work_packages' WHERE users.type IN ('User', 'Group', 'User', 'User') AND (roles.id IS NOT NULL AND role_permissions.id IS NOT NULL OR users.admin = True) AND users.id = 7915 LIMIT 6;
SELECT 1 AS "one" FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 838 INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON roles.id = role_permissions.role_id AND role_permissions.permission = 'view_work_packages' WHERE users.type IN ('User', 'Group', 'User', 'User') AND (roles.id IS NOT NULL AND role_permissions.id IS NOT NULL OR users.admin = True) AND users.id = 7915 LIMIT 6;
SELECT 1 AS "one" FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 838 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON roles.id = role_permissions.role_id AND role_permissions.permission = 'view_work_packages' WHERE users.type IN ('User', 'Group', 'User', 'User') AND (roles.id IS NOT NULL AND role_permissions.id IS NOT NULL OR users.admin = True) AND users.id = 7915 LIMIT 6;
SELECT 1 AS "one" FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 838 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id INNER JOIN role_permissions ON roles.id = role_permissions.role_id AND role_permissions.permission = 'view_work_packages' WHERE users.type IN ('User', 'Group', 'User', 'User') AND (roles.id IS NOT NULL AND role_permissions.id IS NOT NULL OR users.admin = True) AND users.id = 7915 LIMIT 6;
