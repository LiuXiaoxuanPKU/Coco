...
-- Original Query
SELECT 1 AS "one" FROM members WHERE members.user_id IS NULL AND members.project_id = 9271 LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM members WHERE False AND members.project_id = 9271 LIMIT 5;
