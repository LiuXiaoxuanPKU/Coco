...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (project_id IS NULL OR project_id = 215) LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (False OR project_id = 215) LIMIT 5;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (False OR project_id = 215) LIMIT 5;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (False OR project_id = 215) LIMIT 5;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (False OR project_id = 215) LIMIT 5;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 608 AND is_public = False AND (False OR project_id = 215) LIMIT 5;
