...
-- Rewritten Queries
SELECT relations.* FROM relations WHERE relations.hierarchy = 0 AND hierarchy + relates + duplicates + follows + blocks + includes + requires = 1 AND relations.id IN ('854', '858') ORDER BY relations.id DESC LIMIT 3 OFFSET 1;
