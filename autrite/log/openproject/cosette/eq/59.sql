...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (project_id IS NULL OR project_id = 220) LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (False OR project_id = 220) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (False OR project_id = 220) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (False OR project_id = 220) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (False OR project_id = 220) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 617 AND is_public = False AND (False OR project_id = 220) LIMIT 8;
