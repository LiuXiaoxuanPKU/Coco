...
-- Original Query
SELECT 1 AS "one" FROM projects WHERE projects.identifier IS NULL AND projects.id <> 9067 LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects WHERE False AND projects.id <> 9067 LIMIT 8;
