...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'another-page%' AND id <> 141 AND wiki_id = 495;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'another-page%' AND id <> 141 AND wiki_id = 495 LIMIT 1;
