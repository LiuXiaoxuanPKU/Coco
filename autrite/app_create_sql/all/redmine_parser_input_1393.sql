...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6689 AND issue_relations.issue_to_id IN (8437, 7438, 5767);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6689 AND issue_relations.issue_to_id IN (8437, 7438, 5767) LIMIT 1;
