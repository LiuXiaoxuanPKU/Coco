...
-- Original Query
SELECT 1 AS "one" FROM wiki_pages WHERE LOWER(wiki_pages.title) = 'Dddvqvlhmcqgyupsgxeoepwtemtbtisacmcjvkhzdfxzpipcgvjmhaufwiobilrisyzetehfdvvaifivlkuaywcxhwwqqmqnvziivazsgdxfurvhyzyvuafmdpatfsozroabbrkcwxumtxxsnoiamkmhcwehjpqapqfsdxkckwbrbyjfuipxloutrykyxkrio' AND wiki_pages.wiki_id IS NULL LIMIT 4;
-- Rewritten Queries
SELECT 1 AS "one" FROM wiki_pages WHERE LOWER(wiki_pages.title) = 'Dddvqvlhmcqgyupsgxeoepwtemtbtisacmcjvkhzdfxzpipcgvjmhaufwiobilrisyzetehfdvvaifivlkuaywcxhwwqqmqnvziivazsgdxfurvhyzyvuafmdpatfsozroabbrkcwxumtxxsnoiamkmhcwehjpqapqfsdxkckwbrbyjfuipxloutrykyxkrio' AND False LIMIT 4;
SELECT 1 AS "one" FROM wiki_pages WHERE LOWER(wiki_pages.title) = 'Dddvqvlhmcqgyupsgxeoepwtemtbtisacmcjvkhzdfxzpipcgvjmhaufwiobilrisyzetehfdvvaifivlkuaywcxhwwqqmqnvziivazsgdxfurvhyzyvuafmdpatfsozroabbrkcwxumtxxsnoiamkmhcwehjpqapqfsdxkckwbrbyjfuipxloutrykyxkrio' AND False LIMIT 4;
