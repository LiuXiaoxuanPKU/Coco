...
-- Rewritten Queries
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC;
...
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC LIMIT 1;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC LIMIT 1;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC LIMIT 1;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC LIMIT 1;
SELECT queries.* FROM queries LEFT OUTER JOIN projects ON queries.project_id = projects.id WHERE queries.type IN ('ProjectQuery') AND (False OR projects.status <> 9) AND (queries.visibility <> 0 OR queries.user_id = 1) AND False ORDER BY queries.name ASC, queries.id ASC LIMIT 1;
