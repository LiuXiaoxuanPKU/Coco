...
-- Original Query
SELECT time_entries.* FROM time_entries WHERE time_entries.issue_id IS NULL ORDER BY time_entries.id ASC LIMIT 10;
-- Rewritten Queries
SELECT time_entries.* FROM time_entries WHERE False ORDER BY time_entries.id ASC LIMIT 10;
