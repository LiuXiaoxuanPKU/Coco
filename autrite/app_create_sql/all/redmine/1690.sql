...
-- Original Query
SELECT projects.* FROM projects WHERE projects.status <> 9 AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND (LOWER(identifier) LIKE LOWER('%coo%') OR LOWER(name) LIKE LOWER('%coo%'));
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.status <> 9 AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND (LOWER(identifier) LIKE LOWER('%coo%') OR LOWER(name) LIKE LOWER('%coo%')) LIMIT 1;
SELECT projects.* FROM projects WHERE projects.status <> 9 AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND (LOWER(identifier) LIKE LOWER('%coo%') OR LOWER(name) LIKE LOWER('%coo%'));
SELECT projects.* FROM projects WHERE projects.status <> 9 AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND (LOWER(identifier) LIKE LOWER('%coo%') OR LOWER(name) LIKE LOWER('%coo%')) LIMIT 1;
