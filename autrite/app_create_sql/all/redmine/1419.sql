...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8135, 8043, 9852, 2653, 2315, 7463) AND issue_relations.issue_to_id IN (4615, 8280, 4581, 8754, 5615, 3558) AND issue_relations.relation_type IN ('duplicates', 'relates');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8135, 8043, 9852, 2653, 2315, 7463) AND issue_relations.issue_to_id IN (4615, 8280, 4581, 8754, 5615, 3558) AND issue_relations.relation_type IN ('duplicates', 'relates') LIMIT 1;
