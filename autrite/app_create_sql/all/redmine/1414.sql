...
-- Original Query
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (8217, 3330, 5959, 5238, 8748, 5053);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (8217, 3330, 5959, 5238, 8748, 5053) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (8217, 3330, 5959, 5238, 8748, 5053);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (8748, 5053, 4748, 4333, 6178, 2646);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (8748, 5053, 4748, 4333, 6178, 2646);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (8217, 3330, 5959, 5238, 8748, 5053) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (8748, 5053, 4748, 4333, 6178, 2646) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (5959, 5238, 8748, 5053, 4748, 4333) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_from_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_to_id IN (8748, 5053, 4748, 4333, 6178, 2646) LIMIT 1;
