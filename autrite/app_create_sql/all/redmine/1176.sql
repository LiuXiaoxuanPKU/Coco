...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 77 AND attachments.container_type = 'zmldrvsghvompqzukcxevxggp' AND attachments.id = 1836 ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 77 AND attachments.container_type = 'zmldrvsghvompqzukcxevxggp' AND attachments.id = 1836 ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
