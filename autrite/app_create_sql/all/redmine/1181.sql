...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'kaondftoocyfciplztbkpzrvhu' AND attachments.container_id IN (89, 17, 96, 81, 7, 29) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'kaondftoocyfciplztbkpzrvhu' AND attachments.container_id IN (89, 17, 96, 81, 7, 29) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
