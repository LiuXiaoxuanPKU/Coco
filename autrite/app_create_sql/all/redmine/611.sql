...
-- Original Query
SELECT DISTINCT roles.* FROM roles WHERE roles.id = 3;
-- Rewritten Queries
SELECT roles.* FROM roles WHERE roles.id = 3;
SELECT DISTINCT roles.* FROM roles WHERE roles.id = 3 LIMIT 1;
SELECT roles.* FROM roles WHERE roles.id = 3 LIMIT 1;
