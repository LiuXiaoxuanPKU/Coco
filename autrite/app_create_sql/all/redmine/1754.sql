...
-- Original Query
SELECT roles.* FROM roles WHERE roles.id IN (3, 3) ORDER BY roles.builtin ASC, roles.position ASC;
-- Rewritten Queries
SELECT roles.* FROM roles WHERE roles.id IN (3, 3) ORDER BY roles.builtin ASC, roles.position ASC LIMIT 1;
