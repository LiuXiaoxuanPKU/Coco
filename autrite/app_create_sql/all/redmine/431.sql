...
-- Original Query
SELECT COUNT(*) FROM custom_values WHERE custom_values.custom_field_id = 5 AND custom_values.value = '';
-- Rewritten Queries
SELECT COUNT(*) FROM custom_values WHERE custom_values.custom_field_id = 5 AND custom_values.value = '' LIMIT 1;
