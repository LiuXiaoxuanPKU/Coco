...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 3001 AND issue_relations.issue_to_id = 7551;
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 3001 AND issue_relations.issue_to_id = 7551 LIMIT 1;
