...
-- Original Query
SELECT tokens.* FROM tokens WHERE tokens.user_id = 4311 AND tokens.action = 'cg' AND tokens.id IN (3376, 8603, 4365, 9393, 7419, 1621, 8221, 251, 2994, 742);
-- Rewritten Queries
SELECT tokens.* FROM tokens WHERE tokens.user_id = 4311 AND tokens.action = 'cg' AND tokens.id IN (3376, 8603, 4365, 9393, 7419, 1621, 8221, 251, 2994, 742) LIMIT 1;
