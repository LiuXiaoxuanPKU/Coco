...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 1087 ORDER BY changesets.committed_on DESC, changesets.id DESC;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 1087 ORDER BY changesets.committed_on DESC, changesets.id DESC LIMIT 1;
