...
-- Original Query
SELECT DISTINCT issue_statuses.* FROM issue_statuses INNER JOIN workflows ON workflows.new_status_id = issue_statuses.id AND workflows.type IN ('WorkflowTransition') WHERE workflows.old_status_id = 0 AND workflows.role_id IN (229, 443, 9732, 4975, 6513) AND workflows.tracker_id = 15022 AND (author = False OR assignee = True);
-- Rewritten Queries
SELECT issue_statuses.* FROM issue_statuses INNER JOIN workflows ON workflows.new_status_id = issue_statuses.id AND workflows.type IN ('WorkflowTransition') WHERE workflows.old_status_id = 0 AND workflows.role_id IN (347, 229, 443, 9732, 4975) AND workflows.tracker_id = 15022 AND (author = False OR assignee = True);
SELECT DISTINCT issue_statuses.* FROM issue_statuses INNER JOIN workflows ON workflows.new_status_id = issue_statuses.id AND workflows.type IN ('WorkflowTransition') WHERE workflows.old_status_id = 0 AND workflows.role_id IN (229, 443, 9732, 4975, 6513) AND workflows.tracker_id = 15022 AND (author = False OR assignee = True) LIMIT 1;
SELECT issue_statuses.* FROM issue_statuses INNER JOIN workflows ON workflows.new_status_id = issue_statuses.id AND workflows.type IN ('WorkflowTransition') WHERE workflows.old_status_id = 0 AND workflows.role_id IN (347, 229, 443, 9732, 4975) AND workflows.tracker_id = 15022 AND (author = False OR assignee = True) LIMIT 1;
