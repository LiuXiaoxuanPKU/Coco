...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'gdymzjcnusnwxwfnmujbmndzl' AND attachments.container_id IN (21, 14) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'gdymzjcnusnwxwfnmujbmndzl' AND attachments.container_id IN (21, 14) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
