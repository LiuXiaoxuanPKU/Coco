...
-- Original Query
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND members.project_id IS NULL ORDER BY members.id ASC LIMIT 7;
-- Rewritten Queries
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND False ORDER BY members.id ASC LIMIT 7;
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND False ORDER BY members.id ASC LIMIT 7;
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND False ORDER BY members.id ASC LIMIT 7;
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND False ORDER BY members.id ASC LIMIT 7;
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 10 AND projects.status <> 9 AND False ORDER BY members.id ASC LIMIT 7;
