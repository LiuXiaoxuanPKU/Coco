...
-- Original Query
SELECT tokens.* FROM tokens WHERE tokens.user_id = 7976 AND tokens.action = 'qvtrxsccwjtvtsfadtzhdinemyo';
-- Rewritten Queries
SELECT tokens.* FROM tokens WHERE tokens.user_id = 7976 AND tokens.action = 'qvtrxsccwjtvtsfadtzhdinemyo' LIMIT 1;
