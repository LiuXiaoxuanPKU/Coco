...
-- Original Query
SELECT COUNT(DISTINCT roles.id) FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 9;
-- Rewritten Queries
SELECT COUNT(DISTINCT roles.id) FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 9 LIMIT 1;
