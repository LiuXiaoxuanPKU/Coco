...
-- Original Query
SELECT 1 AS "one" FROM issue_relations WHERE issue_relations.issue_to_id IS NULL AND issue_relations.issue_from_id = 3069 LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM issue_relations WHERE False AND issue_relations.issue_from_id = 3069 LIMIT 2;
