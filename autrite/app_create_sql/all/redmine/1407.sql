...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('DocumentCategory') AND enumerations.id IN (14772, 16305) ORDER BY enumerations.position ASC;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('DocumentCategory') AND enumerations.id IN (14772, 16305) ORDER BY enumerations.position ASC LIMIT 1;
