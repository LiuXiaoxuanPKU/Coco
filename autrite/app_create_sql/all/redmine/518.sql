...
-- Original Query
SELECT COUNT(*) FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 21396;
-- Rewritten Queries
SELECT COUNT(*) FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 21396 LIMIT 1;
