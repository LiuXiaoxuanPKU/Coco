...
-- Original Query
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 13984;
-- Rewritten Queries
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 13984 LIMIT 1;
