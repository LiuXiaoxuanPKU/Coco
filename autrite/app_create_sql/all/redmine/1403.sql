...
-- Original Query
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id = 525;
-- Rewritten Queries
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id = 525 LIMIT 1;
