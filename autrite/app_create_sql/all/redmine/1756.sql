...
-- Original Query
SELECT roles.id FROM roles WHERE roles.builtin = 2 ORDER BY roles.position ASC;
-- Rewritten Queries
SELECT roles.id FROM roles WHERE roles.builtin = 2 ORDER BY roles.position ASC LIMIT 1;
