...
-- Original Query
SELECT versions.id FROM projects INNER JOIN versions ON versions.project_id = projects.id WHERE projects.lft >= 2 AND projects.rgt <= 5 ORDER BY projects.lft ASC;
-- Rewritten Queries
SELECT versions.id FROM projects INNER JOIN versions ON versions.project_id = projects.id WHERE projects.lft >= 2 AND projects.rgt <= 5 ORDER BY projects.lft ASC LIMIT 1;
