...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 19057 AND workflows.old_status_id IS NULL AND workflows.role_id = 2185;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 19057 AND False AND workflows.role_id = 2185;
