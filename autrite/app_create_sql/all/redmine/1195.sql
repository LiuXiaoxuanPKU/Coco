...
-- Rewritten Queries
SELECT committer, user_id, COUNT(*) AS "count" FROM changes INNER JOIN changesets ON changesets.id = changes.changeset_id WHERE changesets.repository_id = 10 GROUP BY committer, user_id LIMIT 1;
