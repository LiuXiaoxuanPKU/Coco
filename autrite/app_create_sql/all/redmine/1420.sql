...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (6903, 2950, 366, 1176, 4480, 4165, 608, 9918) AND issue_relations.issue_to_id IN (8529, 4535, 7151, 8528, 8545, 9128, 4962, 793) AND issue_relations.relation_type IN ('duplicates', 'copied_to');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (6903, 2950, 366, 1176, 4480, 4165, 608, 9918) AND issue_relations.issue_to_id IN (8529, 4535, 7151, 8528, 8545, 9128, 4962, 793) AND issue_relations.relation_type IN ('duplicates', 'copied_to') LIMIT 1;
