...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_to_id = 1955;
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_to_id = 1955 LIMIT 1;
