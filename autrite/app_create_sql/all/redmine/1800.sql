...
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT DISTINCT user_id FROM watchers) LIMIT 1;
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT DISTINCT user_id FROM watchers LIMIT 1);
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT DISTINCT user_id FROM watchers LIMIT 1) LIMIT 1;
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT user_id FROM watchers) LIMIT 1;
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT user_id FROM watchers LIMIT 1);
SELECT users.* FROM users WHERE users.type IN ('User', 'AnonymousUser') AND id IN (SELECT user_id FROM watchers LIMIT 1) LIMIT 1;
