...
-- Original Query
SELECT DISTINCT roles.* FROM roles WHERE roles.id IN (4, 5);
-- Rewritten Queries
SELECT roles.* FROM roles WHERE roles.id IN (5, 4);
SELECT DISTINCT roles.* FROM roles WHERE roles.id IN (4, 5) LIMIT 1;
SELECT roles.* FROM roles WHERE roles.id IN (5, 4) LIMIT 1;
