...
-- Original Query
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 8401;
-- Rewritten Queries
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 8401 LIMIT 1;
