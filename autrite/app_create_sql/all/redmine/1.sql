...
-- Original Query
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND enabled_modules.project_id IS NULL LIMIT 7;
-- Rewritten Queries
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND False LIMIT 7;
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND False LIMIT 7;
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND False LIMIT 7;
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND False LIMIT 7;
SELECT 1 AS "one" FROM enabled_modules WHERE enabled_modules.name = 'time_tracking' AND False LIMIT 7;
