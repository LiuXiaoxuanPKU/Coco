...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'bjvdoytzgdne@aol.com';
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'bjvdoytzgdne@aol.com' LIMIT 1;
