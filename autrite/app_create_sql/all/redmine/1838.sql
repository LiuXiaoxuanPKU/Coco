...
-- Original Query
SELECT versions.id FROM projects INNER JOIN versions ON versions.project_id = projects.id WHERE projects.lft >= 1 AND projects.rgt <= 10 ORDER BY projects.lft ASC;
-- Rewritten Queries
SELECT versions.id FROM projects INNER JOIN versions ON versions.project_id = projects.id WHERE projects.lft >= 1 AND projects.rgt <= 10 ORDER BY projects.lft ASC LIMIT 1;
