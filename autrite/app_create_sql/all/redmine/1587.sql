...
-- Original Query
SELECT issues.root_id, issues.lft, issues.rgt FROM issues WHERE issues.id = 22;
-- Rewritten Queries
SELECT issues.root_id, issues.lft, issues.rgt FROM issues WHERE issues.id = 22 LIMIT 1;
