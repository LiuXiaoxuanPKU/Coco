...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 7549 AND issue_relations.issue_to_id = 9816 AND issue_relations.relation_type IN ('relates', 'precedes');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 7549 AND issue_relations.issue_to_id = 9816 AND issue_relations.relation_type IN ('relates', 'precedes') LIMIT 1;
