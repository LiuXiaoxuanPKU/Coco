...
-- Original Query
SELECT issues.id FROM issues WHERE issues.root_id = 17 AND issues.lft > 1 AND issues.rgt < 10 ORDER BY issues.lft ASC;
-- Rewritten Queries
SELECT issues.id FROM issues WHERE issues.root_id = 17 AND issues.lft > 1 AND issues.rgt < 10 ORDER BY issues.lft ASC LIMIT 1;
