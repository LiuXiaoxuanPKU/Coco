...
-- Original Query
SELECT tokens.id FROM tokens WHERE tokens.user_id = 9373 AND tokens.action = 'z' ORDER BY tokens.updated_on DESC OFFSET 1;
-- Rewritten Queries
SELECT tokens.id FROM tokens WHERE tokens.user_id = 9373 AND tokens.action = 'z' ORDER BY tokens.updated_on DESC LIMIT 1 OFFSET 1;
