...
-- Original Query
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND queries.project_id IS NULL AND queries.id = 8050 LIMIT 1;
-- Rewritten Queries
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND False AND queries.id = 8050 LIMIT 1;
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND False AND queries.id = 8050 LIMIT 1;
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND False AND queries.id = 8050 LIMIT 1;
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND False AND queries.id = 8050 LIMIT 1;
SELECT queries.* FROM queries WHERE queries.type IN ('IssueQuery') AND False AND queries.id = 8050 LIMIT 1;
