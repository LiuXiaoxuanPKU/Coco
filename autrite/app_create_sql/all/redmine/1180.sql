...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'pmxqcvxffetynr' AND attachments.container_id IN (40, 10, 26) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'pmxqcvxffetynr' AND attachments.container_id IN (40, 10, 26) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
