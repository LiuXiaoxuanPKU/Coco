...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (enumerations.project_id IS NULL OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = False AND LOWER(enumerations.name) = LOWER('QA') ORDER BY enumerations.position ASC LIMIT 9;
