...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (enumerations.project_id IS NULL OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND LOWER(enumerations.name) = LOWER('Design') ORDER BY enumerations.position ASC LIMIT 3;
