...
-- Original Query
SELECT COUNT(*) FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 1120 AND watchers.watchable_type = 'News';
-- Rewritten Queries
SELECT COUNT(*) FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 1120 AND watchers.watchable_type = 'News' LIMIT 1;
