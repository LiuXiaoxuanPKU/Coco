...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 53 AND attachments.container_type = 'cklfnqisbetrlqvegekmddggu' AND attachments.id IN (5607, 5246) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 53 AND attachments.container_type = 'cklfnqisbetrlqvegekmddggu' AND attachments.id IN (5607, 5246) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
