...
-- Original Query
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 4264 AND trackers.id IN (5085, 6200) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 4264 AND trackers.id IN (5085, 6200) ORDER BY trackers.position ASC LIMIT 1;
