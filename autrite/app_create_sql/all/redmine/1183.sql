...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'goqqejxqwcb' AND attachments.container_id IN (48, 96, 42, 34, 52, 90, 14, 91) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'goqqejxqwcb' AND attachments.container_id IN (48, 96, 42, 34, 52, 90, 14, 91) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
