...
-- Original Query
SELECT member_roles.id FROM member_roles WHERE member_roles.member_id = 3;
-- Rewritten Queries
SELECT member_roles.id FROM member_roles WHERE member_roles.member_id = 3 LIMIT 1;
