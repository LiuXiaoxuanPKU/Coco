...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 5898 AND issue_relations.issue_to_id IN (8830, 9007, 9873);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 5898 AND issue_relations.issue_to_id IN (8830, 9007, 9873) LIMIT 1;
