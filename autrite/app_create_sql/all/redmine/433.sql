...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 4510 AND issue_relations.issue_to_id IN (2551, 8940, 9161);
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 4510 AND issue_relations.issue_to_id IN (2551, 8940, 9161) LIMIT 1;
