...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'urbilcpbbhujweuehwyqzeyxk' AND attachments.container_id IN (10, 73, 86, 35, 65, 49, 20) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'urbilcpbbhujweuehwyqzeyxk' AND attachments.container_id IN (10, 73, 86, 35, 65, 49, 20) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
