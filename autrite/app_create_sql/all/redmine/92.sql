...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (enumerations.project_id IS NULL OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND (False OR enumerations.project_id = 1) AND enumerations.active = True AND (id = 9 OR parent_id = 9) ORDER BY enumerations.position ASC LIMIT 7;
