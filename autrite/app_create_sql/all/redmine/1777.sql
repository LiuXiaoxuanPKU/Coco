...
-- Original Query
SELECT trackers.* FROM trackers WHERE trackers.name = 'bxcrczvuniahppyfzoiusa';
-- Rewritten Queries
SELECT trackers.* FROM trackers WHERE trackers.name = 'bxcrczvuniahppyfzoiusa' LIMIT 1;
