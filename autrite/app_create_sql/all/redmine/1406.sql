...
-- Original Query
SELECT enabled_modules.* FROM enabled_modules WHERE enabled_modules.id = 16415;
-- Rewritten Queries
SELECT enabled_modules.* FROM enabled_modules WHERE enabled_modules.id = 16415 LIMIT 1;
