...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (4898, 6630, 9031, 4037, 5634, 8030, 4217, 5441) AND issue_relations.issue_to_id IN (197, 8927, 4545, 2162, 3069, 6342, 9113, 458) AND issue_relations.relation_type IN ('precedes', 'precedes');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (4898, 6630, 9031, 4037, 5634, 8030, 4217, 5441) AND issue_relations.issue_to_id IN (197, 8927, 4545, 2162, 3069, 6342, 9113, 458) AND issue_relations.relation_type IN ('precedes', 'precedes') LIMIT 1;
