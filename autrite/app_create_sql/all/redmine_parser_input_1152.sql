...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 43 AND attachments.container_type = 'zimwy' AND attachments.id IN (7233, 9216) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 43 AND attachments.container_type = 'zimwy' AND attachments.id IN (7233, 9216) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
