...
-- Original Query
SELECT versions.* FROM versions WHERE versions.id = 167 OR versions.id IS NULL;
-- Rewritten Queries
SELECT versions.* FROM versions WHERE versions.id = 167 OR versions.id IS NULL LIMIT 1;
