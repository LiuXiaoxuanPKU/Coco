...
-- Original Query
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 7954;
-- Rewritten Queries
SELECT COUNT(*) FROM changes INNER JOIN changesets ON changes.changeset_id = changesets.id WHERE changesets.repository_id = 7954 LIMIT 1;
