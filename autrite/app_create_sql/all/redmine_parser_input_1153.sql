...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_id = 90 AND attachments.container_type = 'ojacyymrfbmyly' ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_id = 90 AND attachments.container_type = 'ojacyymrfbmyly' ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
