...
-- Original Query
SELECT tokens.* FROM tokens WHERE tokens.user_id = 5057 AND tokens.action = 'etfhgebhzhasaqs';
-- Rewritten Queries
SELECT tokens.* FROM tokens WHERE tokens.user_id = 5057 AND tokens.action = 'etfhgebhzhasaqs' LIMIT 1;
