...
-- Original Query
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 10758 OR issue_categories.id IS NULL;
-- Rewritten Queries
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 10758 OR issue_categories.id IS NULL LIMIT 1;
