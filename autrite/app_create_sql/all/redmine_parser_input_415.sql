...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_to_id = 7999;
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_to_id = 7999 LIMIT 1;
