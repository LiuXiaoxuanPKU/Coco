...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 830 AND issue_relations.issue_to_id = 9819;
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 830 AND issue_relations.issue_to_id = 9819 LIMIT 1;
