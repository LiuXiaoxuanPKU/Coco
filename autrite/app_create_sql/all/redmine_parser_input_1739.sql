...
-- Original Query
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 179;
-- Rewritten Queries
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 179 LIMIT 1;
