...
-- Original Query
SELECT journals.* FROM journals WHERE journals.journalized_id = 5756 AND journals.journalized_type = 'Issue' AND journals.id > 1 ORDER BY journals.id ASC;
-- Rewritten Queries
SELECT journals.* FROM journals WHERE journals.journalized_id = 5756 AND journals.journalized_type = 'Issue' AND journals.id > 1 ORDER BY journals.id ASC LIMIT 1;
