...
-- Original Query
SELECT tokens.id FROM tokens WHERE tokens.user_id = 8763 AND tokens.action = 'i' ORDER BY tokens.updated_on DESC OFFSET 1;
-- Rewritten Queries
SELECT tokens.id FROM tokens WHERE tokens.user_id = 8763 AND tokens.action = 'i' ORDER BY tokens.updated_on DESC LIMIT 1 OFFSET 1;
