...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.id = 15983 ORDER BY enumerations.position ASC;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('TimeEntryActivity') AND enumerations.id = 15983 ORDER BY enumerations.position ASC LIMIT 1;
