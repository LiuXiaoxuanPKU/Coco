...
-- Original Query
SELECT DISTINCT changesets.committer, changesets.user_id FROM changesets WHERE changesets.repository_id = 6284;
-- Rewritten Queries
SELECT changesets.committer, changesets.user_id FROM changesets WHERE changesets.repository_id = 6284;
SELECT DISTINCT changesets.committer, changesets.user_id FROM changesets WHERE changesets.repository_id = 6284 LIMIT 1;
SELECT changesets.committer, changesets.user_id FROM changesets WHERE changesets.repository_id = 6284 LIMIT 1;
