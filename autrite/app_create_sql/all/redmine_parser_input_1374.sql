...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'xqaybhdmknpvgrmpjroccsx@msn.com';
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'xqaybhdmknpvgrmpjroccsx@msn.com' LIMIT 1;
