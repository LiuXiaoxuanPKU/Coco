...
-- Original Query
SELECT tokens.* FROM tokens WHERE tokens.user_id = 10568 AND tokens.action = 'sujqbivop' AND tokens.id IN (809, 2409, 6028, 7612, 6462, 8859, 6406, 8463, 4364, 1782);
-- Rewritten Queries
SELECT tokens.* FROM tokens WHERE tokens.user_id = 10568 AND tokens.action = 'sujqbivop' AND tokens.id IN (809, 2409, 6028, 7612, 6462, 8859, 6406, 8463, 4364, 1782) LIMIT 1;
