...
-- Original Query
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 17970;
-- Rewritten Queries
SELECT issue_categories.* FROM issue_categories WHERE issue_categories.id = 17970 LIMIT 1;
