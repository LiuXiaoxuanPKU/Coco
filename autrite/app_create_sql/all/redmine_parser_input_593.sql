...
-- Original Query
SELECT DISTINCT roles.* FROM roles WHERE roles.id IN (3, 3);
-- Rewritten Queries
SELECT DISTINCT roles.* FROM roles WHERE roles.id IN (3, 3) LIMIT 1;
SELECT roles.* FROM roles WHERE roles.id IN (5, 3) LIMIT 1;
