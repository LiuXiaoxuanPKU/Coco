...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8089, 2313, 1019, 2351, 9506, 6596) AND issue_relations.issue_to_id IN (7153, 691, 4967, 3117, 6816, 3176) AND issue_relations.relation_type IN ('relates', 'duplicates');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8089, 2313, 1019, 2351, 9506, 6596) AND issue_relations.issue_to_id IN (7153, 691, 4967, 3117, 6816, 3176) AND issue_relations.relation_type IN ('relates', 'duplicates') LIMIT 1;
