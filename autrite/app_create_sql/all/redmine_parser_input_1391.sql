...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8175 AND issue_relations.issue_to_id = 5450 AND issue_relations.delay = 0 AND issue_relations.relation_type = 'copied_to';
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8175 AND issue_relations.issue_to_id = 5450 AND issue_relations.delay = 0 AND issue_relations.relation_type = 'copied_to' LIMIT 1;
