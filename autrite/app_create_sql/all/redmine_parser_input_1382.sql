...
-- Original Query
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('IssuePriority') AND enumerations.id IN (12604, 17582) ORDER BY enumerations.position ASC;
-- Rewritten Queries
SELECT enumerations.* FROM enumerations WHERE enumerations.type IN ('IssuePriority') AND enumerations.id IN (12604, 17582) ORDER BY enumerations.position ASC LIMIT 1;
