...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'fsbures' AND attachments.container_id IN (69, 45, 14, 28, 16, 97) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'fsbures' AND attachments.container_id IN (69, 45, 14, 28, 16, 97) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
