...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'ndopcwprojwp' AND attachments.container_id IN (16, 44, 12, 59, 10, 28, 88) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'ndopcwprojwp' AND attachments.container_id IN (16, 44, 12, 59, 10, 28, 88) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
