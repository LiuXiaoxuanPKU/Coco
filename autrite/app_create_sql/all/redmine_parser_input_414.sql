...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 840 AND issue_relations.issue_to_id IN (4415, 7293, 9829);
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 840 AND issue_relations.issue_to_id IN (4415, 7293, 9829) LIMIT 1;
