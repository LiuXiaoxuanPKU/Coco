...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'opkrxuuae' AND attachments.container_id IN (92, 79, 12) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'opkrxuuae' AND attachments.container_id IN (92, 79, 12) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
