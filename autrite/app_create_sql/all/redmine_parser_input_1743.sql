...
-- Original Query
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 5610 AND watchers.watchable_type = 'Message' AND users.status = 1;
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 5610 AND watchers.watchable_type = 'Message' AND users.status = 1 LIMIT 1;
