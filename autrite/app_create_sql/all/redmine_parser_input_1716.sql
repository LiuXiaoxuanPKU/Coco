...
-- Original Query
SELECT roles.id FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 3270;
-- Rewritten Queries
SELECT roles.id FROM roles INNER JOIN custom_fields_roles ON roles.id = custom_fields_roles.role_id WHERE custom_fields_roles.custom_field_id = 3270 LIMIT 1;
