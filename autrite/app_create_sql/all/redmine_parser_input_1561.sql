...
-- Original Query
SELECT issues.root_id, issues.lft, issues.rgt FROM issues WHERE issues.id = 15;
-- Rewritten Queries
SELECT issues.root_id, issues.lft, issues.rgt FROM issues WHERE issues.id = 15 LIMIT 1;
