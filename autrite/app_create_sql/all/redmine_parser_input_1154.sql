...
-- Original Query
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'ybebbvumldqzyxfd' AND attachments.container_id IN (7, 75) ORDER BY attachments.created_on ASC, attachments.id ASC;
-- Rewritten Queries
SELECT attachments.* FROM attachments WHERE attachments.container_type = 'ybebbvumldqzyxfd' AND attachments.container_id IN (7, 75) ORDER BY attachments.created_on ASC, attachments.id ASC LIMIT 1;
