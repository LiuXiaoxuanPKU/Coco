...
-- Original Query
SELECT enabled_modules.* FROM enabled_modules WHERE enabled_modules.id = 46452;
-- Rewritten Queries
SELECT enabled_modules.* FROM enabled_modules WHERE enabled_modules.id = 46452 LIMIT 1;
