...
-- Original Query
SELECT projects.* FROM projects WHERE projects.id IN (1699, 4192) AND projects.status <> 9;
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.id IN (1699, 4192) AND projects.status <> 9 LIMIT 1;
