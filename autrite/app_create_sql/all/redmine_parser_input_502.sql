...
-- Original Query
SELECT COUNT(*) FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 1146 AND watchers.watchable_type = 'Message';
-- Rewritten Queries
SELECT COUNT(*) FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 1146 AND watchers.watchable_type = 'Message' LIMIT 1;
