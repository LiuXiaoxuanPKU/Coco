...
-- Original Query
SELECT work_packages.id, work_packages.subject, work_packages.project_id, from_id FROM work_packages INNER JOIN relations ON relations.hierarchy = 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id WHERE relations.from_id = 3529;
-- Rewritten Queries
SELECT work_packages.id, work_packages.subject, work_packages.project_id, from_id FROM work_packages INNER JOIN relations ON relations.hierarchy = 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id WHERE relations.from_id = 3529 LIMIT 1;
