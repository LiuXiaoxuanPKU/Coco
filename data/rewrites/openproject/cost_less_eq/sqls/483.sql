...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.project_id = 0 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE False AND versions.project_id = 0 LIMIT 1;
