...
-- Original Query
SELECT members.* FROM members WHERE members.user_id = 28702 AND members.project_id IS NULL LIMIT 8;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.user_id = 28702 AND False LIMIT 8;
