...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'xkpjojffwsikevgpcrcdmtrbevltavlqmzuithqwbxfcypvhpfuhaj' AND versions.id <> 495 AND versions.project_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'xkpjojffwsikevgpcrcdmtrbevltavlqmzuithqwbxfcypvhpfuhaj' AND versions.id <> 495 AND False LIMIT 1;
