...
-- Original Query
SELECT DISTINCT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('Group', 'Group', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
-- Rewritten Queries
SELECT users.id FROM users INNER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (True OR users.admin = True);
SELECT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (True OR users.admin = True);
SELECT DISTINCT users.id FROM users INNER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (True OR users.admin = True);
SELECT DISTINCT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (True OR users.admin = True);
SELECT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (True OR users.admin = True);
SELECT users.id FROM users INNER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
SELECT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
SELECT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'User', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
SELECT DISTINCT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (True OR users.admin = True);
SELECT DISTINCT users.id FROM users INNER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
SELECT DISTINCT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 INNER JOIN member_roles ON members.id = member_roles.member_id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
SELECT DISTINCT users.id FROM users LEFT OUTER JOIN members ON users.id = members.user_id AND members.project_id = 1186 LEFT OUTER JOIN member_roles ON members.id = member_roles.member_id INNER JOIN roles ON roles.id = member_roles.role_id WHERE users.type IN ('User', 'Group', 'Group', 'Group') AND (roles.id IS NOT NULL OR users.admin = True);
