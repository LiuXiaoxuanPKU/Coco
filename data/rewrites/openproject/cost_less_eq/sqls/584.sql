...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-4%' AND id <> 6 AND wiki_id = 85;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-4%' AND id <> 6 AND wiki_id = 85 LIMIT 1;
