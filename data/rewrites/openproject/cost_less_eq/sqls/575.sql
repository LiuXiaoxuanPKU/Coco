...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'initial-name%' AND id <> 7 AND wiki_id = 455;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'initial-name%' AND id <> 7 AND wiki_id = 455 LIMIT 1;
