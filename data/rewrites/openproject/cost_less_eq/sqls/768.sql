...
-- Original Query
SELECT users.* FROM users WHERE LOWER(login) LIKE '%lastname%' OR LOWER(CONCAT(firstname, ' ', lastname)) LIKE '%lastname%' OR LOWER(CONCAT(lastname, ' ', firstname)) LIKE '%lastname%' OR LOWER(mail) LIKE '%lastname%' ORDER BY users.type ASC, users.login ASC, users.lastname ASC, users.firstname ASC, users.mail ASC;
-- Rewritten Queries
SELECT users.* FROM users WHERE LOWER(login) LIKE '%lastname%' OR LOWER(CONCAT(firstname, ' ', lastname)) LIKE '%lastname%' OR LOWER(CONCAT(lastname, ' ', firstname)) LIKE '%lastname%' OR LOWER(mail) LIKE '%lastname%' ORDER BY users.type ASC, users.login ASC, users.lastname ASC, users.firstname ASC, users.mail ASC LIMIT 1;
