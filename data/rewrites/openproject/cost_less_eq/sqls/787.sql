...
-- Original Query
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (3972, 4616);
-- Rewritten Queries
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (9845, 2123);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (4378, 9845);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (4378, 9845);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (9845, 2123) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (4378, 9845) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (4378, 9845) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (2166, 41);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (16, 2166);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (16, 2166);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (2166, 41);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (2166, 41) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (16, 2166) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (16, 2166) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR False) AND members.project_id IN (2166, 41) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (2123, 3972);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (2123, 3972);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (3972, 4616) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (2123, 3972) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (2123, 3972) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4789, 3632);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (41, 4789);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (41, 4789);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4789, 3632);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4789, 3632) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (41, 4789) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (41, 4789) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 24939 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4789, 3632) LIMIT 1;
