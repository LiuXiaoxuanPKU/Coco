...
-- Original Query
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 25136 AND (projects.active = True OR project_id IS NULL) AND projects.active = True LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 25136 AND (projects.active = True OR False) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 25136 AND (projects.active = True OR False) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 25136 AND (projects.active = True OR False) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 25136 AND (projects.active = True OR False) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 25136 AND (projects.active = True OR False) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 25136 AND (projects.active = True OR project_id IS NULL) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 25136 AND (projects.active = True OR project_id IS NULL) AND projects.active = True LIMIT 1;
SELECT 1 AS "one" FROM projects INNER JOIN members ON projects.id = members.project_id LEFT OUTER JOIN projects AS projects_members ON projects_members.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 25136 AND (projects.active = True OR project_id IS NULL) AND projects.active = True LIMIT 1;
