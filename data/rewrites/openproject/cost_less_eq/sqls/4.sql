...
-- Original Query
SELECT projects.id FROM projects WHERE projects.identifier = 'jsmqmgehxizklupwpdyvwsuilndvmdahpjkwbfpqwcudgnecesbouapovehsvmqlfmzixgooiktrrsmgsetmsovmopiuoaqjgwej';
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.identifier = 'jsmqmgehxizklupwpdyvwsuilndvmdahpjkwbfpqwcudgnecesbouapovehsvmqlfmzixgooiktrrsmgsetmsovmopiuoaqjgwej' LIMIT 1;
