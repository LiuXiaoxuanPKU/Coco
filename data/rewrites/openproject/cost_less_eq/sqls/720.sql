...
-- Original Query
SELECT DISTINCT projects.* FROM projects WHERE projects.lft >= 1 AND projects.lft < 4 AND projects.id <> 464 AND projects.active = True ORDER BY projects.name ASC;
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.lft >= 1 AND projects.lft < 4 AND projects.id <> 464 AND projects.active = True ORDER BY projects.name ASC;
