...
-- Original Query
SELECT journals.* FROM journals WHERE journals.journable_id = 6375 AND journals.journable_type = 'WikiContent' AND version > 1 ORDER BY journals.version ASC, journals.created_at ASC;
-- Rewritten Queries
SELECT journals.* FROM journals WHERE journals.journable_id = 6375 AND journals.journable_type = 'WikiContent' AND version > 1 ORDER BY journals.version ASC, journals.created_at ASC LIMIT 1;
