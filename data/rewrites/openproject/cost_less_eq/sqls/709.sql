...
-- Original Query
SELECT 1 AS "one" FROM journals WHERE journals.version = 1 AND journals.journable_id IS NULL AND journals.journable_type = 'Document' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM journals WHERE journals.version = 1 AND False AND journals.journable_type = 'Document' LIMIT 1;
