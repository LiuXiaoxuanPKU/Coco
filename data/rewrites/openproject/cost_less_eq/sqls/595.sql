...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-old-title%' AND id <> 52 AND wiki_id = 260;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'new-old-title%' AND id <> 52 AND wiki_id = 260 LIMIT 1;
