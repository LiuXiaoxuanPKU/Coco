...
-- Original Query
SELECT users.* FROM users INNER JOIN group_users ON users.id = group_users.group_id WHERE users.type = 'User' AND group_users.user_id = 3477;
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN group_users ON users.id = group_users.group_id WHERE users.type = 'User' AND group_users.user_id = 3477 LIMIT 1;
