...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-same-project%' AND wiki_id = 68;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-same-project%' AND wiki_id = 68 LIMIT 1;
