...
-- Original Query
SELECT journals.* FROM journals WHERE journals.journable_id = 4054 AND journals.journable_type = 'MeetingContent' ORDER BY journals.version ASC;
-- Rewritten Queries
SELECT journals.* FROM journals WHERE journals.journable_id = 4054 AND journals.journable_type = 'MeetingContent' ORDER BY journals.version ASC LIMIT 1;
