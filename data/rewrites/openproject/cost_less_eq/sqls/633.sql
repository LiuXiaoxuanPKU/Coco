...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-45%' AND id <> 35 AND wiki_id = 452;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-45%' AND id <> 35 AND wiki_id = 452 LIMIT 1;
