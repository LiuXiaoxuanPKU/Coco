...
-- Original Query
SELECT 1 AS "one" FROM members WHERE members.user_id = 25925 AND members.project_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM members WHERE members.user_id = 25925 AND False LIMIT 1;
