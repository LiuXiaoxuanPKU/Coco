...
-- Original Query
SELECT DISTINCT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON role_permissions.role_id = roles.id WHERE member_roles.member_id = 5095;
-- Rewritten Queries
SELECT DISTINCT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 5095;
SELECT DISTINCT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 5095;
SELECT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 5095;
SELECT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id WHERE member_roles.member_id = 5095;
SELECT roles.id FROM roles INNER JOIN member_roles ON roles.id = member_roles.role_id LEFT OUTER JOIN role_permissions ON role_permissions.role_id = roles.id WHERE member_roles.member_id = 5095;
