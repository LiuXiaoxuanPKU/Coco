...
-- Original Query
SELECT members.* FROM members WHERE members.id IN (444, 7666) AND members.id NOT IN (SELECT DISTINCT member_roles.member_id FROM member_roles);
-- Rewritten Queries
SELECT members.* FROM members WHERE members.id IN (444, 7666) AND members.id NOT IN (SELECT member_roles.member_id FROM member_roles);
