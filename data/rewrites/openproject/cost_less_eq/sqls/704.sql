...
-- Original Query
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2445 AND relations.to_id IS NULL AND relations.id IS NOT NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2445 AND False AND relations.id IS NOT NULL LIMIT 1;
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2445 AND False AND True LIMIT 1;
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2445 AND relations.to_id IS NULL AND True LIMIT 1;
