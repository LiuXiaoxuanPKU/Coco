...
-- Original Query
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 9587 AND relations.to_id = 8213 AND relations.id IS NOT NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 9587 AND relations.to_id = 8213 AND True LIMIT 1;
