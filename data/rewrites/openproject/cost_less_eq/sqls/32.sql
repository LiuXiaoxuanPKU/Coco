...
-- Original Query
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 7648;
-- Rewritten Queries
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 7648 LIMIT 1;
