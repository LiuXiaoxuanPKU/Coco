...
-- Original Query
SELECT 1 AS "one" FROM users INNER JOIN members ON users.id = members.user_id WHERE members.project_id = 1871 AND users.type = 'Group' AND users.id = 3728 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM users WHERE users.type = 'Group' AND users.id = 3728 LIMIT 1;
