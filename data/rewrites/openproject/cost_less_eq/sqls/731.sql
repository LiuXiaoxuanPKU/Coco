...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 9552 AND scmid IN ('64f1f3e89ad1cb57976ff0ad99a107012ba3481d') ORDER BY changesets.committed_on DESC, changesets.id DESC, committed_on DESC;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.repository_id = 9552 AND scmid IN ('64f1f3e89ad1cb57976ff0ad99a107012ba3481d') ORDER BY changesets.committed_on DESC, changesets.id DESC, committed_on DESC LIMIT 1;
