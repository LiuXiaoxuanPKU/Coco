...
-- Original Query
SELECT 1 AS "one" FROM watchers WHERE watchers.user_id IS NULL AND watchers.watchable_type = 'WikiPage' AND watchers.watchable_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM watchers WHERE watchers.user_id IS NULL AND watchers.watchable_type = 'WikiPage' AND False LIMIT 1;
SELECT 1 AS "one" FROM watchers WHERE False AND watchers.watchable_type = 'WikiPage' AND watchers.watchable_id IS NULL LIMIT 1;
SELECT 1 AS "one" FROM watchers WHERE False AND watchers.watchable_type = 'WikiPage' AND False LIMIT 1;
