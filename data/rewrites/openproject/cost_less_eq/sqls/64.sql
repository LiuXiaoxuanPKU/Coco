...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'other-page%' AND wiki_id = 102;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'other-page%' AND wiki_id = 102 LIMIT 1;
