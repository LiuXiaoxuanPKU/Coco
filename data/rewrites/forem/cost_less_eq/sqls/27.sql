...
-- Original Query
SELECT badge_achievements.* FROM badge_achievements WHERE badge_achievements.id IS NULL LIMIT 9;
-- Rewritten Queries
SELECT badge_achievements.* FROM badge_achievements WHERE False LIMIT 9;
