...
SELECT devices.* FROM devices WHERE devices.user_id = 5838 AND devices.token IS NULL AND devices.platform IS NULL AND False LIMIT 9;
SELECT devices.* FROM devices WHERE devices.user_id = 5838 AND False AND devices.platform IS NULL AND False LIMIT 9;
...
SELECT devices.* FROM devices WHERE devices.user_id = 5838 AND devices.token IS NULL AND False AND False LIMIT 9;
SELECT devices.* FROM devices WHERE devices.user_id = 5838 AND False AND False AND False LIMIT 9;
