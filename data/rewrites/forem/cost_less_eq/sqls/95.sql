...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.id <> 9090 AND notifications.organization_id = 3 AND notifications.notifiable_id = 5912 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'nkvmkpiduoeajmkuppqirhsqeabgxakhuivkbxulqrykfkpsjtelejsiuvkjtbahhedckkcbjqtkmnszyauebafmvbjuqnmbtqpkxgyydyqpmbiwuhpvpgrjlussxzazyvnkkpewkxsqyjhzuug' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.id <> 9090 AND notifications.organization_id = 3 AND notifications.notifiable_id = 5912 AND notifications.notifiable_type = 'Comment' AND notifications.action = 'nkvmkpiduoeajmkuppqirhsqeabgxakhuivkbxulqrykfkpsjtelejsiuvkjtbahhedckkcbjqtkmnszyauebafmvbjuqnmbtqpkxgyydyqpmbiwuhpvpgrjlussxzazyvnkkpewkxsqyjhzuug' LIMIT 1;
