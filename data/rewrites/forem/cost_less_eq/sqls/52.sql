...
-- Original Query
SELECT devices.* FROM devices WHERE devices.user_id = 9671 AND devices.token = 'ctrcfnpdmeqmucczyfxoynmtxzycvvengyicqpxvbqnhgyrcuprhadsgebycyngigcebzyjuesfgqyaraehfrxvshqrzetjvt' AND devices.platform = 'iOS' AND devices.consumer_app_id IS NULL LIMIT 4;
-- Rewritten Queries
SELECT devices.* FROM devices WHERE devices.user_id = 9671 AND devices.token = 'ctrcfnpdmeqmucczyfxoynmtxzycvvengyicqpxvbqnhgyrcuprhadsgebycyngigcebzyjuesfgqyaraehfrxvshqrzetjvt' AND devices.platform = 'iOS' AND False LIMIT 4;
