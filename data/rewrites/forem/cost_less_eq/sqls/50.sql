...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 232 AND identities.provider IN ('apple', 'apple') AND identities.provider IN ('github', 'twitter', 'apple', 'facebook', 'apple', 'github');
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 232 AND identities.provider IN ('apple', 'apple') AND identities.provider IN ('github', 'twitter', 'apple', 'facebook', 'apple', 'github') LIMIT 1;
