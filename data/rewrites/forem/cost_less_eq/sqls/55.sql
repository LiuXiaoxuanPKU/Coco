...
-- Original Query
SELECT users.id, users_settings.feed_url FROM users INNER JOIN users_settings ON users_settings.user_id = users.id WHERE users.id = 3118 AND users.id = 3118;
-- Rewritten Queries
SELECT users.id, users_settings.feed_url FROM users INNER JOIN users_settings ON users_settings.user_id = users.id WHERE users.id = 3118 AND users.id = 3118 LIMIT 1;
