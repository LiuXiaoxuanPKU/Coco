...
-- Original Query
SELECT follows.* FROM follows WHERE follows.id IS NULL AND follows.followable_type = 'User' LIMIT 3;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE False AND follows.followable_type = 'User' LIMIT 3;
