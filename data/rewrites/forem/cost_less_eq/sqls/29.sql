...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 6976 AND identities.provider IN ('github', 'apple');
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 6976 AND identities.provider IN ('github', 'apple') LIMIT 1;
