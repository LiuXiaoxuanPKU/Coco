...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7062 AND identities.provider = 'twitter';
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 7062 AND identities.provider = 'twitter' LIMIT 1;
