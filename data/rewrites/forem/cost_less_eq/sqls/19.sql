...
-- Original Query
SELECT podcast_episodes.* FROM podcast_episodes WHERE podcast_episodes.id IS NULL LIMIT 3;
-- Rewritten Queries
SELECT podcast_episodes.* FROM podcast_episodes WHERE False LIMIT 3;
