...
-- Original Query
SELECT identities.provider FROM identities WHERE identities.user_id = 3381 AND identities.provider = 'facebook';
-- Rewritten Queries
SELECT identities.provider FROM identities WHERE identities.user_id = 3381 AND identities.provider = 'facebook' LIMIT 1;
