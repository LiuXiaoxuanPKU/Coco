...
-- Original Query
SELECT COUNT(*) FROM feedback_messages LEFT OUTER JOIN users ON users.id = feedback_messages.reporter_id WHERE users.username ILIKE '%username51%';
-- Rewritten Queries
SELECT COUNT(*) FROM feedback_messages INNER JOIN users ON users.id = feedback_messages.reporter_id WHERE users.username ILIKE '%username51%';
SELECT COUNT(*) FROM feedback_messages LEFT OUTER JOIN users ON users.id = feedback_messages.reporter_id WHERE users.username ILIKE '%username51%' LIMIT 1;
SELECT COUNT(*) FROM feedback_messages INNER JOIN users ON users.id = feedback_messages.reporter_id WHERE users.username ILIKE '%username51%' LIMIT 1;
