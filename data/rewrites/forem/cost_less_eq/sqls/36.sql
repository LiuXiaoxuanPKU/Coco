...
-- Original Query
SELECT podcast_episodes.id, podcast_episodes.media_url FROM podcast_episodes WHERE podcast_episodes.podcast_id = 2329;
-- Rewritten Queries
SELECT podcast_episodes.id, podcast_episodes.media_url FROM podcast_episodes WHERE podcast_episodes.podcast_id = 2329 LIMIT 1;
