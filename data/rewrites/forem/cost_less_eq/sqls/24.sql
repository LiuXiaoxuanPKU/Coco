...
-- Original Query
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 6268;
-- Rewritten Queries
SELECT users.id, users.name, users.profile_image, users.username FROM users WHERE users.id = 6268 LIMIT 1;
