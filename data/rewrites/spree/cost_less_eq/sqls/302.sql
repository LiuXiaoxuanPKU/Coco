...
-- Rewritten Queries
SELECT spree_products.* FROM spree_products INNER JOIN spree_products_taxons ON spree_products_taxons.product_id = spree_products.id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_taxons.taxon_id IN (8127, 9022) AND spree_products.id IN (9213, 4043) AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:29:07.481989') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:29:07.482160') AND spree_products.available_on <= '2022-08-14 05:29:07.482154' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL;
