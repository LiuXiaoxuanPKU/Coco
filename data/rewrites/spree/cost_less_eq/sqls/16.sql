...
-- Original Query
SELECT 1 AS "one" FROM spree_states WHERE LOWER(spree_states.name) = 'dktewlcjlhuykiaasyhmyhmwlcbatyeddyfvyuxodzaiscttonwdmtvfzfhmpwgmzumwpgagtgemumolv' AND spree_states.id <> 7955 AND spree_states.country_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_states WHERE LOWER(spree_states.name) = 'dktewlcjlhuykiaasyhmyhmwlcbatyeddyfvyuxodzaiscttonwdmtvfzfhmpwgmzumwpgagtgemumolv' AND spree_states.id <> 7955 AND False LIMIT 1;
