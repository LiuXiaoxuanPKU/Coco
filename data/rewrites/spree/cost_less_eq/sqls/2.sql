...
-- Original Query
SELECT spree_states.* FROM spree_states WHERE spree_states.country_id = 6579 ORDER BY spree_states.name ASC;
-- Rewritten Queries
SELECT spree_states.* FROM spree_states WHERE spree_states.country_id = 6579 ORDER BY spree_states.name ASC LIMIT 1;
