...
-- Original Query
SELECT spree_option_value_variants.* FROM spree_option_value_variants WHERE spree_option_value_variants.variant_id = 4279 AND spree_option_value_variants.option_value_id = 1719;
-- Rewritten Queries
SELECT spree_option_value_variants.* FROM spree_option_value_variants WHERE spree_option_value_variants.variant_id = 4279 AND spree_option_value_variants.option_value_id = 1719 LIMIT 1;
