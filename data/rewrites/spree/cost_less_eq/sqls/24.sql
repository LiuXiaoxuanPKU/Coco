...
-- Original Query
SELECT 1 AS "one" FROM spree_payment_methods_stores WHERE spree_payment_methods_stores.store_id = 15751 AND spree_payment_methods_stores.payment_method_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_payment_methods_stores WHERE spree_payment_methods_stores.store_id = 15751 AND False LIMIT 1;
