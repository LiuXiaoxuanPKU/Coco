...
SELECT 1 AS "one" FROM spree_menus WHERE spree_menus.location = 'header' AND False AND spree_menus.locale IS NULL LIMIT 1;
SELECT 1 AS "one" FROM spree_menus WHERE spree_menus.location = 'header' AND False AND False LIMIT 1;
