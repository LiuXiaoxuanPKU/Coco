...
-- Original Query
SELECT spree_zone_members.* FROM spree_zone_members WHERE spree_zone_members.zoneable_type = 'Spree::State' AND spree_zone_members.zoneable_id = 10544 AND spree_zone_members.zone_id IS NULL ORDER BY spree_zone_members.id ASC LIMIT 5;
-- Rewritten Queries
SELECT spree_zone_members.* FROM spree_zone_members WHERE spree_zone_members.zoneable_type = 'Spree::State' AND spree_zone_members.zoneable_id = 10544 AND False ORDER BY spree_zone_members.id ASC LIMIT 5;
