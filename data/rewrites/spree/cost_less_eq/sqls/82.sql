...
-- Original Query
SELECT spree_assets.* FROM spree_assets WHERE spree_assets.viewable_id IS NULL AND spree_assets.viewable_type IS NULL AND spree_assets."position" >= 1 AND spree_assets.id <> 76 ORDER BY spree_assets."position" ASC LIMIT 3;
-- Rewritten Queries
SELECT spree_assets.* FROM spree_assets WHERE False AND spree_assets.viewable_type IS NULL AND spree_assets."position" >= 1 AND spree_assets.id <> 76 ORDER BY spree_assets."position" ASC LIMIT 3;
