...
-- Original Query
SELECT spree_products_stores.* FROM spree_products_stores WHERE spree_products_stores.product_id = 6140 AND spree_products_stores.store_id = 5860;
-- Rewritten Queries
SELECT spree_products_stores.* FROM spree_products_stores WHERE spree_products_stores.product_id = 6140 AND spree_products_stores.store_id = 5860 LIMIT 1;
