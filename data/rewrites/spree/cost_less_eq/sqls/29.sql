...
-- Original Query
SELECT spree_products_taxons.* FROM spree_products_taxons WHERE spree_products_taxons.taxon_id = 1612 AND spree_products_taxons.product_id = 6683 ORDER BY spree_products_taxons."position" ASC;
-- Rewritten Queries
SELECT spree_products_taxons.* FROM spree_products_taxons WHERE spree_products_taxons.taxon_id = 1612 AND spree_products_taxons.product_id = 6683 ORDER BY spree_products_taxons."position" ASC LIMIT 1;
