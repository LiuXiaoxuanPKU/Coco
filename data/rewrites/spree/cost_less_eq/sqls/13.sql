...
-- Original Query
SELECT spree_products_taxons.* FROM spree_products_taxons WHERE spree_products_taxons.product_id = 11294 AND spree_products_taxons.taxon_id = 7492;
-- Rewritten Queries
SELECT spree_products_taxons.* FROM spree_products_taxons WHERE spree_products_taxons.product_id = 11294 AND spree_products_taxons.taxon_id = 7492 LIMIT 1;
