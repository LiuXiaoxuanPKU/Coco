...
-- Original Query
SELECT spree_states.id FROM spree_states WHERE spree_states.country_id = 6385 ORDER BY spree_states.name ASC;
-- Rewritten Queries
SELECT spree_states.id FROM spree_states WHERE spree_states.country_id = 6385 ORDER BY spree_states.name ASC LIMIT 1;
