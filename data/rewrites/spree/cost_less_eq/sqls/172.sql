...
-- Original Query
SELECT 1 AS "one" FROM spree_products LEFT OUTER JOIN spree_products_taxons ON spree_products_taxons.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_taxons.taxon_id IN (7075, 3758) AND spree_products.id = 11867 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_products INNER JOIN spree_products_taxons ON spree_products_taxons.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_taxons.taxon_id IN (9748, 7075) AND spree_products.id = 11867 LIMIT 1;
