...
-- Original Query
SELECT 1 AS "one" FROM spree_product_properties WHERE spree_product_properties.property_id = 3261 AND spree_product_properties.product_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_product_properties WHERE spree_product_properties.property_id = 3261 AND False LIMIT 1;
