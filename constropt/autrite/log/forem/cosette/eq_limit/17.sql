...
-- Original Query
SELECT identities.provider FROM identities WHERE identities.user_id = 1793 AND identities.provider = 'github';
-- Rewritten Queries
SELECT identities.provider FROM identities WHERE identities.user_id = 1793 AND identities.provider = 'github' LIMIT 1;
