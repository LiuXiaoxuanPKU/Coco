...
-- Original Query
SELECT organization_memberships.organization_id FROM organization_memberships WHERE organization_memberships.user_id = 9254 AND organization_memberships.type_of_user IN ('guest', 'admin');
-- Rewritten Queries
SELECT organization_memberships.organization_id FROM organization_memberships WHERE organization_memberships.user_id = 9254 AND organization_memberships.type_of_user IN ('guest', 'admin') LIMIT 1;
