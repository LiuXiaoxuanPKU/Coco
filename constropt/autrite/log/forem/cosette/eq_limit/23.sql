...
-- Original Query
SELECT mentions.* FROM mentions WHERE mentions.mentionable_id = 5361 AND mentions.mentionable_type = 'Comment' AND mentions.user_id <> 5551;
-- Rewritten Queries
SELECT mentions.* FROM mentions WHERE mentions.mentionable_id = 5361 AND mentions.mentionable_type = 'Comment' AND mentions.user_id <> 5551 LIMIT 1;
