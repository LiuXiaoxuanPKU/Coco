...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 2864 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 8394 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'wmdchazyhijzkayphsnhrcyxsyeqbxrmpjmbgyviwuwslxxdchyhrrgptzbjkqiacxhwtixztsvcbnsdgwywuouyjgbcniwlvfitqcssmgqudhslibanyqlapubjbkgmgsauealpjczjjvgunzwkjxhmyjyzkwtyngpxtebfgejxrldeyttzbeurpqtdhebsvneyeqccavldrucjejanpix' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 2864 AND False AND notifications.notifiable_id = 8394 AND notifications.notifiable_type = 'TagAdjustment' AND notifications.action = 'wmdchazyhijzkayphsnhrcyxsyeqbxrmpjmbgyviwuwslxxdchyhrrgptzbjkqiacxhwtixztsvcbnsdgwywuouyjgbcniwlvfitqcssmgqudhslibanyqlapubjbkgmgsauealpjczjjvgunzwkjxhmyjyzkwtyngpxtebfgejxrldeyttzbeurpqtdhebsvneyeqccavldrucjejanpix' LIMIT 1;
