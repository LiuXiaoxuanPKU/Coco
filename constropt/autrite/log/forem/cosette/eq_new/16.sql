...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id <> 8162 AND articles.user_id = 5477 AND articles.title IS NULL LIMIT 3;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE False AND articles.id <> 8162 AND articles.user_id = 5477 AND articles.title IS NULL LIMIT 3;
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id <> 8162 AND articles.user_id = 5477 AND False LIMIT 3;
SELECT 1 AS "one" FROM articles WHERE False AND articles.id <> 8162 AND articles.user_id = 5477 AND False LIMIT 3;
