...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id <> 105 AND articles.user_id = 3243 AND articles.title IS NULL LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.id <> 105 AND articles.user_id = 3243 AND False LIMIT 9;
SELECT 1 AS "one" FROM articles WHERE False AND articles.id <> 105 AND articles.user_id = 3243 AND articles.title IS NULL LIMIT 9;
SELECT 1 AS "one" FROM articles WHERE False AND articles.id <> 105 AND articles.user_id = 3243 AND False LIMIT 9;
