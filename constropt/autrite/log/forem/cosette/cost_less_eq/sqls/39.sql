...
-- Original Query
SELECT COUNT(*) FROM identities WHERE identities.user_id = 6200 AND identities.provider IN ('facebook', 'apple') AND identities.provider IN ('apple', 'github', 'twitter', 'apple', 'facebook', 'apple');
-- Rewritten Queries
SELECT COUNT(*) FROM identities WHERE identities.user_id = 6200 AND identities.provider IN ('facebook', 'apple') AND identities.provider IN ('apple', 'github', 'twitter', 'apple', 'facebook', 'apple') LIMIT 1;
