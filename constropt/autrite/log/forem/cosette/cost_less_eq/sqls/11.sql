...
-- Original Query
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'yhggkuoiayefhowdngqfxsugaezkerloljyzrmedsgimjximgbrqwfkafwyktwqdhqwpwxaksmev';
-- Rewritten Queries
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'yhggkuoiayefhowdngqfxsugaezkerloljyzrmedsgimjximgbrqwfkafwyktwqdhqwpwxaksmev' LIMIT 1;
