...
-- Original Query
SELECT collections.slug FROM collections WHERE collections.user_id = 2158;
-- Rewritten Queries
SELECT collections.slug FROM collections WHERE collections.user_id = 2158 LIMIT 1;
