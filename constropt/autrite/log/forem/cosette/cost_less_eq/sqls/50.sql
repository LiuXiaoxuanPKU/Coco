...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 9946 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 9817 AND reactions.category IN ('thinking', 'like');
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 9946 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 9817 AND reactions.category IN ('thinking', 'like') LIMIT 1;
