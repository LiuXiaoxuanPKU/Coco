...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 3802 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 5117 AND reactions.category = 'hands';
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 3802 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 5117 AND reactions.category = 'hands' LIMIT 1;
