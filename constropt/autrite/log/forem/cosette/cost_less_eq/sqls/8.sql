...
-- Original Query
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 1286;
-- Rewritten Queries
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 1286 LIMIT 1;
