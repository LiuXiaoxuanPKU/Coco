...
-- Original Query
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'djcvvrkbxdrvn';
-- Rewritten Queries
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'djcvvrkbxdrvn' LIMIT 1;
