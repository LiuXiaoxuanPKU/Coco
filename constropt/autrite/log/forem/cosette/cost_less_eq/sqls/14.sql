...
-- Original Query
SELECT identities.* FROM identities WHERE identities.user_id = 7212 AND identities.provider = 'facebook';
-- Rewritten Queries
SELECT identities.* FROM identities WHERE identities.user_id = 7212 AND identities.provider = 'facebook' LIMIT 1;
