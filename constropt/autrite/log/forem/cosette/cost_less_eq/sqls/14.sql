...
-- Original Query
SELECT identities.* FROM identities WHERE identities.user_id = 9414 AND identities.provider = 'apple';
-- Rewritten Queries
SELECT identities.* FROM identities WHERE identities.user_id = 9414 AND identities.provider = 'apple' LIMIT 1;
