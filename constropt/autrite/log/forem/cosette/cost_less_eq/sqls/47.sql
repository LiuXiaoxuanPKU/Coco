...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 5086 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 1496 AND reactions.category = 'thumbsup';
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 5086 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 1496 AND reactions.category = 'thumbsup' LIMIT 1;
