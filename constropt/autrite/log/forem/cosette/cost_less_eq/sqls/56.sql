...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.category IN ('thumbsup', 'thumbsup', 'unicorn', 'readinglist', 'hands') AND reactions.reactable_id = 9947 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 2819;
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.category IN ('thumbsup', 'thumbsup', 'unicorn', 'readinglist', 'hands') AND reactions.reactable_id = 9947 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 2819 LIMIT 1;
