...
-- Original Query
SELECT pages.* FROM pages WHERE pages.slug = 'gzojlitjiejoyklrykgmyjusrjnmrpnsxrswxvdxdneaovlhqfmafjpzcrrkjadrijsdrulgtudli';
-- Rewritten Queries
SELECT pages.* FROM pages WHERE pages.slug = 'gzojlitjiejoyklrykgmyjusrjnmrpnsxrswxvdxdneaovlhqfmafjpzcrrkjadrijsdrulgtudli' LIMIT 1;
