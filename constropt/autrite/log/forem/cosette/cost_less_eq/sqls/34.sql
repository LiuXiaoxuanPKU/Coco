...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'hfizrbptpekeyla' AND articles.user_id = 8190 AND articles.title IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown = 'hfizrbptpekeyla' AND articles.user_id = 8190 AND False LIMIT 1;
