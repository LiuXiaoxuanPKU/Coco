...
-- Original Query
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 3174;
-- Rewritten Queries
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 3174 LIMIT 1;
