...
-- Original Query
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'ivnhedaoxyl';
-- Rewritten Queries
SELECT users.* FROM users WHERE users.registered = True AND users.username = 'ivnhedaoxyl' LIMIT 1;
