...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9225 AND notifications.id <> 7829 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 6931 AND notifications.notifiable_type = 'Article' AND notifications.action = 'xuedybuscjujjpynrspuxxvpihtidncfajstapujtfjwmtwppficyqtovfjiykreyzljakpebzirzkbyjzsxhhbsqczjyzszaymwdiwheuaqdymaixgbluqndicfqcbunkyen' LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9225 AND notifications.id <> 7829 AND False AND notifications.notifiable_id = 6931 AND notifications.notifiable_type = 'Article' AND notifications.action = 'xuedybuscjujjpynrspuxxvpihtidncfajstapujtfjwmtwppficyqtovfjiykreyzljakpebzirzkbyjzsxhhbsqczjyzszaymwdiwheuaqdymaixgbluqndicfqcbunkyen' LIMIT 6;
