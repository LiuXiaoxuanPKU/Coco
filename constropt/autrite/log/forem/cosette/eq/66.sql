...
-- Original Query
SELECT notification_subscriptions.user_id FROM notification_subscriptions WHERE notification_subscriptions.notifiable_id = 9039 AND notification_subscriptions.notifiable_type = 'Article' AND notification_subscriptions.config = 'top_level_comments';
-- Rewritten Queries
SELECT notification_subscriptions.user_id FROM notification_subscriptions WHERE notification_subscriptions.notifiable_id = 9039 AND notification_subscriptions.notifiable_type = 'Article' AND notification_subscriptions.config = 'top_level_comments' LIMIT 1;
