...
-- Original Query
SELECT articles.* FROM articles WHERE articles.user_id = 6951 AND articles.slug IS NULL LIMIT 9;
-- Rewritten Queries
SELECT articles.* FROM articles WHERE articles.user_id = 6951 AND False LIMIT 9;
