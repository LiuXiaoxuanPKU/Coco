...
-- Original Query
SELECT DISTINCT articles.id AS alias_0, articles.id FROM articles LEFT OUTER JOIN reactions ON reactions.reactable_type = 'Comment' AND reactions.reactable_id = articles.id WHERE articles.id = 7222 ORDER BY articles.id ASC LIMIT 8;
-- Rewritten Queries
SELECT DISTINCT articles.id AS alias_0, articles.id FROM articles INNER JOIN reactions ON reactions.reactable_type = 'Comment' AND reactions.reactable_id = articles.id WHERE articles.id = 7222 ORDER BY articles.id ASC LIMIT 8;
