...
-- Original Query
SELECT identities.* FROM identities WHERE identities.user_id = 8979 AND identities.provider = 'apple';
-- Rewritten Queries
SELECT identities.* FROM identities WHERE identities.user_id = 8979 AND identities.provider = 'apple' LIMIT 1;
