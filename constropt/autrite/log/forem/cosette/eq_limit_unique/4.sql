...
-- Original Query
SELECT collections.slug FROM collections WHERE collections.user_id = 8311;
-- Rewritten Queries
SELECT collections.slug FROM collections WHERE collections.user_id = 8311 LIMIT 1;
