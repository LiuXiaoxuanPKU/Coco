...
-- Original Query
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 7409 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 8572 AND reactions.category = 'like';
-- Rewritten Queries
SELECT reactions.* FROM reactions WHERE reactions.reactable_id = 7409 AND reactions.reactable_type = 'Comment' AND reactions.user_id = 8572 AND reactions.category = 'like' LIMIT 1;
