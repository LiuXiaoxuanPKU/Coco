...
-- Original Query
SELECT pages.* FROM pages WHERE pages.slug = 'vujuaequfyrbzzswgyffqmlgvbpnkwtnwuhlyxohpghsdefvoqonecxrducsqovsejxccoembgjolfirzxicznpfjkekqqhqodsizikygohrzylzcbgmxetbrxdsvsiinahpbiyckzcaxrefsmkxglyrarwxkpopqzoiqotimc';
-- Rewritten Queries
SELECT pages.* FROM pages WHERE pages.slug = 'vujuaequfyrbzzswgyffqmlgvbpnkwtnwuhlyxohpghsdefvoqonecxrducsqovsejxccoembgjolfirzxicznpfjkekqqhqodsizikygohrzylzcbgmxetbrxdsvsiinahpbiyckzcaxrefsmkxglyrarwxkpopqzoiqotimc' LIMIT 1;
