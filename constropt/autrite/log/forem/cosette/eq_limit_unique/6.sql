...
-- Original Query
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 8578;
-- Rewritten Queries
SELECT users_settings.* FROM users_settings WHERE users_settings.user_id = 8578 LIMIT 1;
