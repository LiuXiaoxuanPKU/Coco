...
-- Original Query
SELECT mentions.user_id FROM mentions WHERE mentions.mentionable_id = 4423 AND mentions.mentionable_type = 'Article';
-- Rewritten Queries
SELECT mentions.user_id FROM mentions WHERE mentions.mentionable_id = 4423 AND mentions.mentionable_type = 'Article' LIMIT 1;
