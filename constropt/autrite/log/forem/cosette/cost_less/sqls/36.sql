...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.organization_id = 3 AND notifications.notifiable_id = 1136 AND notifications.notifiable_type = 'Article' AND notifications.action = 'bkzfoxhjihvjioqqaulodnwp' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.organization_id = 3 AND notifications.notifiable_id = 1136 AND notifications.notifiable_type = 'Article' AND notifications.action = 'bkzfoxhjihvjioqqaulodnwp' LIMIT 1;
