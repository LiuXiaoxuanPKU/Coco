...
-- Original Query
SELECT devices.* FROM devices WHERE devices.user_id = 2385 AND devices.token IS NULL AND devices.platform IS NULL AND devices.consumer_app_id IS NULL LIMIT 9;
-- Rewritten Queries
SELECT devices.* FROM devices WHERE devices.user_id = 2385 AND devices.token IS NULL AND False AND devices.consumer_app_id IS NULL LIMIT 9;
SELECT devices.* FROM devices WHERE devices.user_id = 2385 AND False AND devices.platform IS NULL AND devices.consumer_app_id IS NULL LIMIT 9;
SELECT devices.* FROM devices WHERE devices.user_id = 2385 AND False AND False AND devices.consumer_app_id IS NULL LIMIT 9;
