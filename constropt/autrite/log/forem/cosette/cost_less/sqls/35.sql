...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 7472 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 1136 AND notifications.notifiable_type = 'Article' AND notifications.action = 'bkzfoxhjihvjioqqaulodnwp' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 7472 AND False AND notifications.notifiable_id = 1136 AND notifications.notifiable_type = 'Article' AND notifications.action = 'bkzfoxhjihvjioqqaulodnwp' LIMIT 1;
