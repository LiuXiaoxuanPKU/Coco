...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9135 AND notifications.organization_id IS NULL AND notifications.notifiable_id = 4726 AND notifications.notifiable_type = 'Article' AND notifications.action = 'rbbevwvgffblhjqzrfbuadqxcyttxrmfoxryhtnevdlzdftfjuivbnjffkdzeclhhmglcknqldjcbpgjcmrrzn' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id = 9135 AND False AND notifications.notifiable_id = 4726 AND notifications.notifiable_type = 'Article' AND notifications.action = 'rbbevwvgffblhjqzrfbuadqxcyttxrmfoxryhtnevdlzdftfjuivbnjffkdzeclhhmglcknqldjcbpgjcmrrzn' LIMIT 1;
