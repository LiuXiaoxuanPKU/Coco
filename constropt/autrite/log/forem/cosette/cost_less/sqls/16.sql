...
-- Original Query
SELECT 1 AS "one" FROM articles WHERE articles.body_markdown IS NULL AND articles.user_id = 3351 AND articles.title = 'geqnhgomhcrpactajftrccziatq' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM articles WHERE False AND articles.user_id = 3351 AND articles.title = 'geqnhgomhcrpactajftrccziatq' LIMIT 1;
