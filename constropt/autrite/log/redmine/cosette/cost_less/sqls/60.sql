...
-- Original Query
SELECT DISTINCT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (11734, 10755, 18017) AND workflows.role_id IN (7897, 6783, 6512, 1435);
-- Rewritten Queries
SELECT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id IN (18615, 11734, 10755) AND workflows.role_id IN (290, 7897, 6783, 6512);
