...
-- Original Query
SELECT 1 AS "one" FROM watchers WHERE watchers.user_id = 1783 AND watchers.watchable_type = 'Message' AND watchers.watchable_id IS NULL LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM watchers WHERE watchers.user_id = 1783 AND watchers.watchable_type = 'Message' AND False LIMIT 10;
