...
-- Original Query
SELECT 1 AS "one" FROM wiki_pages WHERE wiki_pages.title IS NULL AND wiki_pages.wiki_id = 16318 LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM wiki_pages WHERE False AND wiki_pages.wiki_id = 16318 LIMIT 8;
