...
-- Original Query
SELECT 1 AS "one" FROM wiki_pages WHERE LOWER(wiki_pages.title) = 'Pfbocwvcbusvbzlstnshpoovnnubqoniewcgzsjqvothmdvjktdbznldcckj' AND wiki_pages.wiki_id IS NULL LIMIT 5;
-- Rewritten Queries
SELECT 1 AS "one" FROM wiki_pages WHERE LOWER(wiki_pages.title) = 'Pfbocwvcbusvbzlstnshpoovnnubqoniewcgzsjqvothmdvjktdbznldcckj' AND False LIMIT 5;
