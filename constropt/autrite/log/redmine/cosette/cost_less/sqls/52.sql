...
-- Original Query
SELECT DISTINCT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id = 13358 AND workflows.role_id IN (7689, 8070, 1538, 5660);
-- Rewritten Queries
SELECT workflows.old_status_id, workflows.new_status_id FROM workflows WHERE workflows.type IN ('WorkflowTransition') AND workflows.tracker_id = 13358 AND workflows.role_id IN (7119, 7689, 8070, 1538);
