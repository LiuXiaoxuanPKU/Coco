...
-- Original Query
SELECT members.* FROM members INNER JOIN projects ON projects.id = members.project_id WHERE members.user_id = 2636 AND projects.status <> 5 AND members.project_id = 946 ORDER BY members.id ASC LIMIT 6;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.user_id = 2636 AND members.project_id = 946 ORDER BY members.id ASC LIMIT 6;
