...
-- Original Query
SELECT 1 AS "one" FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 2919 LIMIT 2;
-- Rewritten Queries
SELECT 1 AS "one" FROM trackers LIMIT 2;
