...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 5022 AND issue_relations.issue_to_id IN (3675, 3676, 2995);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 5022 AND issue_relations.issue_to_id IN (3675, 3676, 2995) LIMIT 1;
