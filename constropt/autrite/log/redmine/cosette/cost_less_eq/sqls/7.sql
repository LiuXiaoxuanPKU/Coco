...
-- Original Query
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id = 1088;
-- Rewritten Queries
SELECT email_addresses.address FROM email_addresses WHERE email_addresses.user_id = 1088 LIMIT 1;
