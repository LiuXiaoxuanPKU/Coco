...
-- Original Query
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 761 AND watchers.watchable_type = 'News' AND users.status = 1;
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 761 AND watchers.watchable_type = 'News' AND users.status = 1 LIMIT 1;
