...
-- Original Query
SELECT 1 AS "one" FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 5055 AND 1 = 0 LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM trackers WHERE 1 = 0 LIMIT 9;
