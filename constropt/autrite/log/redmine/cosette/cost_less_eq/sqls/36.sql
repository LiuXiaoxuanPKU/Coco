...
-- Original Query
SELECT users.id FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 7808 AND watchers.watchable_type = 'News';
-- Rewritten Queries
SELECT users.id FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 7808 AND watchers.watchable_type = 'News' LIMIT 1;
