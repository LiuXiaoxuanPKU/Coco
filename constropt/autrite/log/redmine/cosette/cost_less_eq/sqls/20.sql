...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 5966 AND issue_relations.issue_to_id IN (8232, 4896, 3738);
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 5966 AND issue_relations.issue_to_id IN (8232, 4896, 3738) LIMIT 1;
