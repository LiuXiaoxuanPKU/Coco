...
-- Original Query
SELECT wiki_pages.title FROM wiki_pages WHERE wiki_pages.wiki_id = 6442 ORDER BY LOWER(title) ASC;
-- Rewritten Queries
SELECT wiki_pages.title FROM wiki_pages WHERE wiki_pages.wiki_id = 6442 ORDER BY LOWER(title) ASC LIMIT 1;
