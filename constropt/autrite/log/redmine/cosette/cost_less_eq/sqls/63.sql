...
-- Original Query
SELECT members.* FROM members INNER JOIN users ON users.id = members.user_id WHERE members.project_id = 5084 AND users.type = 'User' AND users.status = 2 AND users.status = 2;
-- Rewritten Queries
SELECT members.* FROM members WHERE members.project_id = 5084;
SELECT members.* FROM members WHERE members.project_id = 5084 LIMIT 1;
SELECT members.* FROM members INNER JOIN users ON users.id = members.user_id WHERE members.project_id = 5084 AND users.type = 'User' AND users.status = 2 AND users.status = 2 LIMIT 1;
