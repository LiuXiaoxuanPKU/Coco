...
-- Original Query
SELECT 1 AS "one" FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 9634 AND trackers.id = 8013 LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM trackers WHERE trackers.id = 8013 LIMIT 10;
