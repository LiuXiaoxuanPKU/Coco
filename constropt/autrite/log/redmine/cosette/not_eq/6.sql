...
-- Original Query
SELECT trackers.name FROM trackers WHERE trackers.id IN (8299, 9137, 7827) ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.name FROM trackers WHERE trackers.id IN (8299, 9137, 7827) ORDER BY trackers.position ASC LIMIT 1;
