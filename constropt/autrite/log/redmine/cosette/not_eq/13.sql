...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id IN (3132, 3282, 291);
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id IN (3132, 3282, 291) LIMIT 1;
