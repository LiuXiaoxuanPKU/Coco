...
-- Original Query
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id IN (407, 231);
-- Rewritten Queries
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id IN (407, 231) LIMIT 1;
