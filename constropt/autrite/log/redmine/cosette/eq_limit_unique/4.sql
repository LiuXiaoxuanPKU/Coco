...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'cyeclxlvkbladuqvnx@hotmail.fr';
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'cyeclxlvkbladuqvnx@hotmail.fr' LIMIT 1;
