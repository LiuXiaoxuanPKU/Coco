...
-- Original Query
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 3264 AND issue_relations.issue_to_id IN (8961, 8703, 1886);
-- Rewritten Queries
SELECT COUNT(*) FROM issue_relations WHERE issue_relations.issue_from_id = 3264 AND issue_relations.issue_to_id IN (8961, 8703, 1886) LIMIT 1;
