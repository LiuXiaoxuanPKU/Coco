...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6962 AND issue_relations.issue_to_id = 9656 AND issue_relations.relation_type IN ('copied_to', 'copied_to');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6962 AND issue_relations.issue_to_id = 9656 AND issue_relations.relation_type IN ('copied_to', 'copied_to') LIMIT 1;
