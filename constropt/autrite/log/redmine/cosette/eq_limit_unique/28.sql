...
-- Original Query
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 2919 AND watchers.watchable_type = 'News' AND users.status = 2;
-- Rewritten Queries
SELECT users.* FROM users INNER JOIN watchers ON users.id = watchers.user_id WHERE watchers.watchable_id = 2919 AND watchers.watchable_type = 'News' AND users.status = 2 LIMIT 1;
