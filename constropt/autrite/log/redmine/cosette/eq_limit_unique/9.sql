...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6112 AND issue_relations.issue_to_id = 5996;
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 6112 AND issue_relations.issue_to_id = 5996 LIMIT 1;
