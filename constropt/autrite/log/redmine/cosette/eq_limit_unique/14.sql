...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 4618 AND issue_relations.issue_to_id IN (7551, 8328, 8627);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 4618 AND issue_relations.issue_to_id IN (7551, 8328, 8627) LIMIT 1;
