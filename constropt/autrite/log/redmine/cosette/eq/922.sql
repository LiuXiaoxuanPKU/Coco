...
SELECT wiki_content_versions.updated_on, wiki_content_versions.comments, wiki_content_versions.version, wiki_pages.title, wiki_content_versions.page_id, wiki_content_versions.author_id, wiki_content_versions.id FROM wiki_content_versions LEFT JOIN wiki_pages ON wiki_pages.id = wiki_content_versions.page_id LEFT JOIN wikis ON wikis.id = wiki_pages.wiki_id INNER JOIN projects ON projects.id = wikis.project_id WHERE wiki_content_versions.author_id = 8 AND projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'wiki') IS NOT NULL ORDER BY wiki_content_versions.id DESC LIMIT 4;
SELECT wiki_content_versions.updated_on, wiki_content_versions.comments, wiki_content_versions.version, wiki_pages.title, wiki_content_versions.page_id, wiki_content_versions.author_id, wiki_content_versions.id FROM wiki_content_versions INNER JOIN wiki_pages ON wiki_pages.id = wiki_content_versions.page_id LEFT JOIN wikis ON wikis.id = wiki_pages.wiki_id LEFT JOIN projects ON projects.id = wikis.project_id WHERE wiki_content_versions.author_id = 8 AND projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'wiki' LIMIT 1) IS NOT NULL ORDER BY wiki_content_versions.id DESC LIMIT 4;
SELECT wiki_content_versions.updated_on, wiki_content_versions.comments, wiki_content_versions.version, wiki_pages.title, wiki_content_versions.page_id, wiki_content_versions.author_id, wiki_content_versions.id FROM wiki_content_versions LEFT JOIN wiki_pages ON wiki_pages.id = wiki_content_versions.page_id INNER JOIN wikis ON wikis.id = wiki_pages.wiki_id LEFT JOIN projects ON projects.id = wikis.project_id WHERE wiki_content_versions.author_id = 8 AND projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'wiki' LIMIT 1) IS NOT NULL ORDER BY wiki_content_versions.id DESC LIMIT 4;
SELECT wiki_content_versions.updated_on, wiki_content_versions.comments, wiki_content_versions.version, wiki_pages.title, wiki_content_versions.page_id, wiki_content_versions.author_id, wiki_content_versions.id FROM wiki_content_versions LEFT JOIN wiki_pages ON wiki_pages.id = wiki_content_versions.page_id LEFT JOIN wikis ON wikis.id = wiki_pages.wiki_id INNER JOIN projects ON projects.id = wikis.project_id WHERE wiki_content_versions.author_id = 8 AND projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'wiki' LIMIT 1) IS NOT NULL ORDER BY wiki_content_versions.id DESC LIMIT 4;
