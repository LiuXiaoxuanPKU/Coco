...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'tojayxgemmmyxsebrlfgmtjjuulcbipluxgy@live.com';
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'tojayxgemmmyxsebrlfgmtjjuulcbipluxgy@live.com' LIMIT 1;
