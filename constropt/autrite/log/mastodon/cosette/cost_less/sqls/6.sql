...
-- Original Query
SELECT 1 AS "one" FROM follows WHERE follows.account_id = 108847825192451992 AND follows.target_account_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM follows WHERE follows.account_id = 108847825192451992 AND False LIMIT 1;
