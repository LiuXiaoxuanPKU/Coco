...
-- Original Query
SELECT webauthn_credentials.external_id FROM webauthn_credentials WHERE webauthn_credentials.user_id = 6397;
-- Rewritten Queries
SELECT webauthn_credentials.external_id FROM webauthn_credentials WHERE webauthn_credentials.user_id = 6397 LIMIT 1;
