...
-- Original Query
SELECT COUNT(distinct name) FROM announcement_reactions WHERE announcement_reactions.announcement_id = 2312 AND announcement_reactions.name != '🧝‍♀️';
-- Rewritten Queries
SELECT COUNT( name) FROM announcement_reactions WHERE announcement_reactions.announcement_id = 2312 AND announcement_reactions.name != '🧝‍♀️'