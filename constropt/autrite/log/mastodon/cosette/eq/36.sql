...
-- Original Query
SELECT COUNT(*) FROM account_pins WHERE account_pins.account_id = 56 AND account_pins.target_account_id = 108847821772236278;
-- Rewritten Queries
SELECT COUNT(*) FROM account_pins WHERE account_pins.account_id = 56 AND account_pins.target_account_id = 108847821772236278 LIMIT 1;
