...
-- Original Query
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id IN (108847820748993043, 108847820748993043, 108847820748993043) AND blocks.account_id = 24;
-- Rewritten Queries
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id IN (108847820748993043, 108847820748993043, 108847820748993043) AND blocks.account_id = 24 LIMIT 1;
