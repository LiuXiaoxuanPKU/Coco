...
-- Original Query
SELECT favourites.status_id FROM favourites WHERE favourites.account_id = 108847814353055139 AND favourites.id = 1;
-- Rewritten Queries
SELECT favourites.status_id FROM favourites WHERE favourites.account_id = 108847814353055139 AND favourites.id = 1 LIMIT 1;
