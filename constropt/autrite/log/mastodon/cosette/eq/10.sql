...
-- Original Query
SELECT COUNT(*) FROM mentions WHERE mentions.account_id = 108847817444498388 AND mentions.status_id = 107465074393578429;
-- Rewritten Queries
SELECT COUNT(*) FROM mentions WHERE mentions.account_id = 108847817444498388 AND mentions.status_id = 107465074393578429 LIMIT 1;
