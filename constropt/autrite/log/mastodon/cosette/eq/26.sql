...
-- Original Query
SELECT bookmarks.status_id FROM bookmarks WHERE bookmarks.status_id = 102980977251984983 AND bookmarks.account_id = 108847831963086148;
-- Rewritten Queries
SELECT bookmarks.status_id FROM bookmarks WHERE bookmarks.status_id = 102980977251984983 AND bookmarks.account_id = 108847831963086148 LIMIT 1;
