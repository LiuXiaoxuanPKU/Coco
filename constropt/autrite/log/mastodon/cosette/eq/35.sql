...
-- Original Query
SELECT list_accounts.* FROM list_accounts WHERE list_accounts.list_id = 8446 AND list_accounts.account_id = 108847823225322354;
-- Rewritten Queries
SELECT list_accounts.* FROM list_accounts WHERE list_accounts.list_id = 8446 AND list_accounts.account_id = 108847823225322354 LIMIT 1;
