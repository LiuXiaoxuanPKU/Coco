...
-- Original Query
SELECT 1 AS "one" FROM favourites WHERE favourites.status_id IS NULL AND favourites.id <> 1 AND favourites.account_id = 108847814353055139 LIMIT 3;
-- Rewritten Queries
SELECT 1 AS "one" FROM favourites WHERE False AND favourites.id <> 1 AND favourites.account_id = 108847814353055139 LIMIT 3;
