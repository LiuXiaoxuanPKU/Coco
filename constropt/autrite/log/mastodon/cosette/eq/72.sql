...
-- Original Query
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847831671126818 AND follows.target_account_id = 108847830090045132 AND follows.show_reblogs = True;
-- Rewritten Queries
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847831671126818 AND follows.target_account_id = 108847830090045132 AND follows.show_reblogs = True LIMIT 1;
