...
-- Original Query
SELECT custom_emojis.* FROM custom_emojis WHERE custom_emojis.shortcode = 'sdarcz' AND custom_emojis.domain IS NULL AND custom_emojis.disabled = False;
-- Rewritten Queries
SELECT custom_emojis.* FROM custom_emojis WHERE custom_emojis.shortcode = 'sdarcz' AND custom_emojis.domain IS NULL AND custom_emojis.disabled = False LIMIT 1;
