...
-- Original Query
SELECT conversation_mutes.conversation_id FROM conversation_mutes WHERE conversation_mutes.conversation_id IN (520, 520) AND conversation_mutes.account_id = 108847803849465088;
-- Rewritten Queries
SELECT conversation_mutes.conversation_id FROM conversation_mutes WHERE conversation_mutes.conversation_id IN (520, 520) AND conversation_mutes.account_id = 108847803849465088 LIMIT 1;
