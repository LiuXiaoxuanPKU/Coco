...
-- Original Query
SELECT 1 AS "one" FROM account_domain_blocks WHERE account_domain_blocks.account_id = 108847819381869235 AND account_domain_blocks.domain IS NULL LIMIT 10;
-- Rewritten Queries
SELECT 1 AS "one" FROM account_domain_blocks WHERE account_domain_blocks.account_id = 108847819381869235 AND False LIMIT 10;
