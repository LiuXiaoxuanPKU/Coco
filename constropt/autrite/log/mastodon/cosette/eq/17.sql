...
-- Original Query
SELECT session_activations.* FROM session_activations WHERE session_activations.session_id = 'liupfekjvcvpvyuthvfrdbfrepyglloyymddlcmtlyvblrfugmigvfitcwnthhrzjbwebginbvxvlngmtfvxxqkmweopvedgmybxqrkocphequhcbaamhbskpbmfkdcwmpkiswlaskcvhzavqwtloazfsyccrplhvfvmtvozwhcrbshaqspj';
-- Rewritten Queries
SELECT session_activations.* FROM session_activations WHERE session_activations.session_id = 'liupfekjvcvpvyuthvfrdbfrepyglloyymddlcmtlyvblrfugmigvfitcwnthhrzjbwebginbvxvlngmtfvxxqkmweopvedgmybxqrkocphequhcbaamhbskpbmfkdcwmpkiswlaskcvhzavqwtloazfsyccrplhvfvmtvozwhcrbshaqspj' LIMIT 1;
