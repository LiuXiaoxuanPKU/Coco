...
-- Original Query
SELECT follows.* FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id = 108847831671126818;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id = 108847831671126818 LIMIT 1;
