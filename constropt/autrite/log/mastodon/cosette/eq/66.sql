...
-- Original Query
SELECT custom_emojis.* FROM custom_emojis WHERE custom_emojis.domain = 'trsipvofjmswpgpaglafluiqajkjpypmfyvyjpjjgoxbgwljrodevmtmqdcabzhwcovxjnxqlfnikqralclitwnmovsgasibrdkis' ORDER BY custom_emojis.domain ASC, custom_emojis.shortcode ASC;
-- Rewritten Queries
SELECT custom_emojis.* FROM custom_emojis WHERE custom_emojis.domain = 'trsipvofjmswpgpaglafluiqajkjpypmfyvyjpjjgoxbgwljrodevmtmqdcabzhwcovxjnxqlfnikqralclitwnmovsgasibrdkis' ORDER BY custom_emojis.domain ASC, custom_emojis.shortcode ASC LIMIT 1;
