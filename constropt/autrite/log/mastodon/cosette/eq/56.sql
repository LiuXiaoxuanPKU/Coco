...
-- Original Query
SELECT COUNT(*) FROM accounts INNER JOIN follows ON accounts.id = follows.target_account_id WHERE follows.account_id = 108847831671126818;
-- Rewritten Queries
SELECT COUNT(*) FROM accounts INNER JOIN follows ON accounts.id = follows.target_account_id WHERE follows.account_id = 108847831671126818 LIMIT 1;
