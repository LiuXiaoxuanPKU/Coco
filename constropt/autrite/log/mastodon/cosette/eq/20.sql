...
-- Original Query
SELECT mutes.* FROM mutes WHERE mutes.target_account_id IN (108847828785536465, 108847828785536465, 108847828785536465) AND mutes.account_id = 108847822853950449;
-- Rewritten Queries
SELECT mutes.* FROM mutes WHERE mutes.target_account_id IN (108847828785536465, 108847828785536465, 108847828785536465) AND mutes.account_id = 108847822853950449 LIMIT 1;
