...
-- Original Query
SELECT follows.account_id FROM follows WHERE follows.account_id = 108847831671126818 AND follows.target_account_id = 108847830090045132;
-- Rewritten Queries
SELECT follows.account_id FROM follows WHERE follows.account_id = 108847831671126818 AND follows.target_account_id = 108847830090045132 LIMIT 1;
