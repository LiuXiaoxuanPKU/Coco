...
-- Original Query
SELECT mentions.status_id FROM mentions WHERE mentions.silent = False AND mentions.status_id IN (107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429) AND mentions.account_id = 108847817444498388;
-- Rewritten Queries
SELECT mentions.status_id FROM mentions WHERE mentions.silent = False AND mentions.status_id IN (107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429, 107465074393578429) AND mentions.account_id = 108847817444498388 LIMIT 1;
