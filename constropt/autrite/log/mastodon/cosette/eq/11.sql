...
-- Original Query
SELECT markers.* FROM markers WHERE markers.user_id = 1 AND markers.timeline IN ('home', 'home');
-- Rewritten Queries
SELECT markers.* FROM markers WHERE markers.user_id = 1 AND markers.timeline IN ('home', 'home') LIMIT 1;
