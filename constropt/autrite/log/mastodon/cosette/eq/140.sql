...
-- Original Query
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts INNER JOIN follows ON accounts.id = follows.account_id WHERE follows.target_account_id = 108847830090045132 AND accounts.domain IS NULL ORDER BY follows.id DESC) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
-- Rewritten Queries
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL LIMIT 1) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL ORDER BY follows.id DESC LIMIT 1) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL ORDER BY follows.id DESC LIMIT 1) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL LIMIT 1) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts INNER JOIN follows ON accounts.id = follows.account_id WHERE follows.target_account_id = 108847830090045132 AND accounts.domain IS NULL ORDER BY follows.id DESC) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL LIMIT 1) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts INNER JOIN follows ON accounts.id = follows.account_id WHERE follows.target_account_id = 108847830090045132 AND accounts.domain IS NULL ORDER BY follows.id DESC LIMIT 1) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
SELECT follows.id FROM follows WHERE follows.target_account_id = 108847830090045132 AND follows.account_id IN (SELECT accounts.id FROM accounts WHERE accounts.domain IS NULL) AND follows.account_id NOT IN (SELECT accounts.id FROM accounts INNER JOIN follows ON accounts.id = follows.account_id WHERE follows.target_account_id = 108847830090045132 AND accounts.domain IS NULL ORDER BY follows.id DESC LIMIT 1) AND follows.account_id <> 108847831671126818 ORDER BY follows.id ASC LIMIT 7;
