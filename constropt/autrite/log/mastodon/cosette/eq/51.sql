...
-- Original Query
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id IN (106409209687650365, 106409209687650365) AND status_pins.account_id = 108847822639886377;
-- Rewritten Queries
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id IN (106409209687650365, 106409209687650365) AND status_pins.account_id = 108847822639886377 LIMIT 1;
