...
-- Original Query
SELECT mutes.target_account_id FROM mutes WHERE mutes.account_id = 108847822853950449 AND mutes.target_account_id = 108847828785536465;
-- Rewritten Queries
SELECT mutes.target_account_id FROM mutes WHERE mutes.account_id = 108847822853950449 AND mutes.target_account_id = 108847828785536465 LIMIT 1;
