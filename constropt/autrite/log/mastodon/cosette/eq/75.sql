...
-- Original Query
SELECT lists.* FROM lists INNER JOIN list_accounts ON lists.id = list_accounts.list_id WHERE list_accounts.account_id = 108847823225322354 AND lists.account_id = -99;
-- Rewritten Queries
SELECT lists.* FROM lists INNER JOIN list_accounts ON lists.id = list_accounts.list_id WHERE list_accounts.account_id = 108847823225322354 AND lists.account_id = -99 LIMIT 1;
