...
-- Original Query
SELECT favourites.status_id FROM favourites WHERE favourites.status_id IN (105049191744174157, 105049191744174157) AND favourites.account_id = 108847814353055139;
-- Rewritten Queries
SELECT favourites.status_id FROM favourites WHERE favourites.status_id IN (105049191744174157, 105049191744174157) AND favourites.account_id = 108847814353055139 LIMIT 1;
