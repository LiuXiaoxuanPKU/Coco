...
-- Original Query
SELECT COUNT(*) FROM follow_requests WHERE follow_requests.target_account_id = 108847831141077075 AND follow_requests.account_id = 108847832794916564;
-- Rewritten Queries
SELECT COUNT(*) FROM follow_requests WHERE follow_requests.target_account_id = 108847831141077075 AND follow_requests.account_id = 108847832794916564 LIMIT 1;
