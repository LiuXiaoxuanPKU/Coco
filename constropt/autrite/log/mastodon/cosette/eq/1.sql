...
-- Original Query
SELECT blocks.account_id FROM blocks WHERE blocks.target_account_id = 108847820748993043;
-- Rewritten Queries
SELECT blocks.account_id FROM blocks WHERE blocks.target_account_id = 108847820748993043 LIMIT 1;
