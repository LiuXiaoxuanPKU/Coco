...
-- Original Query
SELECT follow_requests.* FROM follow_requests WHERE follow_requests.target_account_id = 108847831141077075 AND follow_requests.account_id IN (108847832794916564, 108847832794916564, 108847832794916564);
-- Rewritten Queries
SELECT follow_requests.* FROM follow_requests WHERE follow_requests.target_account_id = 108847831141077075 AND follow_requests.account_id IN (108847832794916564, 108847832794916564, 108847832794916564) LIMIT 1;
