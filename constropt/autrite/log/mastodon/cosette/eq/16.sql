...
-- Original Query
SELECT user_invite_requests.* FROM user_invite_requests WHERE user_invite_requests.user_id = 3648;
-- Rewritten Queries
SELECT user_invite_requests.* FROM user_invite_requests WHERE user_invite_requests.user_id = 3648 LIMIT 1;
