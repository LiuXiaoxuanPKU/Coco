...
-- Original Query
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id IN (108847823507249359, 108847823507249359) AND account_notes.account_id = 108847814547772509;
-- Rewritten Queries
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id IN (108847823507249359, 108847823507249359) AND account_notes.account_id = 108847814547772509 LIMIT 1;
