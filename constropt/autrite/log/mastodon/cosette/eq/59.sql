...
-- Original Query
SELECT 1 AS "one" FROM follow_requests WHERE follow_requests.account_id = 108847832794916564 AND follow_requests.target_account_id IS NULL LIMIT 4;
-- Rewritten Queries
SELECT 1 AS "one" FROM follow_requests WHERE follow_requests.account_id = 108847832794916564 AND False LIMIT 4;
