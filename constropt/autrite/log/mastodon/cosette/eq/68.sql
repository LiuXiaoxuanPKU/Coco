...
-- Original Query
SELECT account_pins.target_account_id FROM account_pins WHERE account_pins.account_id = 56 AND account_pins.target_account_id IN (108847821772236278, 108847821772236278);
-- Rewritten Queries
SELECT account_pins.target_account_id FROM account_pins WHERE account_pins.account_id = 56 AND account_pins.target_account_id IN (108847821772236278, 108847821772236278) LIMIT 1;
