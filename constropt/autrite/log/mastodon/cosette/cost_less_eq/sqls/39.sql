...
-- Original Query
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847829778510922, 108847822947869843, 108847832214620674) AND blocks.target_account_id = 108847831760034719;
-- Rewritten Queries
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847829778510922, 108847822947869843, 108847832214620674) AND blocks.target_account_id = 108847831760034719 LIMIT 1;
