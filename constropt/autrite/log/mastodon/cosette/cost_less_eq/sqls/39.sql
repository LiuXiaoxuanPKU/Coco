...
-- Original Query
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847832480785677 AND follows.target_account_id = 108847815289176241;
-- Rewritten Queries
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847832480785677 AND follows.target_account_id = 108847815289176241 LIMIT 1;
