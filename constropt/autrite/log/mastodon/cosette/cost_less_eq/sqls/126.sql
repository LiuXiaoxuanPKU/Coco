...
-- Original Query
SELECT mentions.id, mentions.account_id FROM mentions INNER JOIN accounts ON accounts.id = mentions.account_id INNER JOIN users ON users.account_id = accounts.id INNER JOIN follows ON accounts.id = follows.account_id WHERE mentions.status_id = 107221005483314044 AND follows.target_account_id = 108847821832654449 AND accounts.domain IS NULL AND users.current_sign_in_at > '2022-07-30 06:46:00.577856' ORDER BY mentions.id ASC LIMIT 1;
-- Rewritten Queries
SELECT mentions.id, mentions.account_id FROM mentions INNER JOIN accounts ON accounts.id = mentions.account_id INNER JOIN follows ON accounts.id = follows.account_id WHERE mentions.status_id = 107221005483314044 AND follows.target_account_id = 108847821832654449 AND accounts.domain IS NULL ORDER BY mentions.id ASC LIMIT 1;
SELECT mentions.id, mentions.account_id FROM mentions INNER JOIN accounts ON accounts.id = mentions.account_id INNER JOIN users ON users.account_id = accounts.id WHERE mentions.status_id = 107221005483314044 AND accounts.domain IS NULL AND users.current_sign_in_at > '2022-07-30 06:46:00.577856' ORDER BY mentions.id ASC LIMIT 1;
