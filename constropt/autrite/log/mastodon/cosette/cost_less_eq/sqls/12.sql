...
-- Original Query
SELECT follows.* FROM follows WHERE follows.target_account_id = 108847820828851509 AND follows.account_id = 108847826529938109;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.target_account_id = 108847820828851509 AND follows.account_id = 108847826529938109 LIMIT 1;
