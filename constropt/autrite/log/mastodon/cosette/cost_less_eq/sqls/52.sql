...
-- Original Query
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id = 108847819956543818 AND account_notes.account_id = 108847831363770599;
-- Rewritten Queries
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id = 108847819956543818 AND account_notes.account_id = 108847831363770599 LIMIT 1;
