...
-- Original Query
SELECT follows.* FROM follows WHERE follows.target_account_id IN (108847799997276740, 108847832241686251) AND follows.account_id = 108847832249903456;
-- Rewritten Queries
SELECT follows.* FROM follows WHERE follows.target_account_id IN (108847799997276740, 108847832241686251) AND follows.account_id = 108847832249903456 LIMIT 1;
