...
-- Original Query
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847823238900937 AND follows.target_account_id = 108847820282794052;
-- Rewritten Queries
SELECT follows.target_account_id FROM follows WHERE follows.account_id = 108847823238900937 AND follows.target_account_id = 108847820282794052 LIMIT 1;
