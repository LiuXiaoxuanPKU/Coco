...
-- Original Query
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id = 108438117780136556 AND status_pins.account_id = 108847815124425740;
-- Rewritten Queries
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id = 108438117780136556 AND status_pins.account_id = 108847815124425740 LIMIT 1;
