...
-- Original Query
SELECT 1 AS "one" FROM favourites WHERE favourites.status_id IS NULL AND favourites.id <> 6049 AND favourites.account_id = 108847828800917978 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM favourites WHERE False AND favourites.id <> 6049 AND favourites.account_id = 108847828800917978 LIMIT 1;
