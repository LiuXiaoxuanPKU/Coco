...
-- Original Query
SELECT blocks.target_account_id FROM blocks WHERE blocks.account_id = 108847825394752469 AND blocks.target_account_id = 108847832043042701;
-- Rewritten Queries
SELECT blocks.target_account_id FROM blocks WHERE blocks.account_id = 108847825394752469 AND blocks.target_account_id = 108847832043042701 LIMIT 1;
