...
-- Original Query
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id = 108847809412090960 AND blocks.account_id = 108847832508723091;
-- Rewritten Queries
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id = 108847809412090960 AND blocks.account_id = 108847832508723091 LIMIT 1;
