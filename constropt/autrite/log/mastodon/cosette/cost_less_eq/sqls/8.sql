...
-- Original Query
SELECT mutes.* FROM mutes WHERE mutes.target_account_id = 108847832799374002 AND mutes.account_id = 108847819849539584;
-- Rewritten Queries
SELECT mutes.* FROM mutes WHERE mutes.target_account_id = 108847832799374002 AND mutes.account_id = 108847819849539584 LIMIT 1;
