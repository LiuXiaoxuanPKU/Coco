...
-- Original Query
SELECT DISTINCT follows.id AS alias_0, accounts.id FROM accounts LEFT OUTER JOIN follows ON follows.target_account_id = accounts.id LEFT OUTER JOIN account_stats ON account_stats.account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
-- Rewritten Queries
SELECT follows.id AS alias_0, accounts.id FROM accounts LEFT OUTER JOIN follows ON follows.target_account_id = accounts.id LEFT OUTER JOIN account_stats ON account_stats.account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT follows.id AS alias_0, accounts.id FROM accounts LEFT OUTER JOIN follows ON follows.target_account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT follows.id AS alias_0, accounts.id FROM accounts INNER JOIN follows ON follows.target_account_id = accounts.id LEFT OUTER JOIN account_stats ON account_stats.account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT follows.id AS alias_0, accounts.id FROM accounts INNER JOIN follows ON follows.target_account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT DISTINCT follows.id AS alias_0, accounts.id FROM accounts LEFT OUTER JOIN follows ON follows.target_account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT DISTINCT follows.id AS alias_0, accounts.id FROM accounts INNER JOIN follows ON follows.target_account_id = accounts.id LEFT OUTER JOIN account_stats ON account_stats.account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
SELECT DISTINCT follows.id AS alias_0, accounts.id FROM accounts INNER JOIN follows ON follows.target_account_id = accounts.id WHERE accounts.id <> 108847826821086576 AND follows.account_id = 108847832595850352 ORDER BY follows.id DESC LIMIT 3;
