...
-- Original Query
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id IN (108847830373797796, 108847812430989052) AND blocks.account_id = 108847817556828519;
-- Rewritten Queries
SELECT blocks.target_account_id FROM blocks WHERE blocks.target_account_id IN (108847830373797796, 108847812430989052) AND blocks.account_id = 108847817556828519 LIMIT 1;
