...
-- Original Query
SELECT domain_blocks.* FROM domain_blocks WHERE domain_blocks.domain = 'qnurloyoobutougpapibipxmzirzsccqqxmn';
-- Rewritten Queries
SELECT domain_blocks.* FROM domain_blocks WHERE domain_blocks.domain = 'qnurloyoobutougpapibipxmzirzsccqqxmn' LIMIT 1;
