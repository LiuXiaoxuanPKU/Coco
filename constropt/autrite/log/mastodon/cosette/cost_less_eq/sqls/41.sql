...
-- Original Query
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id = 106849366745957474 AND status_pins.account_id = 108847820815114147;
-- Rewritten Queries
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id = 106849366745957474 AND status_pins.account_id = 108847820815114147 LIMIT 1;
