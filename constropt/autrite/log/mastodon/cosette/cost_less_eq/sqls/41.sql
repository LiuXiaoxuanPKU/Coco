...
-- Original Query
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847814098171192, 108847820344430077, 108847828895590430) AND blocks.target_account_id = 108847827566501235;
-- Rewritten Queries
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847814098171192, 108847820344430077, 108847828895590430) AND blocks.target_account_id = 108847827566501235 LIMIT 1;
