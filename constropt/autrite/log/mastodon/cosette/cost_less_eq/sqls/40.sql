...
-- Original Query
SELECT follows.account_id FROM follows WHERE follows.account_id IN (108847798842350711, 108847827893840741) AND follows.target_account_id = 108847824089092341;
-- Rewritten Queries
SELECT follows.account_id FROM follows WHERE follows.account_id IN (108847798842350711, 108847827893840741) AND follows.target_account_id = 108847824089092341 LIMIT 1;
