...
-- Original Query
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847821751485683, 108847815418268075) AND blocks.target_account_id = 108847823440357024;
-- Rewritten Queries
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847821751485683, 108847815418268075) AND blocks.target_account_id = 108847823440357024 LIMIT 1;
