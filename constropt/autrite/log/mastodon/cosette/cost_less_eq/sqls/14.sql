...
-- Original Query
SELECT session_activations.* FROM session_activations WHERE session_activations.session_id = 'krhmqkcdxhqtwhldiwqsbpwhnanenbvufpdsj';
-- Rewritten Queries
SELECT session_activations.* FROM session_activations WHERE session_activations.session_id = 'krhmqkcdxhqtwhldiwqsbpwhnanenbvufpdsj' LIMIT 1;
