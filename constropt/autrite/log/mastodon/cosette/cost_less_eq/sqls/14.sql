...
-- Original Query
SELECT mentions.account_id FROM mentions WHERE mentions.status_id = 108483592489786540 AND mentions.silent = True;
-- Rewritten Queries
SELECT mentions.account_id FROM mentions WHERE mentions.status_id = 108483592489786540 AND mentions.silent = True LIMIT 1;
