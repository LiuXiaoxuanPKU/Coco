...
-- Original Query
SELECT user_invite_requests.* FROM user_invite_requests WHERE user_invite_requests.user_id = 9599;
-- Rewritten Queries
SELECT user_invite_requests.* FROM user_invite_requests WHERE user_invite_requests.user_id = 9599 LIMIT 1;
