...
-- Original Query
SELECT follows.account_id FROM follows WHERE follows.account_id = 108847817560168740 AND follows.target_account_id = 108847831751175311;
-- Rewritten Queries
SELECT follows.account_id FROM follows WHERE follows.account_id = 108847817560168740 AND follows.target_account_id = 108847831751175311 LIMIT 1;
