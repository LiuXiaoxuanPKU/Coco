...
-- Original Query
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847831203729303, 108847825394752469) AND blocks.target_account_id = 108847832043042701;
-- Rewritten Queries
SELECT blocks.account_id FROM blocks WHERE blocks.account_id IN (108847831203729303, 108847825394752469) AND blocks.target_account_id = 108847832043042701 LIMIT 1;
