...
-- Original Query
SELECT favourites.status_id FROM favourites WHERE favourites.status_id = 104061685441728173 AND favourites.account_id = 108847830875344495;
-- Rewritten Queries
SELECT favourites.status_id FROM favourites WHERE favourites.status_id = 104061685441728173 AND favourites.account_id = 108847830875344495 LIMIT 1;
