...
-- Original Query
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id = 108847820404558717 AND account_notes.account_id = 108847814200047900;
-- Rewritten Queries
SELECT account_notes.* FROM account_notes WHERE account_notes.target_account_id = 108847820404558717 AND account_notes.account_id = 108847814200047900 LIMIT 1;
