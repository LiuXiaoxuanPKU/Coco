...
-- Original Query
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id IN (104719231181290916, 105996438525534508) AND status_pins.account_id = 108847831656505882;
-- Rewritten Queries
SELECT status_pins.status_id FROM status_pins WHERE status_pins.status_id IN (104719231181290916, 105996438525534508) AND status_pins.account_id = 108847831656505882 LIMIT 1;
