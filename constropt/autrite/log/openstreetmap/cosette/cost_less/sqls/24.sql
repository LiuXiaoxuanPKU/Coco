...
-- Original Query
SELECT COUNT(*) FROM friends INNER JOIN users ON users.id = friends.friend_user_id WHERE friends.user_id = 9390 AND users.status IN ('pending', 'pending') AND created_at >= '2022-08-29 20:22:41.565818';
-- Rewritten Queries
SELECT COUNT(*) FROM friends WHERE friends.user_id = 9390 AND created_at >= '2022-08-29 20:22:41.565818';
