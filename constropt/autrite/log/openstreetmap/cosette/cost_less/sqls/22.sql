...
-- Original Query
SELECT 1 AS "one" FROM current_way_tags WHERE current_way_tags.k = 'ydjbfyrudertyzbaqetebwcehwnpxuiuidwbtzxvytdvsudujquuvumocvkvriekhdprwatpfcwtlnxnwptdjqxozjlutagrozwtdhliilyalyyebfmjlbokcywbmlaxiuofzkyykegluofeajjiokemocegkoqmosxotcxvdyuocrybdzlqdnhoolzgvthnrvzvofdddsyznmbstq' AND NOT(current_way_tags.way_id = 186 AND current_way_tags.k = 'Key 3') AND current_way_tags.way_id IS NULL LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM current_way_tags WHERE current_way_tags.k = 'ydjbfyrudertyzbaqetebwcehwnpxuiuidwbtzxvytdvsudujquuvumocvkvriekhdprwatpfcwtlnxnwptdjqxozjlutagrozwtdhliilyalyyebfmjlbokcywbmlaxiuofzkyykegluofeajjiokemocegkoqmosxotcxvdyuocrybdzlqdnhoolzgvthnrvzvofdddsyznmbstq' AND NOT(current_way_tags.way_id = 186 AND current_way_tags.k = 'Key 3') AND False LIMIT 6;
