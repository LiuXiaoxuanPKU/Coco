...
-- Original Query
SELECT changesets.* FROM changesets WHERE num_changes > 0 ORDER BY changesets.id DESC LIMIT 3;
-- Rewritten Queries
SELECT changesets.* FROM changesets ORDER BY changesets.id DESC LIMIT 3;
