...
-- Original Query
SELECT diary_comments.* FROM diary_comments INNER JOIN users ON users.id = diary_comments.user_id WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False AND users.status IN ('pending', 'pending') ORDER BY diary_comments.id ASC;
-- Rewritten Queries
SELECT diary_comments.* FROM diary_comments WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False ORDER BY diary_comments.id ASC;
