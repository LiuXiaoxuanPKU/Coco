...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.user_id = 3734 AND (closed_at < '2022-08-29 21:22:12.724623' OR num_changes > 10000) ORDER BY created_at DESC LIMIT 3;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.user_id = 3734 AND closed_at < '2022-08-29 21:22:12.724623' ORDER BY created_at DESC LIMIT 3;
