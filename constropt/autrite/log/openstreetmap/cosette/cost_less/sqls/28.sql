...
-- Original Query
SELECT current_nodes.* FROM current_nodes INNER JOIN current_way_nodes ON current_nodes.id = current_way_nodes.node_id WHERE current_way_nodes.way_id = 8454 ORDER BY current_way_nodes.sequence_id ASC;
-- Rewritten Queries
SELECT current_nodes.* FROM current_nodes INNER JOIN current_way_nodes ON current_nodes.id = current_way_nodes.node_id WHERE current_way_nodes.way_id = 8454 ORDER BY current_way_nodes.sequence_id ASC LIMIT 1;
