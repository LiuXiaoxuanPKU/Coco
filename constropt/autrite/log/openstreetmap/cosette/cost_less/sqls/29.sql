...
-- Original Query
SELECT 1 AS "one" FROM way_tags WHERE way_tags.k = 'hwfnmkoqustfvlaxtgvaisfdukwpnsywymnajtrbjgttltiskmiepclzefurwazusarfrzyjsgqvkqwpawxyajthpadudpmbd' AND NOT(way_tags.way_id = 145 AND way_tags.version = 1 AND way_tags.k = 'Key 2') AND way_tags.way_id IS NULL AND way_tags.version IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM way_tags WHERE way_tags.k = 'hwfnmkoqustfvlaxtgvaisfdukwpnsywymnajtrbjgttltiskmiepclzefurwazusarfrzyjsgqvkqwpawxyajthpadudpmbd' AND NOT(way_tags.way_id = 145 AND way_tags.version = 1 AND way_tags.k = 'Key 2') AND False AND way_tags.version IS NULL LIMIT 1;
SELECT 1 AS "one" FROM way_tags WHERE way_tags.k = 'hwfnmkoqustfvlaxtgvaisfdukwpnsywymnajtrbjgttltiskmiepclzefurwazusarfrzyjsgqvkqwpawxyajthpadudpmbd' AND NOT(way_tags.way_id = 145 AND way_tags.version = 1 AND way_tags.k = 'Key 2') AND way_tags.way_id IS NULL AND False LIMIT 1;
SELECT 1 AS "one" FROM way_tags WHERE way_tags.k = 'hwfnmkoqustfvlaxtgvaisfdukwpnsywymnajtrbjgttltiskmiepclzefurwazusarfrzyjsgqvkqwpawxyajthpadudpmbd' AND NOT(way_tags.way_id = 145 AND way_tags.version = 1 AND way_tags.k = 'Key 2') AND False AND False LIMIT 1;
