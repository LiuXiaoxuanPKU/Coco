...
-- Original Query
SELECT 1 AS "one" FROM current_relation_tags WHERE current_relation_tags.k = 'gcpcivtoajhnupvekpuaftkuhxeanjkzwuigniabmrjvwevsooekhsndxbqqsliblkpcodwpjkzxujoaxmlspfhjnjsougqgoorzstxvltuhghvihspiloalqbqgkslvtvmkejrkflmhhsgkzeffcuxhkpmx' AND NOT(current_relation_tags.relation_id = 110 AND current_relation_tags.k = 'Key 1') AND current_relation_tags.relation_id IS NULL LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM current_relation_tags WHERE current_relation_tags.k = 'gcpcivtoajhnupvekpuaftkuhxeanjkzwuigniabmrjvwevsooekhsndxbqqsliblkpcodwpjkzxujoaxmlspfhjnjsougqgoorzstxvltuhghvihspiloalqbqgkslvtvmkejrkflmhhsgkzeffcuxhkpmx' AND NOT(current_relation_tags.relation_id = 110 AND current_relation_tags.k = 'Key 1') AND False LIMIT 9;
