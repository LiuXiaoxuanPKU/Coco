...
-- Original Query
SELECT COUNT(*) FROM (SELECT DISTINCT gpx_files.id FROM gpx_files INNER JOIN gpx_file_tags ON gpx_file_tags.gpx_id = gpx_files.id LEFT OUTER JOIN users ON users.id = gpx_files.user_id WHERE gpx_files.visibility IN ('public', 'public') AND gpx_file_tags.tag = 'ihursgwahjqjkpjdeprynegarbgmgzsiqfvcpqfyrzjjvsrvaxinejvpymdopkwjxfpaizuhjaauklejkrwcteezhvrludcwofgzgavqlxnnpalilnupblkgvdileritpbzrryfanybduwtkzmdwqqicrhlsezjibqhojwvizrirwzxfjuyqglxzuxypggmhyugxckftjqyqntpwtkjnqdnjlznqbhfntjeodynii' AND gpx_files.visible = True AND gpx_files.id = 2362 subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT  gpx_files.id FROM gpx_files INNER JOIN gpx_file_tags ON gpx_file_tags.gpx_id = gpx_files.id LEFT OUTER JOIN users ON users.id = gpx_files.user_id WHERE gpx_files.visibility IN ('public', 'public') AND gpx_file_tags.tag = 'ihursgwahjqjkpjdeprynegarbgmgzsiqfvcpqfyrzjjvsrvaxinejvpymdopkwjxfpaizuhjaauklejkrwcteezhvrludcwofgzgavqlxnnpalilnupblkgvdileritpbzrryfanybduwtkzmdwqqicrhlsezjibqhojwvizrirwzxfjuyqglxzuxypggmhyugxckftjqyqntpwtkjnqdnjlznqbhfntjeodynii' AND gpx_files.visible = True AND gpx_files.id = 2362 subquery_for_count