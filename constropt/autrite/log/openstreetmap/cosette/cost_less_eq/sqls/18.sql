...
-- Original Query
SELECT changesets.* FROM changesets WHERE num_changes > 0 AND changesets.id <= '744' ORDER BY changesets.id DESC LIMIT 4;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.id <= '744' ORDER BY changesets.id DESC LIMIT 4;
