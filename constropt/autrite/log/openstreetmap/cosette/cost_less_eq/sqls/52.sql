...
-- Original Query
SELECT COUNT(*) FROM current_relations INNER JOIN current_relation_members ON current_relations.id = current_relation_members.relation_id WHERE current_relation_members.member_id = 5183 AND current_relation_members.member_type = 'Way';
-- Rewritten Queries
SELECT COUNT(*) FROM current_relations INNER JOIN current_relation_members ON current_relations.id = current_relation_members.relation_id WHERE current_relation_members.member_id = 5183 AND current_relation_members.member_type = 'Way' LIMIT 1;
