...
-- Original Query
SELECT current_ways.* FROM current_ways WHERE current_ways.id IN (8290, 4119) AND current_ways.visible = True;
-- Rewritten Queries
SELECT current_ways.* FROM current_ways WHERE current_ways.id IN (8290, 4119) AND current_ways.visible = True LIMIT 1;
