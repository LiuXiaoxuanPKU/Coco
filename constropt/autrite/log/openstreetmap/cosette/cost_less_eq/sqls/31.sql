...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.user_id = 2730 AND closed_at >= '2022-08-29 21:22:12.457259' AND num_changes <= 10000 ORDER BY created_at DESC LIMIT 1;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.user_id = 2730 AND closed_at >= '2022-08-29 21:22:12.457259' ORDER BY created_at DESC LIMIT 1;
