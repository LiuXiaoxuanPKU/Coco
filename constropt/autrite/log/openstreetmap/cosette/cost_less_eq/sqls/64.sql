...
-- Original Query
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relation_members.member_type = 'Relation' AND current_relation_members.member_id IN (8584, 7662) AND current_relations.visible = False;
-- Rewritten Queries
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relation_members.member_type = 'Relation' AND current_relation_members.member_id IN (8584, 7662) AND current_relations.visible = False LIMIT 1;
