...
-- Original Query
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relation_members.member_type = 'Way' AND current_relation_members.member_id IN (556, 7528) AND current_relations.visible = True;
-- Rewritten Queries
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relation_members.member_type = 'Way' AND current_relation_members.member_id IN (556, 7528) AND current_relations.visible = True LIMIT 1;
