...
-- Original Query
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM way_tags WHERE way_tags.way_id = 359 AND way_tags.version = 749 ORDER BY way_tags.k ASC) AS subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM way_tags WHERE way_tags.way_id = 359 AND way_tags.version = 749 ORDER BY way_tags.k ASC) AS subquery_for_count LIMIT 1;
