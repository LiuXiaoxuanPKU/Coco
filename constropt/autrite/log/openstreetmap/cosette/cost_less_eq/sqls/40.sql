...
-- Original Query
SELECT COUNT(*) FROM diary_comments INNER JOIN users ON users.id = diary_comments.user_id WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False AND users.status IN ('pending', 'pending');
-- Rewritten Queries
SELECT COUNT(*) FROM diary_comments WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False;
SELECT COUNT(*) FROM diary_comments WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False LIMIT 1;
SELECT COUNT(*) FROM diary_comments INNER JOIN users ON users.id = diary_comments.user_id WHERE diary_comments.diary_entry_id = 4470 AND diary_comments.visible = False AND users.status IN ('pending', 'pending') LIMIT 1;
