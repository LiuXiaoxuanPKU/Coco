...
-- Original Query
SELECT current_ways.* FROM current_ways INNER JOIN current_way_nodes ON current_way_nodes.way_id = current_ways.id WHERE current_ways.visible = True AND current_way_nodes.node_id = 2309 ORDER BY current_ways.id ASC;
-- Rewritten Queries
SELECT current_ways.* FROM current_ways INNER JOIN current_way_nodes ON current_way_nodes.way_id = current_ways.id WHERE current_ways.visible = True AND current_way_nodes.node_id = 2309 ORDER BY current_ways.id ASC LIMIT 1;
