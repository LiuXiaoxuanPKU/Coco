...
-- Original Query
SELECT changesets.* FROM changesets WHERE num_changes > 0 AND changesets.user_id = 5412 ORDER BY changesets.id DESC LIMIT 6;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.user_id = 5412 ORDER BY changesets.id DESC LIMIT 6;
