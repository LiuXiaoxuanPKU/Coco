...
-- Original Query
SELECT 1 AS "one" FROM current_node_tags WHERE current_node_tags.k = 'brqiilmobwibxniltyrfgbocgjhahxcyuwlafafkmmqblaomciboopmzokcozexgznpfdsznsyczdcsreknmnassztmqhvvspbebbgtuuqbhtfazllrzlwjzgjnmmsjshtdyelpbkfjlkdgnoxdbxxkrargpyjjbietwsfenttnmmyidmdmoylwtixxktimhdvumrpdgkgtckymcsqvjmuptdbmhnfgmouphbpxsfczpgo' AND NOT(current_node_tags.node_id = 353 AND current_node_tags.k = 'Key 2') AND current_node_tags.node_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM current_node_tags WHERE current_node_tags.k = 'brqiilmobwibxniltyrfgbocgjhahxcyuwlafafkmmqblaomciboopmzokcozexgznpfdsznsyczdcsreknmnassztmqhvvspbebbgtuuqbhtfazllrzlwjzgjnmmsjshtdyelpbkfjlkdgnoxdbxxkrargpyjjbietwsfenttnmmyidmdmoylwtixxktimhdvumrpdgkgtckymcsqvjmuptdbmhnfgmouphbpxsfczpgo' AND NOT(current_node_tags.node_id = 353 AND current_node_tags.k = 'Key 2') AND False LIMIT 1;
