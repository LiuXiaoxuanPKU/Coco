...
-- Original Query
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_node_tags WHERE current_node_tags.node_id = 4412 ORDER BY current_node_tags.k ASC) AS subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_node_tags WHERE current_node_tags.node_id = 4412 ORDER BY current_node_tags.k ASC) AS subquery_for_count LIMIT 1;
