...
-- Original Query
SELECT note_comments.* FROM note_comments LEFT OUTER JOIN users ON users.id = note_comments.author_id WHERE note_comments.note_id = 4131 ORDER BY note_comments.created_at DESC LIMIT 6;
-- Rewritten Queries
SELECT note_comments.* FROM note_comments WHERE note_comments.note_id = 4131 ORDER BY note_comments.created_at DESC LIMIT 6;
