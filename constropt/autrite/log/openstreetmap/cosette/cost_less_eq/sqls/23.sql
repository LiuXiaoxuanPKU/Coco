...
-- Original Query
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_way_tags WHERE current_way_tags.way_id = 8980 ORDER BY current_way_tags.k ASC) AS subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_way_tags WHERE current_way_tags.way_id = 8980 ORDER BY current_way_tags.k ASC) AS subquery_for_count LIMIT 1;
