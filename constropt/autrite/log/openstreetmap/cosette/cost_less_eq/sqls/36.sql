...
-- Original Query
SELECT 1 AS "one" FROM current_ways INNER JOIN current_way_nodes ON current_way_nodes.way_id = current_ways.id WHERE current_ways.visible = True AND current_way_nodes.node_id = 8583 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM current_ways WHERE current_ways.visible = True LIMIT 1;
