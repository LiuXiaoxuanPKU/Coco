...
-- Original Query
SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.k = 'mhkjwlc' AND NOT(relation_tags.relation_id = 154 AND relation_tags.version = 1 AND relation_tags.k = 'Key 1') AND relation_tags.relation_id IS NULL AND relation_tags.version IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.k = 'mhkjwlc' AND NOT(relation_tags.relation_id = 154 AND relation_tags.version = 1 AND relation_tags.k = 'Key 1') AND False AND relation_tags.version IS NULL LIMIT 1;
SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.k = 'mhkjwlc' AND NOT(relation_tags.relation_id = 154 AND relation_tags.version = 1 AND relation_tags.k = 'Key 1') AND relation_tags.relation_id IS NULL AND False LIMIT 1;
SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.k = 'mhkjwlc' AND NOT(relation_tags.relation_id = 154 AND relation_tags.version = 1 AND relation_tags.k = 'Key 1') AND False AND False LIMIT 1;
