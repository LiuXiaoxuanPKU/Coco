...
-- Original Query
SELECT note_comments.* FROM note_comments LEFT OUTER JOIN users ON users.id = note_comments.author_id WHERE note_comments.visible = True AND (users.status IN ('pending', 'pending') OR users.status IS NULL) AND note_comments.note_id = 585 ORDER BY note_comments.created_at ASC;
-- Rewritten Queries
SELECT note_comments.* FROM note_comments LEFT OUTER JOIN users ON users.id = note_comments.author_id WHERE note_comments.visible = True AND users.status IS NULL AND note_comments.note_id = 585 ORDER BY note_comments.created_at ASC;
SELECT note_comments.* FROM note_comments LEFT OUTER JOIN users ON users.id = note_comments.author_id WHERE note_comments.visible = True AND (users.status IN ('pending', 'pending') OR users.status IS NULL) AND note_comments.note_id = 585 ORDER BY note_comments.created_at ASC LIMIT 1;
SELECT note_comments.* FROM note_comments LEFT OUTER JOIN users ON users.id = note_comments.author_id WHERE note_comments.visible = True AND users.status IS NULL AND note_comments.note_id = 585 ORDER BY note_comments.created_at ASC LIMIT 1;
