...
-- Original Query
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.relation_id = 2728 AND relation_tags.version = 955 ORDER BY relation_tags.k ASC) AS subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM relation_tags WHERE relation_tags.relation_id = 2728 AND relation_tags.version = 955 ORDER BY relation_tags.k ASC) AS subquery_for_count LIMIT 1;
