...
-- Original Query
SELECT relation_tags.* FROM relation_tags WHERE relation_tags.relation_id = 1349 AND relation_tags.version = 582 ORDER BY relation_tags.k ASC;
-- Rewritten Queries
SELECT relation_tags.* FROM relation_tags WHERE relation_tags.relation_id = 1349 AND relation_tags.version = 582 ORDER BY relation_tags.k ASC LIMIT 1;
