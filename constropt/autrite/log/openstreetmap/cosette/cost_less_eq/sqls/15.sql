...
-- Original Query
SELECT changesets.* FROM changesets WHERE num_changes > 0 AND False ORDER BY changesets.id DESC LIMIT 2;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE False ORDER BY changesets.id DESC LIMIT 2;
