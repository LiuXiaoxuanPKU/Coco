...
-- Original Query
SELECT changesets.* FROM changesets WHERE changesets.user_id = 5163 AND (closed_at < '2022-08-29 21:22:12.741412' OR num_changes > 10000) ORDER BY created_at DESC LIMIT 8;
-- Rewritten Queries
SELECT changesets.* FROM changesets WHERE changesets.user_id = 5163 AND closed_at < '2022-08-29 21:22:12.741412' ORDER BY created_at DESC LIMIT 8;
