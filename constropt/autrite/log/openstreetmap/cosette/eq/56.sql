...
-- Original Query
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relations.visible = False AND current_relation_members.member_type = 'Node' AND current_relation_members.member_id = 821 ORDER BY current_relations.id ASC;
-- Rewritten Queries
SELECT current_relations.* FROM current_relations INNER JOIN current_relation_members ON current_relation_members.relation_id = current_relations.id WHERE current_relations.visible = False AND current_relation_members.member_type = 'Node' AND current_relation_members.member_id = 821 ORDER BY current_relations.id ASC LIMIT 1;
