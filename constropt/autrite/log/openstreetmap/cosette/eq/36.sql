...
-- Original Query
SELECT 1 AS "one" FROM changeset_tags WHERE changeset_tags.k = 'sjcjcylwovxsozebkgtoamiwcydyvzkdvuxkljgayeayfbdbjinnvbyiwztzyeuoqtyq' AND NOT(changeset_tags.changeset_id = 734 AND changeset_tags.k = 'Key 2') AND changeset_tags.changeset_id IS NULL LIMIT 6;
-- Rewritten Queries
SELECT 1 AS "one" FROM changeset_tags WHERE changeset_tags.k = 'sjcjcylwovxsozebkgtoamiwcydyvzkdvuxkljgayeayfbdbjinnvbyiwztzyeuoqtyq' AND NOT(changeset_tags.changeset_id = 734 AND changeset_tags.k = 'Key 2') AND False LIMIT 6;
