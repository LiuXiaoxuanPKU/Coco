...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-invisible-project%' AND wiki_id = 52;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-invisible-project%' AND wiki_id = 52 LIMIT 1;
