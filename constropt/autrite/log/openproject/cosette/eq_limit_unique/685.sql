...
-- Original Query
SELECT wiki_pages.*, wiki_contents.updated_at FROM wiki_pages LEFT JOIN wiki_contents ON wiki_contents.page_id = wiki_pages.id WHERE wiki_pages.wiki_id = 3891 ORDER BY title;
-- Rewritten Queries
SELECT wiki_pages.*, wiki_contents.updated_at FROM wiki_pages LEFT JOIN wiki_contents ON wiki_contents.page_id = wiki_pages.id WHERE wiki_pages.wiki_id = 3891 ORDER BY title LIMIT 1;
