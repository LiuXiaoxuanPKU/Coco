...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND wiki_id = 477;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND wiki_id = 477 LIMIT 1;
