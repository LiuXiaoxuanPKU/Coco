...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'how-to-solve-an-issue%' AND wiki_id = 347;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'how-to-solve-an-issue%' AND wiki_id = 347 LIMIT 1;
