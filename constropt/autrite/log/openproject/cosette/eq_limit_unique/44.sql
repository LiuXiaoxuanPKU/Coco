...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'alert-foo%' AND wiki_id = 487;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'alert-foo%' AND wiki_id = 487 LIMIT 1;
