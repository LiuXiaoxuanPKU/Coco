...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'start-page%' AND id <> 167 AND wiki_id = 508;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'start-page%' AND id <> 167 AND wiki_id = 508 LIMIT 1;
