...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'another-page%' AND id <> 145 AND wiki_id = 497;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'another-page%' AND id <> 145 AND wiki_id = 497 LIMIT 1;
