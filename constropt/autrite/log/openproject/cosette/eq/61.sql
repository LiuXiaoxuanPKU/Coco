...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'ubersicht%' AND wiki_id = 1136;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'ubersicht%' AND wiki_id = 1136 LIMIT 1;
