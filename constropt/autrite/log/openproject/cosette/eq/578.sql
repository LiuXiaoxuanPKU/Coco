...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-3%' AND id <> 5 AND wiki_id = 83;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'wiki-page-no-3%' AND id <> 5 AND wiki_id = 83 LIMIT 1;
