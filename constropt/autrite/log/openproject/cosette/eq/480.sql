...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'attached%' AND id <> 4 AND wiki_id = 314;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'attached%' AND id <> 4 AND wiki_id = 314 LIMIT 1;
