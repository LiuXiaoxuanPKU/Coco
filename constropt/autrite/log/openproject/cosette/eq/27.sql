...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'foobar%' AND wiki_id = 88;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'foobar%' AND wiki_id = 88 LIMIT 1;
