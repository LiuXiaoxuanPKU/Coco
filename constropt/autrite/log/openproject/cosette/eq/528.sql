...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'etika-mieniedzhmienta%' AND wiki_id = 1137;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'etika-mieniedzhmienta%' AND wiki_id = 1137 LIMIT 1;
