...
-- Original Query
SELECT COUNT(*) FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type = 'Group' AND group_users.group_id = 20176;
-- Rewritten Queries
SELECT COUNT(*) FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type = 'Group' AND group_users.group_id = 20176 LIMIT 1;
