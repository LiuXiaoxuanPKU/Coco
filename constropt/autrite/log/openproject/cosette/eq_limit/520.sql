...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND wiki_id = 509;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'cookbook-documentation%' AND wiki_id = 509 LIMIT 1;
