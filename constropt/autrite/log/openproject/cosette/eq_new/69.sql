...
-- Original Query
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL;
-- Rewritten Queries
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages WHERE False AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages WHERE False AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages WHERE False AND 1 = 0) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT DISTINCT work_packages.id FROM work_packages WHERE False AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL LIMIT 1;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0) OR work_packages.id IS NULL;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages WHERE False AND 1 = 0) OR work_packages.id IS NULL;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE relations.from_id IS NULL AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id WHERE False AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL;
SELECT work_packages.id FROM work_packages WHERE work_packages.id IN (SELECT work_packages.id FROM work_packages WHERE False AND 1 = 0 LIMIT 1) OR work_packages.id IS NULL;
