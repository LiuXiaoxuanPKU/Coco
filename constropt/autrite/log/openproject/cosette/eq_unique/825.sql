...
-- Original Query
SELECT 1 AS "one" FROM versions LEFT OUTER JOIN projects ON projects.id = versions.project_id WHERE projects.id = 3770 OR projects.active = True AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 1 AND projects.lft < 14 ORDER BY projects.name ASC) AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft <= 12 AND projects.rgt >= 13 AND projects.id <> 587 ORDER BY projects.name ASC) AND versions.sharing IN ('none', 'none') OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 12 AND projects.lft < 13 ORDER BY projects.name ASC) AND versions.sharing = 'none' LIMIT 9;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions LEFT OUTER JOIN projects ON projects.id = versions.project_id WHERE projects.id = 3770 OR projects.active = True AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 1 AND projects.lft < 14 ORDER BY projects.name ASC LIMIT 1) AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft <= 12 AND projects.rgt >= 13 AND projects.id <> 587 ORDER BY projects.name ASC LIMIT 1) AND versions.sharing IN ('none', 'none') OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 12 AND projects.lft < 13 ORDER BY projects.name ASC) AND versions.sharing = 'none' LIMIT 9;
SELECT 1 AS "one" FROM versions LEFT OUTER JOIN projects ON projects.id = versions.project_id WHERE projects.id = 3770 OR projects.active = True AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 1 AND projects.lft < 14 ORDER BY projects.name ASC LIMIT 1) AND versions.sharing = 'none' OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft <= 12 AND projects.rgt >= 13 AND projects.id <> 587 ORDER BY projects.name ASC LIMIT 1) AND versions.sharing IN ('none', 'none') OR projects.active = True AND projects.id IN (SELECT projects.id FROM projects WHERE projects.lft >= 12 AND projects.lft < 13 ORDER BY projects.name ASC LIMIT 1) AND versions.sharing = 'none' LIMIT 9;
