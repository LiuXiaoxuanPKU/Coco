...
-- Original Query
SELECT 1 AS "one" FROM spree_payments WHERE spree_payments.order_id = 2806 AND source_type = 'Spree::Payment' AND amount < 0 AND state = 'completed' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_payments WHERE spree_payments.order_id = 2806 AND source_type = 'Spree::Payment' AND state = 'completed' LIMIT 1;
