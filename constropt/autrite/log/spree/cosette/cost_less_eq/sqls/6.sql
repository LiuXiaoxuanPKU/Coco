...
-- Original Query
SELECT 1 AS "one" FROM spree_menus WHERE spree_menus.location IS NULL AND spree_menus.store_id = 11894 AND spree_menus.locale IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_menus WHERE False AND spree_menus.store_id = 11894 AND spree_menus.locale IS NULL LIMIT 1;
SELECT 1 AS "one" FROM spree_menus WHERE spree_menus.location IS NULL AND spree_menus.store_id = 11894 AND False LIMIT 1;
SELECT 1 AS "one" FROM spree_menus WHERE False AND spree_menus.store_id = 11894 AND False LIMIT 1;
