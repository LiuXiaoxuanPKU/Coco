...
-- Original Query
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL LIMIT 10 OFFSET 1;
-- Rewritten Queries
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND True AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND True LIMIT 10 OFFSET 1;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' LIMIT 10 OFFSET 1;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND spree_prices.currency = 'usd' AND True AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND spree_prices.currency = 'usd' AND True LIMIT 10 OFFSET 1;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND spree_prices.currency = 'usd' AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND spree_prices.currency = 'usd' LIMIT 10 OFFSET 1;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND spree_prices.currency = 'usd' LIMIT 10 OFFSET 1;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 5785 AND spree_prices.currency = 'usd' AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:42:09.208452') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:42:09.208587') AND spree_products.available_on <= '2022-08-14 05:42:09.208580' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL LIMIT 10 OFFSET 1;
