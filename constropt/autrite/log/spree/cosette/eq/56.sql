...
-- Original Query
SELECT spree_assets.alt FROM spree_assets LEFT OUTER JOIN active_storage_attachments ON active_storage_attachments.record_type = 'Spree::Asset' AND active_storage_attachments.name = 'attachment' AND active_storage_attachments.record_id = spree_assets.id LEFT OUTER JOIN active_storage_blobs ON active_storage_blobs.id = active_storage_attachments.blob_id WHERE spree_assets.viewable_id = 4299 AND spree_assets.viewable_type = 'Spree::MenuItem' ORDER BY spree_assets.position ASC;
-- Rewritten Queries
SELECT spree_assets.alt FROM spree_assets LEFT OUTER JOIN active_storage_attachments ON active_storage_attachments.record_type = 'Spree::Asset' AND active_storage_attachments.name = 'attachment' AND active_storage_attachments.record_id = spree_assets.id LEFT OUTER JOIN active_storage_blobs ON active_storage_blobs.id = active_storage_attachments.blob_id WHERE spree_assets.viewable_id = 4299 AND spree_assets.viewable_type = 'Spree::MenuItem' ORDER BY spree_assets.position ASC LIMIT 1;
