...
-- Original Query
SELECT 1 AS "one" FROM spree_property_prototypes WHERE spree_property_prototypes.prototype_id IS NULL AND spree_property_prototypes.property_id = 7562 LIMIT 3;
-- Rewritten Queries
SELECT 1 AS "one" FROM spree_property_prototypes WHERE False AND spree_property_prototypes.property_id = 7562 LIMIT 3;
