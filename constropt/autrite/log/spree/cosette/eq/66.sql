{
    ...
    "rewrites": [
        ...
        {
            "sql": "SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:29:08.744409') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:29:08.744565') AND spree_products.available_on <= '2022-08-14 05:29:08.744558' AND spree_prices.currency = \"$3\" AND True",
            "cost": 17.37,
            "rewrite_types": [
                "RewriteNullPredicate",
                "RemoveJoin",
        ...
        {
            "sql": "SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:29:08.744409') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:29:08.744565') AND spree_products.available_on <= '2022-08-14 05:29:08.744558' AND spree_prices.currency = \"$3\" AND spree_prices.amount IS NOT NULL LIMIT 1",
            "cost": 17.37,
            "rewrite_types": [
                "RemoveJoin",
                "RemoveDistinct",
        ...
        {
            "sql": "SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:29:08.744409') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:29:08.744565') AND spree_products.available_on <= '2022-08-14 05:29:08.744558' AND spree_prices.currency = \"$3\" AND True LIMIT 1",
            "cost": 17.37,
            "rewrite_types": [
                "RewriteNullPredicate",
                "RemoveJoin",
        ...
        {
            "sql": "SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND (spree_products.deleted_at IS NULL OR spree_products.deleted_at >= '2022-08-14 05:29:08.744409') AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:29:08.744565') AND spree_products.available_on <= '2022-08-14 05:29:08.744558' AND spree_prices.currency = \"$3\" LIMIT 1",
            "cost": 17.37,
            "rewrite_types": [
                "RemovePredicate",
                "RemoveJoin",
