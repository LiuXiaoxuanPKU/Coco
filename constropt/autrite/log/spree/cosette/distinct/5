...
-- Original Query
SELECT COUNT(DISTINCT spree_option_values.option_type_id) FROM spree_option_values WHERE spree_option_values.id = 4493;
-- Rewritten Queries
SELECT COUNT( spree_option_values.option_type_id) FROM spree_option_values WHERE spree_option_values.id = 4493