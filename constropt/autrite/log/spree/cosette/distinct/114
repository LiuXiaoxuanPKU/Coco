...
-- Original Query
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_prices.amount BETWEEN $1 AND $2 AND (spree_products.deleted_at IS NULL or spree_products.deleted_at >= '2022-08-14 05:28:47.256719') AND (spree_products.discontinue_on IS NULL or spree_products.discontinue_on >= '2022-08-14 05:28:47.256848') AND (spree_products.available_on <= '2022-08-14 05:28:47.256843') AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL
;
-- Rewritten Queries
