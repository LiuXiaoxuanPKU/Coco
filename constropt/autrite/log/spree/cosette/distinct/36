...
-- Original Query
SELECT COUNT(DISTINCT spree_option_values.option_type_id) FROM spree_option_values WHERE spree_option_values.id IN (7878, 3936);
-- Rewritten Queries
SELECT COUNT( spree_option_values.option_type_id) FROM spree_option_values WHERE spree_option_values.id IN (7878, 3936)