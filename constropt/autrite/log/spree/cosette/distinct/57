...
-- Original Query
SELECT COUNT(count_column) FROM (SELECT DISTINCT spree_products.id AS count_column FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 12860 AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.deleted_at IS NULL or spree_products.deleted_at >= '2022-08-14 05:42:08.234575') AND (spree_products.discontinue_on IS NULL or spree_products.discontinue_on >= '2022-08-14 05:42:08.234692') AND (spree_products.available_on <= '2022-08-14 05:42:08.234686') AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL LIMIT 4 OFFSET 1 subquery_for_count
;
-- Rewritten Queries
SELECT COUNT(count_column) FROM (SELECT  spree_products.id AS count_column FROM spree_products INNER JOIN spree_products_stores ON spree_products.id = spree_products_stores.product_id INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 12860 AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.deleted_at IS NULL or spree_products.deleted_at >= '2022-08-14 05:42:08.234575') AND (spree_products.discontinue_on IS NULL or spree_products.discontinue_on >= '2022-08-14 05:42:08.234692') AND (spree_products.available_on <= '2022-08-14 05:42:08.234686') AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL LIMIT 4 OFFSET 1 subquery_for_count
