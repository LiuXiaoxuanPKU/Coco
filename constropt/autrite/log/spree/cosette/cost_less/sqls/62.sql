...
-- Original Query
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL;
-- Rewritten Queries
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE True AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND True;
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036';
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE True AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND True;
SELECT DISTINCT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id WHERE (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036';
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL;
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND True AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd' AND True;
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd';
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd';
SELECT spree_products.* FROM spree_products INNER JOIN spree_variants ON spree_variants.deleted_at IS NULL AND spree_variants.product_id = spree_products.id INNER JOIN spree_prices ON spree_prices.deleted_at IS NULL AND spree_prices.variant_id = spree_variants.id WHERE spree_prices.currency = 'usd' AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND spree_prices.currency = 'usd' AND spree_prices.amount IS NOT NULL;
