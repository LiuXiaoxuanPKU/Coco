...
-- Rewritten Queries
SELECT DISTINCT spree_products.id FROM spree_products WHERE spree_products.deleted_at IS NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:56.708543') AND spree_products.available_on <= '2022-08-14 05:28:56.708534' AND True;
SELECT DISTINCT spree_products.id FROM spree_products WHERE spree_products.deleted_at IS NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:56.708543') AND spree_products.available_on <= '2022-08-14 05:28:56.708534';
