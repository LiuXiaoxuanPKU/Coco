...
-- Rewritten Queries
SELECT DISTINCT spree_products.* FROM spree_products WHERE True AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036' AND True;
SELECT DISTINCT spree_products.* FROM spree_products WHERE (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:28:59.238048') AND spree_products.available_on <= '2022-08-14 05:28:59.238036';
