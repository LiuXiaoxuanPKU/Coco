...
-- Rewritten Queries
SELECT DISTINCT spree_products.* FROM spree_products WHERE spree_products.deleted_at IS NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:37:36.181805') AND spree_products.available_on <= '2022-08-14 05:37:36.181795' AND True;
SELECT DISTINCT spree_products.* FROM spree_products WHERE spree_products.deleted_at IS NULL AND (spree_products.discontinue_on IS NULL OR spree_products.discontinue_on >= '2022-08-14 05:37:36.181805') AND spree_products.available_on <= '2022-08-14 05:37:36.181795';
