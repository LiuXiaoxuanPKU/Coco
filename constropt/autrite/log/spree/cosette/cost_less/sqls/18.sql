...
-- Original Query
SELECT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products_stores.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 7558;
-- Rewritten Queries
SELECT spree_products.* FROM spree_products INNER JOIN spree_products_stores ON spree_products_stores.product_id = spree_products.id WHERE spree_products.deleted_at IS NULL AND spree_products_stores.store_id = 7558 LIMIT 1;
