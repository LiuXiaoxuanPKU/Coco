...
-- Original Query
SELECT podcast_episodes.media_url FROM podcast_episodes WHERE podcast_episodes.podcast_id = 7922;
-- Rewritten Queries
SELECT podcast_episodes.media_url FROM podcast_episodes WHERE podcast_episodes.podcast_id = 7922 LIMIT 1;
