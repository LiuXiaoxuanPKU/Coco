...
-- Original Query
SELECT 1 AS "one" FROM notifications WHERE notifications.user_id IS NULL AND notifications.organization_id = 2 AND notifications.notifiable_id = 4737 AND notifications.notifiable_type = 'Article' AND notifications.action = 'xsagskmrnsmlhqmqpyqdtrjned' LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM notifications WHERE False AND notifications.organization_id = 2 AND notifications.notifiable_id = 4737 AND notifications.notifiable_type = 'Article' AND notifications.action = 'xsagskmrnsmlhqmqpyqdtrjned' LIMIT 1;
