...
-- Original Query
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'bvqrwjvzzszcrcumzsrfvtudlxiepodmscflsiujwwjpmimpdomlaqdsmzvytyhleuqlaqyyhlbbxjqprzljxpfseknlayspofinqftgbhhfsicfzayxgyljtesxcjxezyourxaxgmyw';
-- Rewritten Queries
SELECT consumer_apps.platform FROM consumer_apps WHERE consumer_apps.app_bundle = 'bvqrwjvzzszcrcumzsrfvtudlxiepodmscflsiujwwjpmimpdomlaqdsmzvytyhleuqlaqyyhlbbxjqprzljxpfseknlayspofinqftgbhhfsicfzayxgyljtesxcjxezyourxaxgmyw' LIMIT 1;
