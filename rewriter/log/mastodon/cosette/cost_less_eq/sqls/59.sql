...
-- Original Query
SELECT COUNT(*) FROM accounts INNER JOIN list_accounts ON accounts.id = list_accounts.account_id WHERE list_accounts.list_id = 6051;
-- Rewritten Queries
SELECT COUNT(*) FROM accounts INNER JOIN list_accounts ON accounts.id = list_accounts.account_id WHERE list_accounts.list_id = 6051 LIMIT 1;
