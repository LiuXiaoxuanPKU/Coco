...
-- Original Query
SELECT mutes.target_account_id FROM mutes WHERE mutes.account_id = 108847825045991835;
-- Rewritten Queries
SELECT mutes.target_account_id FROM mutes WHERE mutes.account_id = 108847825045991835 LIMIT 1;
