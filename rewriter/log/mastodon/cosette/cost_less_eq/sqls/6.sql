...
-- Original Query
SELECT favourites.account_id FROM favourites WHERE favourites.status_id = 107090825948473298;
-- Rewritten Queries
SELECT favourites.account_id FROM favourites WHERE favourites.status_id = 107090825948473298 LIMIT 1;
