...
-- Original Query
SELECT favourites.status_id FROM favourites WHERE favourites.status_id = 107494070078414609 AND favourites.account_id = 108847831013654594;
-- Rewritten Queries
SELECT favourites.status_id FROM favourites WHERE favourites.status_id = 107494070078414609 AND favourites.account_id = 108847831013654594 LIMIT 1;
