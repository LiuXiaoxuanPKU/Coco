...
-- Original Query
SELECT mutes.* FROM mutes WHERE mutes.target_account_id IN (108847821949588335, 108847832618472754) AND mutes.account_id = 108847832876415886;
-- Rewritten Queries
SELECT mutes.* FROM mutes WHERE mutes.target_account_id IN (108847821949588335, 108847832618472754) AND mutes.account_id = 108847832876415886 LIMIT 1;
