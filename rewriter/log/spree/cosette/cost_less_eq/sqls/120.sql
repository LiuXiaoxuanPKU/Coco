...
-- Original Query
SELECT 1 AS "one" FROM spree_promotions INNER JOIN spree_promotion_rules ON spree_promotions.id = spree_promotion_rules.promotion_id INNER JOIN spree_product_promotion_rules ON spree_promotion_rules.id = spree_product_promotion_rules.promotion_rule_id WHERE spree_product_promotion_rules.product_id = 4784 AND spree_promotions.advertise = False AND (spree_promotions.starts_at IS NULL OR spree_promotions.starts_at < '2022-08-14 05:38:26.589079') AND (spree_promotions.expires_at IS NULL OR spree_promotions.expires_at > '2022-08-14 05:38:26.589163') AND spree_promotions.id = 7307 LIMIT 1;
-- Rewritten Queries
