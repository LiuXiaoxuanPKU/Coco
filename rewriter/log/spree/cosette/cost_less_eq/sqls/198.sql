...
SELECT spree_variants.* FROM spree_variants INNER JOIN spree_option_value_variants ON spree_option_value_variants.variant_id = spree_variants.id INNER JOIN spree_option_values ON spree_option_values.id = spree_option_value_variants.option_value_id WHERE spree_variants.deleted_at IS NULL AND spree_variants.id IN (SELECT spree_variants.id FROM spree_variants WHERE spree_variants.deleted_at IS NULL AND spree_variants.product_id = 6401 AND spree_variants.is_master = True AND (spree_variants.discontinue_on IS NULL OR spree_variants.discontinue_on >= '2022-08-14 05:38:54.371957') AND spree_variants.deleted_at IS NULL AND True) ORDER BY spree_option_values.position ASC LIMIT 1;
...
SELECT spree_variants.* FROM spree_variants INNER JOIN spree_option_value_variants ON spree_option_value_variants.variant_id = spree_variants.id INNER JOIN spree_option_values ON spree_option_values.id = spree_option_value_variants.option_value_id WHERE spree_variants.deleted_at IS NULL AND spree_variants.id IN (SELECT DISTINCT spree_variants.id FROM spree_variants WHERE spree_variants.deleted_at IS NULL AND spree_variants.product_id = 6401 AND spree_variants.is_master = True AND (spree_variants.discontinue_on IS NULL OR spree_variants.discontinue_on >= '2022-08-14 05:38:54.371957') AND spree_variants.deleted_at IS NULL AND True) ORDER BY spree_option_values.position ASC LIMIT 1;
SELECT spree_variants.* FROM spree_variants INNER JOIN spree_option_value_variants ON spree_option_value_variants.variant_id = spree_variants.id INNER JOIN spree_option_values ON spree_option_values.id = spree_option_value_variants.option_value_id WHERE spree_variants.deleted_at IS NULL AND spree_variants.id IN (SELECT DISTINCT spree_variants.id FROM spree_variants WHERE spree_variants.deleted_at IS NULL AND spree_variants.product_id = 6401 AND spree_variants.is_master = True AND (spree_variants.discontinue_on IS NULL OR spree_variants.discontinue_on >= '2022-08-14 05:38:54.371957') AND spree_variants.deleted_at IS NULL AND True LIMIT 1) ORDER BY spree_option_values.position ASC LIMIT 1;
SELECT spree_variants.* FROM spree_variants INNER JOIN spree_option_value_variants ON spree_option_value_variants.variant_id = spree_variants.id INNER JOIN spree_option_values ON spree_option_values.id = spree_option_value_variants.option_value_id WHERE spree_variants.deleted_at IS NULL AND spree_variants.id IN (SELECT DISTINCT spree_variants.id FROM spree_variants WHERE spree_variants.deleted_at IS NULL AND spree_variants.product_id = 6401 AND spree_variants.is_master = True AND (spree_variants.discontinue_on IS NULL OR spree_variants.discontinue_on >= '2022-08-14 05:38:54.371957') AND spree_variants.deleted_at IS NULL) ORDER BY spree_option_values.position ASC LIMIT 1;
SELECT spree_variants.* FROM spree_variants INNER JOIN spree_option_value_variants ON spree_option_value_variants.variant_id = spree_variants.id INNER JOIN spree_option_values ON spree_option_values.id = spree_option_value_variants.option_value_id WHERE spree_variants.deleted_at IS NULL AND spree_variants.id IN (SELECT DISTINCT spree_variants.id FROM spree_variants WHERE spree_variants.deleted_at IS NULL AND spree_variants.product_id = 6401 AND spree_variants.is_master = True AND (spree_variants.discontinue_on IS NULL OR spree_variants.discontinue_on >= '2022-08-14 05:38:54.371957') AND spree_variants.deleted_at IS NULL LIMIT 1) ORDER BY spree_option_values.position ASC LIMIT 1;
