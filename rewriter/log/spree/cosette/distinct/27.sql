...
-- Original Query
SELECT DISTINCT spree_promotions.* FROM spree_promotions INNER JOIN spree_order_promotions
;
-- Rewritten Queries
SELECT  spree_promotions.* FROM spree_promotions INNER JOIN spree_order_promotions
