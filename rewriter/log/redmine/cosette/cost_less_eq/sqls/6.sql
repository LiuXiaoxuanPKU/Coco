...
-- Original Query
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 1018;
-- Rewritten Queries
SELECT user_preferences.* FROM user_preferences WHERE user_preferences.user_id = 1018 LIMIT 1;
