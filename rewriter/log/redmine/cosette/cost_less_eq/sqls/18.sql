...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8039 AND issue_relations.issue_to_id = 1821;
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 8039 AND issue_relations.issue_to_id = 1821 LIMIT 1;
