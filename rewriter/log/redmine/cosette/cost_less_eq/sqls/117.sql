...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8815, 4744, 895, 2270, 7880, 9699) AND issue_relations.issue_to_id IN (3317, 8236, 9665, 5477, 2495, 7287) AND issue_relations.relation_type IN ('precedes', 'copied_to');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (8815, 4744, 895, 2270, 7880, 9699) AND issue_relations.issue_to_id IN (3317, 8236, 9665, 5477, 2495, 7287) AND issue_relations.relation_type IN ('precedes', 'copied_to') LIMIT 1;
