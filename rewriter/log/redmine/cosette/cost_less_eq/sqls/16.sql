...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id = 4240;
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.is_default = False AND email_addresses.user_id = 4240 LIMIT 1;
