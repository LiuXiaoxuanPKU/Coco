...
-- Original Query
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'invalid@somenet.foo';
-- Rewritten Queries
SELECT email_addresses.* FROM email_addresses WHERE email_addresses.address = 'invalid@somenet.foo' LIMIT 1;
