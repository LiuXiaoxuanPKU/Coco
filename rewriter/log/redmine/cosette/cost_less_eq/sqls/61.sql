...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 2906 AND issue_relations.issue_to_id = 2281 AND issue_relations.relation_type IN ('precedes', 'duplicates');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id = 2906 AND issue_relations.issue_to_id = 2281 AND issue_relations.relation_type IN ('precedes', 'duplicates') LIMIT 1;
