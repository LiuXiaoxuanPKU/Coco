...
-- Original Query
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (5966, 8131, 8577, 3914, 2640, 1729, 543, 9733) AND issue_relations.issue_to_id IN (6872, 9287, 6476, 8463, 8962, 1950, 1997, 9494) AND issue_relations.relation_type IN ('copied_to', 'copied_to');
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations WHERE issue_relations.issue_from_id IN (5966, 8131, 8577, 3914, 2640, 1729, 543, 9733) AND issue_relations.issue_to_id IN (6872, 9287, 6476, 8463, 8962, 1950, 1997, 9494) AND issue_relations.relation_type IN ('copied_to', 'copied_to') LIMIT 1;
