...
-- Original Query
SELECT DISTINCT attachments.filename AS alias_0, projects.id FROM projects LEFT OUTER JOIN attachments ON attachments.container_id = projects.id AND attachments.container_type = 'vjgyvgrxxutfbjq' WHERE projects.id = 8425 ORDER BY attachments.filename ASC LIMIT 10;
-- Rewritten Queries
SELECT attachments.filename AS alias_0, projects.id FROM projects LEFT OUTER JOIN attachments ON attachments.container_id = projects.id AND attachments.container_type = 'vjgyvgrxxutfbjq' WHERE projects.id = 8425 ORDER BY attachments.filename ASC LIMIT 10;
