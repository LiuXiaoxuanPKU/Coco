...
-- Original Query
SELECT members.* FROM members INNER JOIN users ON users.id = members.user_id WHERE members.project_id = 2840 AND users.type IN ('User', 'User');
-- Rewritten Queries
SELECT members.* FROM members WHERE members.project_id = 2840;
SELECT members.* FROM members WHERE members.project_id = 2840 LIMIT 1;
