...
-- Original Query
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 12014 AND workflows.old_status_id IS NULL AND workflows.role_id = 1421;
-- Rewritten Queries
SELECT workflows.* FROM workflows WHERE workflows.type IN ('WorkflowPermission') AND workflows.tracker_id = 12014 AND False AND workflows.role_id = 1421;
