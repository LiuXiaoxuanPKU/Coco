...
-- Original Query
SELECT trackers.* FROM trackers INNER JOIN projects_trackers ON trackers.id = projects_trackers.tracker_id WHERE projects_trackers.project_id = 1966 AND trackers.id = 8895 ORDER BY trackers.position ASC;
-- Rewritten Queries
SELECT trackers.* FROM trackers WHERE trackers.id = 8895 ORDER BY trackers.position ASC;
