...
-- Original Query
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_from_id IN (2432, 360, 6038, 1973, 945, 371);
-- Rewritten Queries
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_from_id IN (2432, 360, 6038, 1973, 945, 371) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_from_id IN (6038, 1973, 945, 371, 5764, 1329);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_from_id IN (6038, 1973, 945, 371, 5764, 1329);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_from_id IN (945, 371, 5764, 1329, 9512, 9241);
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13)) AND issues.is_private = False AND issue_relations.issue_from_id IN (6038, 1973, 945, 371, 5764, 1329) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking') IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_from_id IN (6038, 1973, 945, 371, 5764, 1329) LIMIT 1;
SELECT issue_relations.* FROM issue_relations INNER JOIN issues ON issues.id = issue_relations.issue_to_id INNER JOIN projects ON projects.id = issues.project_id WHERE projects.status <> 9 AND (SELECT 1 AS "one" FROM enabled_modules AS em WHERE em.project_id = projects.id AND em.name = 'issue_tracking' LIMIT 1) IS NOT NULL AND projects.is_public = True AND projects.id NOT IN (SELECT project_id FROM members WHERE user_id IN (6, 13) LIMIT 1) AND issues.is_private = False AND issue_relations.issue_from_id IN (945, 371, 5764, 1329, 9512, 9241) LIMIT 1;
