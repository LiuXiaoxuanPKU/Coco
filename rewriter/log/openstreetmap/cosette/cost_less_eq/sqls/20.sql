...
-- Original Query
SELECT current_relation_tags.* FROM current_relation_tags WHERE current_relation_tags.relation_id = 7407 ORDER BY current_relation_tags.k ASC;
-- Rewritten Queries
SELECT current_relation_tags.* FROM current_relation_tags WHERE current_relation_tags.relation_id = 7407 ORDER BY current_relation_tags.k ASC LIMIT 1;
