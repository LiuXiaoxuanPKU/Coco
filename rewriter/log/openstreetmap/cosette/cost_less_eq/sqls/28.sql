...
-- Original Query
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_relation_tags WHERE current_relation_tags.relation_id = 2452 ORDER BY current_relation_tags.k ASC) AS subquery_for_count;
-- Rewritten Queries
SELECT COUNT(*) FROM (SELECT 1 AS "one" FROM current_relation_tags WHERE current_relation_tags.relation_id = 2452 ORDER BY current_relation_tags.k ASC) AS subquery_for_count LIMIT 1;
