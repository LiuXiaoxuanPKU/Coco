...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (project_id IS NULL OR project_id = 277) LIMIT 8;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 277) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 277) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 277) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 277) LIMIT 8;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 277) LIMIT 8;
