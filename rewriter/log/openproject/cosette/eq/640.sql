...
-- Original Query
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-invisible-project%' AND wiki_id = 22;
-- Rewritten Queries
SELECT wiki_pages.* FROM wiki_pages WHERE slug LIKE 'leaf-page-from-invisible-project%' AND wiki_id = 22 LIMIT 1;
