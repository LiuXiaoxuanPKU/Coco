...
-- Original Query
SELECT DISTINCT projects.id, projects.name FROM projects WHERE projects.lft >= 1 AND projects.lft < 2 AND projects.id <> 22 AND projects.active = True ORDER BY projects.name ASC;
-- Rewritten Queries
SELECT projects.id, projects.name FROM projects WHERE projects.lft >= 1 AND projects.lft < 2 AND projects.id <> 22 AND projects.active = True ORDER BY projects.name ASC;
