...
-- Original Query
SELECT 1 AS "one" FROM projects WHERE projects.identifier IS NULL AND projects.id <> 8903 LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM projects WHERE False AND projects.id <> 8903 LIMIT 1;
