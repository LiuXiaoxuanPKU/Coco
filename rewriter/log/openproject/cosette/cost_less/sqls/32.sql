...
-- Original Query
SELECT DISTINCT attribute_help_texts.attribute_name FROM attribute_help_texts WHERE attribute_help_texts.type = 'AttributeHelpText::Project' AND attribute_help_texts.type = 'AttributeHelpText::Project';
-- Rewritten Queries
SELECT attribute_help_texts.attribute_name FROM attribute_help_texts WHERE attribute_help_texts.type = 'AttributeHelpText::Project' AND attribute_help_texts.type = 'AttributeHelpText::Project';
