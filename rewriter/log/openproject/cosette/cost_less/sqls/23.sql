...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'wmpzfgbzldmbusvuyqcfawsrge' AND versions.id <> 6316 AND versions.project_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE LOWER(versions.name) = 'wmpzfgbzldmbusvuyqcfawsrge' AND versions.id <> 6316 AND False LIMIT 1;
