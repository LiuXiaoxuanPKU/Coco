...
SELECT work_packages.*, COALESCE(max_depth.depth, 0) FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id INNER JOIN (SELECT relations.to_id, MAX(hierarchy) AS depth FROM relations WHERE relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 GROUP BY relations.to_id) AS max_depth ON max_depth.to_id = work_packages.id WHERE relations.from_id = 4708 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 ORDER BY COALESCE(max_depth.depth, 0) ASC LIMIT 1;
SELECT DISTINCT work_packages.*, COALESCE(max_depth.depth, 0) FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id INNER JOIN (SELECT relations.to_id, MAX(hierarchy) AS depth FROM relations WHERE relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 GROUP BY relations.to_id) AS max_depth ON max_depth.to_id = work_packages.id WHERE relations.from_id = 4708 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 ORDER BY COALESCE(max_depth.depth, 0) ASC;
SELECT DISTINCT work_packages.*, COALESCE(max_depth.depth, 0) FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id INNER JOIN (SELECT relations.to_id, MAX(hierarchy) AS depth FROM relations WHERE relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 GROUP BY relations.to_id) AS max_depth ON max_depth.to_id = work_packages.id WHERE relations.from_id = 4708 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 ORDER BY COALESCE(max_depth.depth, 0) ASC LIMIT 1;
SELECT work_packages.*, COALESCE(max_depth.depth, 0) FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id LEFT OUTER JOIN (SELECT relations.to_id, MAX(hierarchy) AS depth FROM relations WHERE relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 GROUP BY relations.to_id) AS max_depth ON max_depth.to_id = work_packages.id WHERE relations.from_id = 4708 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 ORDER BY COALESCE(max_depth.depth, 0) ASC;
SELECT work_packages.*, COALESCE(max_depth.depth, 0) FROM work_packages INNER JOIN relations ON work_packages.id = relations.to_id LEFT OUTER JOIN (SELECT relations.to_id, MAX(hierarchy) AS depth FROM relations WHERE relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 GROUP BY relations.to_id) AS max_depth ON max_depth.to_id = work_packages.id WHERE relations.from_id = 4708 AND relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 ORDER BY COALESCE(max_depth.depth, 0) ASC LIMIT 1;
