...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (project_id IS NULL OR project_id = 273) LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (False OR project_id = 273) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (False OR project_id = 273) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (False OR project_id = 273) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (False OR project_id = 273) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE user_id = 769 AND is_public = False AND (False OR project_id = 273) LIMIT 1;
