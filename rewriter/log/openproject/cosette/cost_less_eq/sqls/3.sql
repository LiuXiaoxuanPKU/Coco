...
-- Original Query
SELECT projects.id FROM projects WHERE projects.identifier = 'ssshjbixfjncmsnhhuphgztjgylnkvpmtegvwedvpsqbalqfahkryrzsjraxydxjozwtuwgiyiztonyofcuudwzkcikainjrpelk';
-- Rewritten Queries
SELECT projects.id FROM projects WHERE projects.identifier = 'ssshjbixfjncmsnhhuphgztjgylnkvpmtegvwedvpsqbalqfahkryrzsjraxydxjozwtuwgiyiztonyofcuudwzkcikainjrpelk' LIMIT 1;
