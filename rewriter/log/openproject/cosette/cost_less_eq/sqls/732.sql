...
-- Original Query
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2727 AND relations.to_id IS NULL AND relations.id IS NOT NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM relations WHERE relations.from_id = 2727 AND False AND relations.id IS NOT NULL LIMIT 1;
