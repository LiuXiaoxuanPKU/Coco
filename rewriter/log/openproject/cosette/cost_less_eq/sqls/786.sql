...
-- Original Query
SELECT projects.* FROM projects WHERE projects.id IN (SELECT DISTINCT projects.parent_id FROM projects WHERE projects.parent_id IS NOT NULL) ORDER BY projects.id ASC LIMIT 6;
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.id IN (SELECT projects.parent_id FROM projects WHERE projects.parent_id IS NOT NULL) ORDER BY projects.id ASC LIMIT 6;
