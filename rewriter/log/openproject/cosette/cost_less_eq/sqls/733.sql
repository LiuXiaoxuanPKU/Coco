...
-- Original Query
SELECT journals.* FROM journals WHERE journals.journable_id = 3902 AND journals.journable_type = 'Changeset' ORDER BY journals.version ASC;
-- Rewritten Queries
SELECT journals.* FROM journals WHERE journals.journable_id = 3902 AND journals.journable_type = 'Changeset' ORDER BY journals.version ASC LIMIT 1;
