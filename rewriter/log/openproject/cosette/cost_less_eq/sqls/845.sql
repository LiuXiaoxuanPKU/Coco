...
-- Original Query
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4213, 3737);
-- Rewritten Queries
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (1036, 243) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (9944, 1250) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
...
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
...
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
...
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (901, 1036) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
...
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR False) AND members.project_id IN (105, 9944) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (9248, 2895);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (4213, 3737) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (9248, 2895) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (243, 4213);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (243, 4213);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (1250, 9248);
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (1250, 9248);
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (243, 4213) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id LEFT OUTER JOIN roles ON roles.id = member_roles.role_id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (243, 4213) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members INNER JOIN projects ON projects.id = members.project_id LEFT OUTER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (1250, 9248) LIMIT 1;
SELECT COUNT(DISTINCT members.id) FROM members LEFT OUTER JOIN projects ON projects.id = members.project_id INNER JOIN member_roles ON member_roles.member_id = members.id WHERE members.user_id = 22766 AND (projects.active = True OR project_id IS NULL) AND members.project_id IN (1250, 9248) LIMIT 1;
