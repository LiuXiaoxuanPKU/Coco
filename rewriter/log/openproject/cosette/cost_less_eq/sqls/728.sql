...
-- Original Query
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (project_id IS NULL OR project_id = 270) LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 270) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 270) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 270) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 270) LIMIT 1;
SELECT 1 AS "one" FROM cost_queries WHERE is_public = True AND (False OR project_id = 270) LIMIT 1;
