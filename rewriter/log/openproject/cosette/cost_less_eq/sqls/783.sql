...
-- Original Query
SELECT COUNT(*) FROM changesets WHERE changesets.repository_id = 314 AND scmid IN ('71e5c1d3dca6304805b143b9d0e6695fb3895ea4', '83ca5fd546063a3c7dc2e568ba3355661a9e2b2c');
-- Rewritten Queries
SELECT COUNT(*) FROM changesets WHERE changesets.repository_id = 314 AND scmid IN ('71e5c1d3dca6304805b143b9d0e6695fb3895ea4', '83ca5fd546063a3c7dc2e568ba3355661a9e2b2c') LIMIT 1;
