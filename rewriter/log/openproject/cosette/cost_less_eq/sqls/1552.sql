...
-- Original Query
SELECT work_packages.id FROM work_packages LEFT OUTER JOIN projects ON projects.id = work_packages.project_id LEFT OUTER JOIN relations ON relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id LEFT OUTER JOIN work_packages AS ancestors_work_packages ON ancestors_work_packages.id = relations.from_id WHERE work_packages.id = 2252 ORDER BY id ASC;
-- Rewritten Queries
SELECT work_packages.id FROM work_packages LEFT OUTER JOIN projects ON projects.id = work_packages.project_id LEFT OUTER JOIN relations ON relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id WHERE work_packages.id = 2252 ORDER BY id ASC;
SELECT work_packages.id FROM work_packages LEFT OUTER JOIN projects ON projects.id = work_packages.project_id LEFT OUTER JOIN relations ON relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id LEFT OUTER JOIN work_packages AS ancestors_work_packages ON ancestors_work_packages.id = relations.from_id WHERE work_packages.id = 2252 ORDER BY id ASC LIMIT 1;
SELECT work_packages.id FROM work_packages LEFT OUTER JOIN projects ON projects.id = work_packages.project_id LEFT OUTER JOIN relations ON relations.hierarchy <> 0 AND relations.relates = 0 AND relations.duplicates = 0 AND relations.follows = 0 AND relations.blocks = 0 AND relations.includes = 0 AND relations.requires = 0 AND relations.to_id = work_packages.id WHERE work_packages.id = 2252 ORDER BY id ASC LIMIT 1;
