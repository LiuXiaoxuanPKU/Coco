...
-- Original Query
SELECT users.id FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type IN ('User', 'Group', 'User', 'User') AND group_users.group_id = 24563;
-- Rewritten Queries
SELECT users.id FROM users INNER JOIN group_users ON users.id = group_users.user_id WHERE users.type IN ('User', 'Group', 'User', 'User') AND group_users.group_id = 24563 LIMIT 1;
