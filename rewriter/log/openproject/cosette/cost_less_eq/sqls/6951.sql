...
SELECT COUNT(*) FROM relations WHERE (relations.from_id = 917 AND relations.to_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT DISTINCT projects.id FROM projects WHERE projects.active = True) LIMIT 1) OR relations.to_id = 1508 AND relations.from_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT DISTINCT projects.id FROM projects WHERE projects.active = True) LIMIT 1)) AND hierarchy + relates + duplicates + follows + blocks + includes + requires = 1 AND relations.hierarchy = 0;
SELECT COUNT(*) FROM relations WHERE (relations.from_id = 917 AND relations.to_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT DISTINCT projects.id FROM projects WHERE projects.active = True) LIMIT 1) OR relations.to_id = 1508 AND relations.from_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT DISTINCT projects.id FROM projects WHERE projects.active = True) LIMIT 1)) AND hierarchy + relates + duplicates + follows + blocks + includes + requires = 1 AND relations.hierarchy = 0 LIMIT 1;
SELECT COUNT(*) FROM relations WHERE (relations.from_id = 917 AND relations.to_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT projects.id FROM projects WHERE projects.active = True LIMIT 1) LIMIT 1) OR relations.to_id = 1508 AND relations.from_id IN (SELECT work_packages.id FROM work_packages WHERE work_packages.project_id IN (SELECT projects.id FROM projects WHERE projects.active = True) LIMIT 1)) AND hierarchy + relates + duplicates + follows + blocks + includes + requires = 1 AND relations.hierarchy = 0;
