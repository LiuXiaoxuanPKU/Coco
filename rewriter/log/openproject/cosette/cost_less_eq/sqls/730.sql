...
-- Original Query
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.id <> 7474 AND versions.project_id IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM versions WHERE versions.name IS NULL AND versions.id <> 7474 AND False LIMIT 1;
SELECT 1 AS "one" FROM versions WHERE False AND versions.id <> 7474 AND versions.project_id IS NULL LIMIT 1;
SELECT 1 AS "one" FROM versions WHERE False AND versions.id <> 7474 AND False LIMIT 1;
