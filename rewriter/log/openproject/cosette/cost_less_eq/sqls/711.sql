...
-- Original Query
SELECT DISTINCT projects.* FROM projects WHERE projects.active = True ORDER BY projects.created_at DESC LIMIT 5;
-- Rewritten Queries
SELECT projects.* FROM projects WHERE projects.active = True ORDER BY projects.created_at DESC LIMIT 5;
