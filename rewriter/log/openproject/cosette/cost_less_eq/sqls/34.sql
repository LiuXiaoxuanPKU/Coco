...
-- Original Query
SELECT 1 AS "one" FROM users WHERE users.type = 'Group' AND users.lastname IS NULL LIMIT 1;
-- Rewritten Queries
SELECT 1 AS "one" FROM users WHERE users.type = 'Group' AND False LIMIT 1;
